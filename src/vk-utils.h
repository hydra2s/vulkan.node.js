...
namespace vku {
  ...
  namespace unsafe {
    ...
    template<class St = VkStructureType>
    inline decltype(auto) searchPtr(const St& sType, auto& base = VkBaseOutStructure{ .pNext = nullptr }, cpp21::optional_ref<cpp21::wrap_ptr<VkBaseOutStructure>> parent = {}) {
      auto pNext = &base;
      auto structure = cpp21::optional_ref(reinterpret_cast<cpp21::wrap_ptr<VkBaseOutStructure>&>(reinterpret_cast<VkBaseOutStructure&>(base).pNext));//what
      auto last = cpp21::optional_ref(reinterpret_cast<cpp21::wrap_ptr<VkBaseOutStructure>&>(pNext));
      cpp21::optional_ref<cpp21::wrap_ptr<VkBaseOutStructure>> found = {};
      ...
      while (bool(structure) && bool(structure.value())) {
        ...
        structure = cpp21::optional_ref(reinterpret_cast<cpp21::wrap_ptr<VkBaseOutStructure>&>(structure.value()->pNext));
      };
    ...
    // for Vulkan Hpp only!
    template<class St = VkStructureType>
    inline decltype(auto) relocate(St const& sType, auto& base = VkBaseOutStructure{ .pNext = nullptr }, void* const& where = nullptr) {
      cpp21::wrap_ptr<VkBaseOutStructure> last = nullptr;
      auto found = searchPtr(sType, base, cpp21::optional_ref<cpp21::wrap_ptr<VkBaseOutStructure>>(last));
    ...
    // for Vulkan Hpp only!
    template<class St = VkStructureType>
    inline decltype(auto) relocate(St const& sType, auto& base = VkBaseOutStructure{ .pNext = nullptr }, cpp21::optional_ref<cpp21::wrap_ptr<cpp21::void_t>> where = {}) {
      cpp21::wrap_ptr<VkBaseOutStructure> last = nullptr;
      auto found = searchPtr(sType, base, cpp21::optional_ref(last));
    ...
    //
    template<class St = VkStructureType>
    inline decltype(auto) chainify(St const& sType, auto& base = VkBaseOutStructure{ .pNext = nullptr }, const void* what = nullptr, void* const& where = nullptr) {
      auto found = relocate(sType, base, cpp21::optional_ref(reinterpret_cast<cpp21::wrap_ptr<cpp21::void_t>&>(const_cast<void*&>(where))));
      if (what && found && *found) {
    ...
    //
    template<class St = VkStructureType>
    inline decltype(auto) chainify(St const& sType, auto& base = VkBaseOutStructure{ .pNext = nullptr }, const void* what = nullptr, cpp21::optional_ref<cpp21::wrap_ptr<cpp21::void_t>> where = {}) {
  ...
  public:
    ...
    inline decltype(auto) getElement(St const& sType) {
    ...
    // 
    template<class T = VkBaseOutStructure, class St = VkStructureType>
    inline decltype(auto) getReference(St const& sType) {
      auto element = this->getElement<T>(sType);
      return element ? cpp21::opt_ref<T>(*element) : cpp21::optional_ref<T>{};
    };
    ...
    inline decltype(auto) copyChain(const T& base = T{}) {
      ...
      auto structure = ptr ? cpp21::opt_cref(*ptr) : cpp21::optional_ref<const VkBaseInStructure>{};//what
      auto last = structure;
      ...
      while (structure) {
        ...
        structure = structure.value().pNext ? cpp21::opt_cref(*reinterpret_cast<const cpp21::wrap_ptr<VkBaseInStructure>&>(structure.value().pNext)) : cpp21::optional_ref<const VkBaseInStructure>{};
      };
