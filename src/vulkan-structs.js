...
const VkBaseOutStructure = new Proxy(C.CStructView, new C.CStruct("VkBaseOutStructure", {
...
const VkBaseInStructure = new Proxy(C.CStructView, new C.CStruct("VkBaseInStructure", {
    sType: "u32("+(V.VkBaseInStructure_sType_offsetof||0)+")",
    pNext: "u64("+(V.VkBaseInStructure_pNext_offsetof||0)+")",
}, (V.VkBaseInStructure_sizeof||0)));


const VkOffset2D = new Proxy(C.CStructView, new C.CStruct("VkOffset2D", {
    x: "i32("+(V.VkOffset2D_x_offsetof||0)+")",
    y: "i32("+(V.VkOffset2D_y_offsetof||0)+")",
}, (V.VkOffset2D_sizeof||0)));


const VkOffset3D = new Proxy(C.CStructView, new C.CStruct("VkOffset3D", {
...
const VkExtent2D = new Proxy(C.CStructView, new C.CStruct("VkExtent2D", {
    width: "u32("+(V.VkExtent2D_width_offsetof||0)+")",
    height: "u32("+(V.VkExtent2D_height_offsetof||0)+")",
}, (V.VkExtent2D_sizeof||0)));


const VkExtent3D = new Proxy(C.CStructView, new C.CStruct("VkExtent3D", {
...
const VkViewport = new Proxy(C.CStructView, new C.CStruct("VkViewport", {
...
const VkRect2D = new Proxy(C.CStructView, new C.CStruct("VkRect2D", {
    offset: "VkOffset2D("+(V.VkRect2D_offset_offsetof||0)+")",
    extent: "VkExtent2D("+(V.VkRect2D_extent_offsetof||0)+")",
}, (V.VkRect2D_sizeof||0)));


const VkClearRect = new Proxy(C.CStructView, new C.CStruct("VkClearRect", {
...
const VkComponentMapping = new Proxy(C.CStructView, new C.CStruct("VkComponentMapping", {
...
const VkPhysicalDeviceProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceProperties", {
    ...
    limits: "VkPhysicalDeviceLimits("+(V.VkPhysicalDeviceProperties_limits_offsetof||0)+")",
    sparseProperties: "VkPhysicalDeviceSparseProperties("+(V.VkPhysicalDeviceProperties_sparseProperties_offsetof||0)+")",
}, (V.VkPhysicalDeviceProperties_sizeof||0)));


const VkExtensionProperties = new Proxy(C.CStructView, new C.CStruct("VkExtensionProperties", {
...
const VkLayerProperties = new Proxy(C.CStructView, new C.CStruct("VkLayerProperties", {
...
const VkApplicationInfo = new Proxy(C.CStructView, new C.CStruct("VkApplicationInfo", {
    sType: "u32("+(V.VkApplicationInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_APPLICATION_INFO||0),
...
const VkAllocationCallbacks = new Proxy(C.CStructView, new C.CStruct("VkAllocationCallbacks", {
    pUserData: "u64("+(V.VkAllocationCallbacks_pUserData_offsetof||0)+")",
    pfnAllocation: "PFN_vkAllocationFunction("+(V.VkAllocationCallbacks_pfnAllocation_offsetof||0)+")",
    pfnReallocation: "PFN_vkReallocationFunction("+(V.VkAllocationCallbacks_pfnReallocation_offsetof||0)+")",
    pfnFree: "PFN_vkFreeFunction("+(V.VkAllocationCallbacks_pfnFree_offsetof||0)+")",
    pfnInternalAllocation: "PFN_vkInternalAllocationNotification("+(V.VkAllocationCallbacks_pfnInternalAllocation_offsetof||0)+")",
    pfnInternalFree: "PFN_vkInternalFreeNotification("+(V.VkAllocationCallbacks_pfnInternalFree_offsetof||0)+")",
}, (V.VkAllocationCallbacks_sizeof||0)));


const VkDeviceQueueCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDeviceQueueCreateInfo", {
    sType: "u32("+(V.VkDeviceQueueCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_QUEUE_CREATE_INFO||0),
...
const VkDeviceCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDeviceCreateInfo", {
    sType: "u32("+(V.VkDeviceCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO||0),
...
const VkInstanceCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkInstanceCreateInfo", {
    sType: "u32("+(V.VkInstanceCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO||0),
...
const VkQueueFamilyProperties = new Proxy(C.CStructView, new C.CStruct("VkQueueFamilyProperties", {
    ...
    minImageTransferGranularity: "VkExtent3D("+(V.VkQueueFamilyProperties_minImageTransferGranularity_offsetof||0)+")",
}, (V.VkQueueFamilyProperties_sizeof||0)));


const VkPhysicalDeviceMemoryProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMemoryProperties", {
    memoryTypeCount: "u32("+(V.VkPhysicalDeviceMemoryProperties_memoryTypeCount_offsetof||0)+")",
    memoryTypes: "VkMemoryType["+(E.VK_MAX_MEMORY_TYPES||1)+"]("+(V.VkPhysicalDeviceMemoryProperties_memoryTypes_offsetof||0)+")",
    memoryHeapCount: "u32("+(V.VkPhysicalDeviceMemoryProperties_memoryHeapCount_offsetof||0)+")",
    memoryHeaps: "VkMemoryHeap["+(E.VK_MAX_MEMORY_HEAPS||1)+"]("+(V.VkPhysicalDeviceMemoryProperties_memoryHeaps_offsetof||0)+")",
}, (V.VkPhysicalDeviceMemoryProperties_sizeof||0)));


const VkMemoryAllocateInfo = new Proxy(C.CStructView, new C.CStruct("VkMemoryAllocateInfo", {
    sType: "u32("+(V.VkMemoryAllocateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO||0),
...
const VkMemoryRequirements = new Proxy(C.CStructView, new C.CStruct("VkMemoryRequirements", {
...
const VkSparseImageFormatProperties = new Proxy(C.CStructView, new C.CStruct("VkSparseImageFormatProperties", {
    aspectMask: "u32("+(V.VkSparseImageFormatProperties_aspectMask_offsetof||0)+")",
    imageGranularity: "VkExtent3D("+(V.VkSparseImageFormatProperties_imageGranularity_offsetof||0)+")",
    flags: "u32("+(V.VkSparseImageFormatProperties_flags_offsetof||0)+")",
}, (V.VkSparseImageFormatProperties_sizeof||0)));


const VkSparseImageMemoryRequirements = new Proxy(C.CStructView, new C.CStruct("VkSparseImageMemoryRequirements", {
    formatProperties: "VkSparseImageFormatProperties("+(V.VkSparseImageMemoryRequirements_formatProperties_offsetof||0)+")",
...
const VkMemoryType = new Proxy(C.CStructView, new C.CStruct("VkMemoryType", {
...
const VkMemoryHeap = new Proxy(C.CStructView, new C.CStruct("VkMemoryHeap", {
    size: "u64("+(V.VkMemoryHeap_size_offsetof||0)+")",
    flags: "u32("+(V.VkMemoryHeap_flags_offsetof||0)+")",
}, (V.VkMemoryHeap_sizeof||0)));


const VkMappedMemoryRange = new Proxy(C.CStructView, new C.CStruct("VkMappedMemoryRange", {
    sType: "u32("+(V.VkMappedMemoryRange_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE||0),
...
const VkFormatProperties = new Proxy(C.CStructView, new C.CStruct("VkFormatProperties", {
...
const VkImageFormatProperties = new Proxy(C.CStructView, new C.CStruct("VkImageFormatProperties", {
    maxExtent: "VkExtent3D("+(V.VkImageFormatProperties_maxExtent_offsetof||0)+")",
...
const VkDescriptorImageInfo = new Proxy(C.CStructView, new C.CStruct("VkDescriptorImageInfo", {
    sampler: "u64("+(V.VkDescriptorImageInfo_sampler_offsetof||0)+")",
    imageView: "u64("+(V.VkDescriptorImageInfo_imageView_offsetof||0)+")",
...
const VkBufferCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkBufferCreateInfo", {
    sType: "u32("+(V.VkBufferCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO||0),
...
const VkBufferViewCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkBufferViewCreateInfo", {
...
const VkImageSubresource = new Proxy(C.CStructView, new C.CStruct("VkImageSubresource", {
...
const VkImageSubresourceLayers = new Proxy(C.CStructView, new C.CStruct("VkImageSubresourceLayers", {
...
const VkImageSubresourceRange = new Proxy(C.CStructView, new C.CStruct("VkImageSubresourceRange", {
...
const VkMemoryBarrier = new Proxy(C.CStructView, new C.CStruct("VkMemoryBarrier", {
    sType: "u32("+(V.VkMemoryBarrier_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_BARRIER||0),
...
const VkBufferMemoryBarrier = new Proxy(C.CStructView, new C.CStruct("VkBufferMemoryBarrier", {
    sType: "u32("+(V.VkBufferMemoryBarrier_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER||0),
...
const VkImageMemoryBarrier = new Proxy(C.CStructView, new C.CStruct("VkImageMemoryBarrier", {
    sType: "u32("+(V.VkImageMemoryBarrier_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER||0),
    ...
    subresourceRange: "VkImageSubresourceRange("+(V.VkImageMemoryBarrier_subresourceRange_offsetof||0)+")",
}, (V.VkImageMemoryBarrier_sizeof||0)));


const VkImageCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkImageCreateInfo", {
    sType: "u32("+(V.VkImageCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO||0),
    ...
    extent: "VkExtent3D("+(V.VkImageCreateInfo_extent_offsetof||0)+")",
...
const VkSubresourceLayout = new Proxy(C.CStructView, new C.CStruct("VkSubresourceLayout", {
...
const VkImageViewCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkImageViewCreateInfo", {
    sType: "u32("+(V.VkImageViewCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO||0),
    ...
    components: "VkComponentMapping("+(V.VkImageViewCreateInfo_components_offsetof||0)+")",
    subresourceRange: "VkImageSubresourceRange("+(V.VkImageViewCreateInfo_subresourceRange_offsetof||0)+")",
}, (V.VkImageViewCreateInfo_sizeof||0)));


const VkBufferCopy = new Proxy(C.CStructView, new C.CStruct("VkBufferCopy", {
...
const VkSparseMemoryBind = new Proxy(C.CStructView, new C.CStruct("VkSparseMemoryBind", {
...
const VkSparseImageMemoryBind = new Proxy(C.CStructView, new C.CStruct("VkSparseImageMemoryBind", {
    subresource: "VkImageSubresource("+(V.VkSparseImageMemoryBind_subresource_offsetof||0)+")",
    offset: "VkOffset3D("+(V.VkSparseImageMemoryBind_offset_offsetof||0)+")",
    extent: "VkExtent3D("+(V.VkSparseImageMemoryBind_extent_offsetof||0)+")",
...
const VkSparseImageOpaqueMemoryBindInfo = new Proxy(C.CStructView, new C.CStruct("VkSparseImageOpaqueMemoryBindInfo", {
...
const VkSparseImageMemoryBindInfo = new Proxy(C.CStructView, new C.CStruct("VkSparseImageMemoryBindInfo", {
...
const VkBindSparseInfo = new Proxy(C.CStructView, new C.CStruct("VkBindSparseInfo", {
    sType: "u32("+(V.VkBindSparseInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BIND_SPARSE_INFO||0),
...
const VkImageCopy = new Proxy(C.CStructView, new C.CStruct("VkImageCopy", {
    srcSubresource: "VkImageSubresourceLayers("+(V.VkImageCopy_srcSubresource_offsetof||0)+")",
    srcOffset: "VkOffset3D("+(V.VkImageCopy_srcOffset_offsetof||0)+")",
    dstSubresource: "VkImageSubresourceLayers("+(V.VkImageCopy_dstSubresource_offsetof||0)+")",
    dstOffset: "VkOffset3D("+(V.VkImageCopy_dstOffset_offsetof||0)+")",
    extent: "VkExtent3D("+(V.VkImageCopy_extent_offsetof||0)+")",
}, (V.VkImageCopy_sizeof||0)));


const VkImageBlit = new Proxy(C.CStructView, new C.CStruct("VkImageBlit", {
    srcSubresource: "VkImageSubresourceLayers("+(V.VkImageBlit_srcSubresource_offsetof||0)+")",
    srcOffsets: "VkOffset3D[2]("+(V.VkImageBlit_srcOffsets_offsetof||0)+")",
    dstSubresource: "VkImageSubresourceLayers("+(V.VkImageBlit_dstSubresource_offsetof||0)+")",
    dstOffsets: "VkOffset3D[2]("+(V.VkImageBlit_dstOffsets_offsetof||0)+")",
}, (V.VkImageBlit_sizeof||0)));


const VkBufferImageCopy = new Proxy(C.CStructView, new C.CStruct("VkBufferImageCopy", {
    ...
    imageSubresource: "VkImageSubresourceLayers("+(V.VkBufferImageCopy_imageSubresource_offsetof||0)+")",
    imageOffset: "VkOffset3D("+(V.VkBufferImageCopy_imageOffset_offsetof||0)+")",
    imageExtent: "VkExtent3D("+(V.VkBufferImageCopy_imageExtent_offsetof||0)+")",
}, (V.VkBufferImageCopy_sizeof||0)));


const VkCopyMemoryIndirectCommandNV = new Proxy(C.CStructView, new C.CStruct("VkCopyMemoryIndirectCommandNV", {
...
const VkCopyMemoryToImageIndirectCommandNV = new Proxy(C.CStructView, new C.CStruct("VkCopyMemoryToImageIndirectCommandNV", {
    ...
    imageSubresource: "VkImageSubresourceLayers("+(V.VkCopyMemoryToImageIndirectCommandNV_imageSubresource_offsetof||0)+")",
    imageOffset: "VkOffset3D("+(V.VkCopyMemoryToImageIndirectCommandNV_imageOffset_offsetof||0)+")",
    imageExtent: "VkExtent3D("+(V.VkCopyMemoryToImageIndirectCommandNV_imageExtent_offsetof||0)+")",
}, (V.VkCopyMemoryToImageIndirectCommandNV_sizeof||0)));


const VkImageResolve = new Proxy(C.CStructView, new C.CStruct("VkImageResolve", {
    srcSubresource: "VkImageSubresourceLayers("+(V.VkImageResolve_srcSubresource_offsetof||0)+")",
    srcOffset: "VkOffset3D("+(V.VkImageResolve_srcOffset_offsetof||0)+")",
    dstSubresource: "VkImageSubresourceLayers("+(V.VkImageResolve_dstSubresource_offsetof||0)+")",
    dstOffset: "VkOffset3D("+(V.VkImageResolve_dstOffset_offsetof||0)+")",
    extent: "VkExtent3D("+(V.VkImageResolve_extent_offsetof||0)+")",
}, (V.VkImageResolve_sizeof||0)));


const VkShaderModuleCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkShaderModuleCreateInfo", {
    sType: "u32("+(V.VkShaderModuleCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO||0),
...
const VkDescriptorSetLayoutBinding = new Proxy(C.CStructView, new C.CStruct("VkDescriptorSetLayoutBinding", {
...
const VkDescriptorSetLayoutCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDescriptorSetLayoutCreateInfo", {
    sType: "u32("+(V.VkDescriptorSetLayoutCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO||0),
...
const VkDescriptorPoolSize = new Proxy(C.CStructView, new C.CStruct("VkDescriptorPoolSize", {
...
const VkDescriptorPoolCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDescriptorPoolCreateInfo", {
    sType: "u32("+(V.VkDescriptorPoolCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO||0),
...
const VkDescriptorSetAllocateInfo = new Proxy(C.CStructView, new C.CStruct("VkDescriptorSetAllocateInfo", {
    sType: "u32("+(V.VkDescriptorSetAllocateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO||0),
    pNext: "u64("+(V.VkDescriptorSetAllocateInfo_pNext_offsetof||0)+")",
    descriptorPool: "VkDescriptorPool("+(V.VkDescriptorSetAllocateInfo_descriptorPool_offsetof||0)+")",
...
const VkSpecializationMapEntry = new Proxy(C.CStructView, new C.CStruct("VkSpecializationMapEntry", {
...
const VkSpecializationInfo = new Proxy(C.CStructView, new C.CStruct("VkSpecializationInfo", {
...
const VkPipelineShaderStageCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineShaderStageCreateInfo", {
    sType: "u32("+(V.VkPipelineShaderStageCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO||0),
...
const VkComputePipelineCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkComputePipelineCreateInfo", {
    sType: "u32("+(V.VkComputePipelineCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COMPUTE_PIPELINE_CREATE_INFO||0),
    pNext: "u64("+(V.VkComputePipelineCreateInfo_pNext_offsetof||0)+")",
    flags: "u32("+(V.VkComputePipelineCreateInfo_flags_offsetof||0)+")",
    stage: "VkPipelineShaderStageCreateInfo("+(V.VkComputePipelineCreateInfo_stage_offsetof||0)+")",
...
const VkVertexInputBindingDescription = new Proxy(C.CStructView, new C.CStruct("VkVertexInputBindingDescription", {
...
const VkVertexInputAttributeDescription = new Proxy(C.CStructView, new C.CStruct("VkVertexInputAttributeDescription", {
...
const VkPipelineVertexInputStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineVertexInputStateCreateInfo", {
    sType: "u32("+(V.VkPipelineVertexInputStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO||0),
...
const VkPipelineInputAssemblyStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineInputAssemblyStateCreateInfo", {
    sType: "u32("+(V.VkPipelineInputAssemblyStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO||0),
...
const VkPipelineTessellationStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineTessellationStateCreateInfo", {
    sType: "u32("+(V.VkPipelineTessellationStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_STATE_CREATE_INFO||0),
...
const VkPipelineViewportStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineViewportStateCreateInfo", {
    sType: "u32("+(V.VkPipelineViewportStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO||0),
...
const VkPipelineRasterizationStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineRasterizationStateCreateInfo", {
    sType: "u32("+(V.VkPipelineRasterizationStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO||0),
...
const VkPipelineMultisampleStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineMultisampleStateCreateInfo", {
    sType: "u32("+(V.VkPipelineMultisampleStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO||0),
...
const VkPipelineColorBlendAttachmentState = new Proxy(C.CStructView, new C.CStruct("VkPipelineColorBlendAttachmentState", {
...
const VkPipelineColorBlendStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineColorBlendStateCreateInfo", {
    sType: "u32("+(V.VkPipelineColorBlendStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO||0),
...
const VkPipelineDynamicStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineDynamicStateCreateInfo", {
    sType: "u32("+(V.VkPipelineDynamicStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO||0),
...
const VkStencilOpState = new Proxy(C.CStructView, new C.CStruct("VkStencilOpState", {
...
const VkPipelineDepthStencilStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineDepthStencilStateCreateInfo", {
    sType: "u32("+(V.VkPipelineDepthStencilStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO||0),
    ...
    front: "VkStencilOpState("+(V.VkPipelineDepthStencilStateCreateInfo_front_offsetof||0)+")",
    back: "VkStencilOpState("+(V.VkPipelineDepthStencilStateCreateInfo_back_offsetof||0)+")",
...
const VkGraphicsPipelineCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkGraphicsPipelineCreateInfo", {
    sType: "u32("+(V.VkGraphicsPipelineCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO||0),
...
const VkPipelineCacheCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineCacheCreateInfo", {
    sType: "u32("+(V.VkPipelineCacheCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO||0),
...
const VkPipelineCacheHeaderVersionOne = new Proxy(C.CStructView, new C.CStruct("VkPipelineCacheHeaderVersionOne", {
...
const VkPushConstantRange = new Proxy(C.CStructView, new C.CStruct("VkPushConstantRange", {
...
const VkPipelineLayoutCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineLayoutCreateInfo", {
    sType: "u32("+(V.VkPipelineLayoutCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO||0),
...
const VkSamplerCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkSamplerCreateInfo", {
    sType: "u32("+(V.VkSamplerCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO||0),
...
const VkCommandPoolCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkCommandPoolCreateInfo", {
    sType: "u32("+(V.VkCommandPoolCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO||0),
...
const VkCommandBufferBeginInfo = new Proxy(C.CStructView, new C.CStruct("VkCommandBufferBeginInfo", {
    sType: "u32("+(V.VkCommandBufferBeginInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO||0),
...
const VkClearDepthStencilValue = new Proxy(C.CStructView, new C.CStruct("VkClearDepthStencilValue", {
...
const VkClearAttachment = new Proxy(C.CStructView, new C.CStruct("VkClearAttachment", {
    ...
    clearValue: "VkClearValue("+(V.VkClearAttachment_clearValue_offsetof||0)+")",
}, (V.VkClearAttachment_sizeof||0)));


const VkAttachmentDescription = new Proxy(C.CStructView, new C.CStruct("VkAttachmentDescription", {
...
const VkAttachmentReference = new Proxy(C.CStructView, new C.CStruct("VkAttachmentReference", {
...
const VkSubpassDescription = new Proxy(C.CStructView, new C.CStruct("VkSubpassDescription", {
...
const VkSubpassDependency = new Proxy(C.CStructView, new C.CStruct("VkSubpassDependency", {
...
const VkRenderPassCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkRenderPassCreateInfo", {
    sType: "u32("+(V.VkRenderPassCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO||0),
...
const VkEventCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkEventCreateInfo", {
    sType: "u32("+(V.VkEventCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EVENT_CREATE_INFO||0),
    pNext: "u64("+(V.VkEventCreateInfo_pNext_offsetof||0)+")",
    flags: "u32("+(V.VkEventCreateInfo_flags_offsetof||0)+")",
}, (V.VkEventCreateInfo_sizeof||0)));


const VkFenceCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkFenceCreateInfo", {
    sType: "u32("+(V.VkFenceCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FENCE_CREATE_INFO||0),
    pNext: "u64("+(V.VkFenceCreateInfo_pNext_offsetof||0)+")",
    flags: "u32("+(V.VkFenceCreateInfo_flags_offsetof||0)+")",
}, (V.VkFenceCreateInfo_sizeof||0)));


const VkPhysicalDeviceFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFeatures", {
...
const VkPhysicalDeviceSparseProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSparseProperties", {
...
const VkPhysicalDeviceLimits = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceLimits", {
...
const VkSemaphoreCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkSemaphoreCreateInfo", {
    sType: "u32("+(V.VkSemaphoreCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SEMAPHORE_CREATE_INFO||0),
...
const VkQueryPoolCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkQueryPoolCreateInfo", {
    sType: "u32("+(V.VkQueryPoolCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUERY_POOL_CREATE_INFO||0),
...
const VkFramebufferCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkFramebufferCreateInfo", {
...
const VkDrawIndirectCommand = new Proxy(C.CStructView, new C.CStruct("VkDrawIndirectCommand", {
...
const VkDrawIndexedIndirectCommand = new Proxy(C.CStructView, new C.CStruct("VkDrawIndexedIndirectCommand", {
...
const VkDispatchIndirectCommand = new Proxy(C.CStructView, new C.CStruct("VkDispatchIndirectCommand", {
...
const VkMultiDrawInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMultiDrawInfoEXT", {
...
const VkMultiDrawIndexedInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMultiDrawIndexedInfoEXT", {
...
const VkSubmitInfo = new Proxy(C.CStructView, new C.CStruct("VkSubmitInfo", {
    sType: "u32("+(V.VkSubmitInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBMIT_INFO||0),
...
const VkDisplayPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayPropertiesKHR", {
    display: "VkDisplayKHR("+(V.VkDisplayPropertiesKHR_display_offsetof||0)+")",
...
const VkDisplayPlanePropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayPlanePropertiesKHR", {
    currentDisplay: "VkDisplayKHR("+(V.VkDisplayPlanePropertiesKHR_currentDisplay_offsetof||0)+")",
    currentStackIndex: "u32("+(V.VkDisplayPlanePropertiesKHR_currentStackIndex_offsetof||0)+")",
}, (V.VkDisplayPlanePropertiesKHR_sizeof||0)));


const VkDisplayModeParametersKHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayModeParametersKHR", {
...
const VkDisplayModePropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayModePropertiesKHR", {
    displayMode: "VkDisplayModeKHR("+(V.VkDisplayModePropertiesKHR_displayMode_offsetof||0)+")",
    parameters: "VkDisplayModeParametersKHR("+(V.VkDisplayModePropertiesKHR_parameters_offsetof||0)+")",
}, (V.VkDisplayModePropertiesKHR_sizeof||0)));


const VkDisplayModeCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayModeCreateInfoKHR", {
    sType: "u32("+(V.VkDisplayModeCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_MODE_CREATE_INFO_KHR||0),
    pNext: "u64("+(V.VkDisplayModeCreateInfoKHR_pNext_offsetof||0)+")",
    flags: "u32("+(V.VkDisplayModeCreateInfoKHR_flags_offsetof||0)+")",
    parameters: "VkDisplayModeParametersKHR("+(V.VkDisplayModeCreateInfoKHR_parameters_offsetof||0)+")",
}, (V.VkDisplayModeCreateInfoKHR_sizeof||0)));


const VkDisplayPlaneCapabilitiesKHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayPlaneCapabilitiesKHR", {
...
const VkDisplaySurfaceCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkDisplaySurfaceCreateInfoKHR", {
    sType: "u32("+(V.VkDisplaySurfaceCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_SURFACE_CREATE_INFO_KHR||0),
    pNext: "u64("+(V.VkDisplaySurfaceCreateInfoKHR_pNext_offsetof||0)+")",
    flags: "u32("+(V.VkDisplaySurfaceCreateInfoKHR_flags_offsetof||0)+")",
    displayMode: "VkDisplayModeKHR("+(V.VkDisplaySurfaceCreateInfoKHR_displayMode_offsetof||0)+")",
...
const VkDisplayPresentInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayPresentInfoKHR", {
    sType: "u32("+(V.VkDisplayPresentInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_PRESENT_INFO_KHR||0),
...
const VkSurfaceCapabilitiesKHR = new Proxy(C.CStructView, new C.CStruct("VkSurfaceCapabilitiesKHR", {
...
const VkAndroidSurfaceCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAndroidSurfaceCreateInfoKHR", {
    sType: "u32("+(V.VkAndroidSurfaceCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ANDROID_SURFACE_CREATE_INFO_KHR||0),
...
const VkViSurfaceCreateInfoNN = new Proxy(C.CStructView, new C.CStruct("VkViSurfaceCreateInfoNN", {
    sType: "u32("+(V.VkViSurfaceCreateInfoNN_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VI_SURFACE_CREATE_INFO_NN||0),
...
const VkWaylandSurfaceCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkWaylandSurfaceCreateInfoKHR", {
    sType: "u32("+(V.VkWaylandSurfaceCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_WAYLAND_SURFACE_CREATE_INFO_KHR||0),
...
const VkWin32SurfaceCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkWin32SurfaceCreateInfoKHR", {
    sType: "u32("+(V.VkWin32SurfaceCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR||0),
    pNext: "u64("+(V.VkWin32SurfaceCreateInfoKHR_pNext_offsetof||0)+")",
    flags: "u32("+(V.VkWin32SurfaceCreateInfoKHR_flags_offsetof||0)+")",
    hinstance: "HINSTANCE("+(V.VkWin32SurfaceCreateInfoKHR_hinstance_offsetof||0)+")",
    hwnd: "HWND("+(V.VkWin32SurfaceCreateInfoKHR_hwnd_offsetof||0)+")",
}, (V.VkWin32SurfaceCreateInfoKHR_sizeof||0)));


const VkXlibSurfaceCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkXlibSurfaceCreateInfoKHR", {
    sType: "u32("+(V.VkXlibSurfaceCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_XLIB_SURFACE_CREATE_INFO_KHR||0),
    ...
    window: "Window("+(V.VkXlibSurfaceCreateInfoKHR_window_offsetof||0)+")",
}, (V.VkXlibSurfaceCreateInfoKHR_sizeof||0)));


const VkXcbSurfaceCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkXcbSurfaceCreateInfoKHR", {
    sType: "u32("+(V.VkXcbSurfaceCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_XCB_SURFACE_CREATE_INFO_KHR||0),
    ...
    window: "xcb_window_t("+(V.VkXcbSurfaceCreateInfoKHR_window_offsetof||0)+")",
}, (V.VkXcbSurfaceCreateInfoKHR_sizeof||0)));


const VkDirectFBSurfaceCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDirectFBSurfaceCreateInfoEXT", {
    sType: "u32("+(V.VkDirectFBSurfaceCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DIRECTFB_SURFACE_CREATE_INFO_EXT||0),
...
const VkImagePipeSurfaceCreateInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkImagePipeSurfaceCreateInfoFUCHSIA", {
    sType: "u32("+(V.VkImagePipeSurfaceCreateInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGEPIPE_SURFACE_CREATE_INFO_FUCHSIA||0),
    ...
    imagePipeHandle: "zx_handle_t("+(V.VkImagePipeSurfaceCreateInfoFUCHSIA_imagePipeHandle_offsetof||0)+")",
}, (V.VkImagePipeSurfaceCreateInfoFUCHSIA_sizeof||0)));


const VkStreamDescriptorSurfaceCreateInfoGGP = new Proxy(C.CStructView, new C.CStruct("VkStreamDescriptorSurfaceCreateInfoGGP", {
    sType: "u32("+(V.VkStreamDescriptorSurfaceCreateInfoGGP_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_STREAM_DESCRIPTOR_SURFACE_CREATE_INFO_GGP||0),
    ...
    streamDescriptor: "GgpStreamDescriptor("+(V.VkStreamDescriptorSurfaceCreateInfoGGP_streamDescriptor_offsetof||0)+")",
}, (V.VkStreamDescriptorSurfaceCreateInfoGGP_sizeof||0)));


const VkScreenSurfaceCreateInfoQNX = new Proxy(C.CStructView, new C.CStruct("VkScreenSurfaceCreateInfoQNX", {
    sType: "u32("+(V.VkScreenSurfaceCreateInfoQNX_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SCREEN_SURFACE_CREATE_INFO_QNX||0),
...
const VkSurfaceFormatKHR = new Proxy(C.CStructView, new C.CStruct("VkSurfaceFormatKHR", {
...
const VkSwapchainCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkSwapchainCreateInfoKHR", {
    sType: "u32("+(V.VkSwapchainCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SWAPCHAIN_CREATE_INFO_KHR||0),
...
const VkPresentInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkPresentInfoKHR", {
    sType: "u32("+(V.VkPresentInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PRESENT_INFO_KHR||0),
...
const VkDebugReportCallbackCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugReportCallbackCreateInfoEXT", {
    sType: "u32("+(V.VkDebugReportCallbackCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT||0),
    ...
    pfnCallback: "PFN_vkDebugReportCallbackEXT("+(V.VkDebugReportCallbackCreateInfoEXT_pfnCallback_offsetof||0)+")",
    pUserData: "u64("+(V.VkDebugReportCallbackCreateInfoEXT_pUserData_offsetof||0)+")",
}, (V.VkDebugReportCallbackCreateInfoEXT_sizeof||0)));


const VkValidationFlagsEXT = new Proxy(C.CStructView, new C.CStruct("VkValidationFlagsEXT", {
    sType: "u32("+(V.VkValidationFlagsEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VALIDATION_FLAGS_EXT||0),
...
const VkValidationFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkValidationFeaturesEXT", {
    sType: "u32("+(V.VkValidationFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VALIDATION_FEATURES_EXT||0),
...
const VkPipelineRasterizationStateRasterizationOrderAMD = new Proxy(C.CStructView, new C.CStruct("VkPipelineRasterizationStateRasterizationOrderAMD", {
    sType: "u32("+(V.VkPipelineRasterizationStateRasterizationOrderAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_RASTERIZATION_ORDER_AMD||0),
...
const VkDebugMarkerObjectNameInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugMarkerObjectNameInfoEXT", {
    sType: "u32("+(V.VkDebugMarkerObjectNameInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_NAME_INFO_EXT||0),
...
const VkDebugMarkerObjectTagInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugMarkerObjectTagInfoEXT", {
    sType: "u32("+(V.VkDebugMarkerObjectTagInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_TAG_INFO_EXT||0),
...
const VkDebugMarkerMarkerInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugMarkerMarkerInfoEXT", {
    sType: "u32("+(V.VkDebugMarkerMarkerInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_MARKER_MARKER_INFO_EXT||0),
...
const VkDedicatedAllocationImageCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkDedicatedAllocationImageCreateInfoNV", {
    sType: "u32("+(V.VkDedicatedAllocationImageCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV||0),
...
const VkDedicatedAllocationBufferCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkDedicatedAllocationBufferCreateInfoNV", {
    sType: "u32("+(V.VkDedicatedAllocationBufferCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV||0),
...
const VkDedicatedAllocationMemoryAllocateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkDedicatedAllocationMemoryAllocateInfoNV", {
...
const VkExternalImageFormatPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkExternalImageFormatPropertiesNV", {
    imageFormatProperties: "VkImageFormatProperties("+(V.VkExternalImageFormatPropertiesNV_imageFormatProperties_offsetof||0)+")",
...
const VkExternalMemoryImageCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkExternalMemoryImageCreateInfoNV", {
    sType: "u32("+(V.VkExternalMemoryImageCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV||0),
...
const VkExportMemoryAllocateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkExportMemoryAllocateInfoNV", {
    sType: "u32("+(V.VkExportMemoryAllocateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_NV||0),
...
const VkImportMemoryWin32HandleInfoNV = new Proxy(C.CStructView, new C.CStruct("VkImportMemoryWin32HandleInfoNV", {
    sType: "u32("+(V.VkImportMemoryWin32HandleInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_NV||0),
...
const VkExportMemoryWin32HandleInfoNV = new Proxy(C.CStructView, new C.CStruct("VkExportMemoryWin32HandleInfoNV", {
    sType: "u32("+(V.VkExportMemoryWin32HandleInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_NV||0),
...
const VkWin32KeyedMutexAcquireReleaseInfoNV = new Proxy(C.CStructView, new C.CStruct("VkWin32KeyedMutexAcquireReleaseInfoNV", {
    sType: "u32("+(V.VkWin32KeyedMutexAcquireReleaseInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV||0),
...
const VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_NV||0),
...
const VkDevicePrivateDataCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDevicePrivateDataCreateInfo", {
    sType: "u32("+(V.VkDevicePrivateDataCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_PRIVATE_DATA_CREATE_INFO||0),
...
const VkDevicePrivateDataCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkDevicePrivateDataCreateInfo"));


const VkPrivateDataSlotCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPrivateDataSlotCreateInfo", {
    sType: "u32("+(V.VkPrivateDataSlotCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PRIVATE_DATA_SLOT_CREATE_INFO||0),
...
const VkPrivateDataSlotCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPrivateDataSlotCreateInfo"));


const VkPhysicalDevicePrivateDataFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePrivateDataFeatures", {
    sType: "u32("+(V.VkPhysicalDevicePrivateDataFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES||0),
...
const VkPhysicalDevicePrivateDataFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDevicePrivateDataFeatures"));


const VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_NV||0),
...
const VkPhysicalDeviceMultiDrawPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMultiDrawPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceMultiDrawPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT||0),
...
const VkGraphicsShaderGroupCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkGraphicsShaderGroupCreateInfoNV", {
    sType: "u32("+(V.VkGraphicsShaderGroupCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GRAPHICS_SHADER_GROUP_CREATE_INFO_NV||0),
...
const VkGraphicsPipelineShaderGroupsCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkGraphicsPipelineShaderGroupsCreateInfoNV", {
    sType: "u32("+(V.VkGraphicsPipelineShaderGroupsCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_SHADER_GROUPS_CREATE_INFO_NV||0),
...
const VkBindShaderGroupIndirectCommandNV = new Proxy(C.CStructView, new C.CStruct("VkBindShaderGroupIndirectCommandNV", {
    groupIndex: "u32("+(V.VkBindShaderGroupIndirectCommandNV_groupIndex_offsetof||0)+")",
}, (V.VkBindShaderGroupIndirectCommandNV_sizeof||0)));


const VkBindIndexBufferIndirectCommandNV = new Proxy(C.CStructView, new C.CStruct("VkBindIndexBufferIndirectCommandNV", {
...
const VkBindVertexBufferIndirectCommandNV = new Proxy(C.CStructView, new C.CStruct("VkBindVertexBufferIndirectCommandNV", {
...
const VkSetStateFlagsIndirectCommandNV = new Proxy(C.CStructView, new C.CStruct("VkSetStateFlagsIndirectCommandNV", {
...
const VkIndirectCommandsLayoutTokenNV = new Proxy(C.CStructView, new C.CStruct("VkIndirectCommandsLayoutTokenNV", {
    sType: "u32("+(V.VkIndirectCommandsLayoutTokenNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_NV||0),
...
const VkIndirectCommandsLayoutCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkIndirectCommandsLayoutCreateInfoNV", {
    sType: "u32("+(V.VkIndirectCommandsLayoutCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NV||0),
...
const VkGeneratedCommandsInfoNV = new Proxy(C.CStructView, new C.CStruct("VkGeneratedCommandsInfoNV", {
    sType: "u32("+(V.VkGeneratedCommandsInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_NV||0),
    ...
    indirectCommandsLayout: "VkIndirectCommandsLayoutNV("+(V.VkGeneratedCommandsInfoNV_indirectCommandsLayout_offsetof||0)+")",
...
const VkGeneratedCommandsMemoryRequirementsInfoNV = new Proxy(C.CStructView, new C.CStruct("VkGeneratedCommandsMemoryRequirementsInfoNV", {
    sType: "u32("+(V.VkGeneratedCommandsMemoryRequirementsInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_NV||0),
    ...
    indirectCommandsLayout: "VkIndirectCommandsLayoutNV("+(V.VkGeneratedCommandsMemoryRequirementsInfoNV_indirectCommandsLayout_offsetof||0)+")",
...
const VkFormatProperties2 = new Proxy(C.CStructView, new C.CStruct("VkFormatProperties2", {
    sType: "u32("+(V.VkFormatProperties2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2||0),
    pNext: "u64("+(V.VkFormatProperties2_pNext_offsetof||0)+")",
    formatProperties: "VkFormatProperties("+(V.VkFormatProperties2_formatProperties_offsetof||0)+")",
}, (V.VkFormatProperties2_sizeof||0)));

const VkFormatProperties2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkFormatProperties2"));


const VkImageFormatProperties2 = new Proxy(C.CStructView, new C.CStruct("VkImageFormatProperties2", {
    sType: "u32("+(V.VkImageFormatProperties2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_FORMAT_PROPERTIES_2||0),
    pNext: "u64("+(V.VkImageFormatProperties2_pNext_offsetof||0)+")",
    imageFormatProperties: "VkImageFormatProperties("+(V.VkImageFormatProperties2_imageFormatProperties_offsetof||0)+")",
}, (V.VkImageFormatProperties2_sizeof||0)));

const VkImageFormatProperties2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageFormatProperties2"));


const VkPhysicalDeviceImageFormatInfo2 = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageFormatInfo2", {
    sType: "u32("+(V.VkPhysicalDeviceImageFormatInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2||0),
...
const VkPhysicalDeviceImageFormatInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceImageFormatInfo2"));


const VkQueueFamilyProperties2 = new Proxy(C.CStructView, new C.CStruct("VkQueueFamilyProperties2", {
    sType: "u32("+(V.VkQueueFamilyProperties2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUEUE_FAMILY_PROPERTIES_2||0),
    pNext: "u64("+(V.VkQueueFamilyProperties2_pNext_offsetof||0)+")",
    queueFamilyProperties: "VkQueueFamilyProperties("+(V.VkQueueFamilyProperties2_queueFamilyProperties_offsetof||0)+")",
}, (V.VkQueueFamilyProperties2_sizeof||0)));

const VkQueueFamilyProperties2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkQueueFamilyProperties2"));


const VkPhysicalDeviceMemoryProperties2 = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMemoryProperties2", {
    sType: "u32("+(V.VkPhysicalDeviceMemoryProperties2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PROPERTIES_2||0),
    pNext: "u64("+(V.VkPhysicalDeviceMemoryProperties2_pNext_offsetof||0)+")",
    memoryProperties: "VkPhysicalDeviceMemoryProperties("+(V.VkPhysicalDeviceMemoryProperties2_memoryProperties_offsetof||0)+")",
}, (V.VkPhysicalDeviceMemoryProperties2_sizeof||0)));

const VkPhysicalDeviceMemoryProperties2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceMemoryProperties2"));


const VkSparseImageFormatProperties2 = new Proxy(C.CStructView, new C.CStruct("VkSparseImageFormatProperties2", {
    sType: "u32("+(V.VkSparseImageFormatProperties2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2||0),
    pNext: "u64("+(V.VkSparseImageFormatProperties2_pNext_offsetof||0)+")",
    properties: "VkSparseImageFormatProperties("+(V.VkSparseImageFormatProperties2_properties_offsetof||0)+")",
}, (V.VkSparseImageFormatProperties2_sizeof||0)));

const VkSparseImageFormatProperties2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSparseImageFormatProperties2"));


const VkPhysicalDeviceSparseImageFormatInfo2 = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSparseImageFormatInfo2", {
    sType: "u32("+(V.VkPhysicalDeviceSparseImageFormatInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2||0),
...
const VkPhysicalDeviceSparseImageFormatInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceSparseImageFormatInfo2"));


const VkPhysicalDevicePushDescriptorPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePushDescriptorPropertiesKHR", {
    sType: "u32("+(V.VkPhysicalDevicePushDescriptorPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR||0),
...
const VkConformanceVersion = new Proxy(C.CStructView, new C.CStruct("VkConformanceVersion", {
...
const VkConformanceVersionKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkConformanceVersion"));


const VkPhysicalDeviceDriverProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDriverProperties", {
    sType: "u32("+(V.VkPhysicalDeviceDriverProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES||0),
    ...
    conformanceVersion: "VkConformanceVersion("+(V.VkPhysicalDeviceDriverProperties_conformanceVersion_offsetof||0)+")",
}, (V.VkPhysicalDeviceDriverProperties_sizeof||0)));

const VkPhysicalDeviceDriverPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceDriverProperties"));


const VkPresentRegionsKHR = new Proxy(C.CStructView, new C.CStruct("VkPresentRegionsKHR", {
    sType: "u32("+(V.VkPresentRegionsKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PRESENT_REGIONS_KHR||0),
...
const VkPresentRegionKHR = new Proxy(C.CStructView, new C.CStruct("VkPresentRegionKHR", {
...
const VkRectLayerKHR = new Proxy(C.CStructView, new C.CStruct("VkRectLayerKHR", {
...
const VkPhysicalDeviceVariablePointersFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVariablePointersFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceVariablePointersFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES||0),
...
const VkPhysicalDeviceVariablePointersFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceVariablePointersFeatures"));

const VkPhysicalDeviceVariablePointerFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceVariablePointersFeatures"));

const VkPhysicalDeviceVariablePointerFeatures = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceVariablePointersFeatures"));


const VkExternalMemoryProperties = new Proxy(C.CStructView, new C.CStruct("VkExternalMemoryProperties", {
...
const VkExternalMemoryPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExternalMemoryProperties"));


const VkPhysicalDeviceExternalImageFormatInfo = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExternalImageFormatInfo", {
    sType: "u32("+(V.VkPhysicalDeviceExternalImageFormatInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO||0),
...
const VkPhysicalDeviceExternalImageFormatInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceExternalImageFormatInfo"));


const VkExternalImageFormatProperties = new Proxy(C.CStructView, new C.CStruct("VkExternalImageFormatProperties", {
    sType: "u32("+(V.VkExternalImageFormatProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES||0),
    pNext: "u64("+(V.VkExternalImageFormatProperties_pNext_offsetof||0)+")",
    externalMemoryProperties: "VkExternalMemoryProperties("+(V.VkExternalImageFormatProperties_externalMemoryProperties_offsetof||0)+")",
}, (V.VkExternalImageFormatProperties_sizeof||0)));

const VkExternalImageFormatPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExternalImageFormatProperties"));


const VkPhysicalDeviceExternalBufferInfo = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExternalBufferInfo", {
    sType: "u32("+(V.VkPhysicalDeviceExternalBufferInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO||0),
...
const VkPhysicalDeviceExternalBufferInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceExternalBufferInfo"));


const VkExternalBufferProperties = new Proxy(C.CStructView, new C.CStruct("VkExternalBufferProperties", {
    sType: "u32("+(V.VkExternalBufferProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES||0),
    pNext: "u64("+(V.VkExternalBufferProperties_pNext_offsetof||0)+")",
    externalMemoryProperties: "VkExternalMemoryProperties("+(V.VkExternalBufferProperties_externalMemoryProperties_offsetof||0)+")",
}, (V.VkExternalBufferProperties_sizeof||0)));

const VkExternalBufferPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExternalBufferProperties"));


const VkPhysicalDeviceIDProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceIDProperties", {
    sType: "u32("+(V.VkPhysicalDeviceIDProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES||0),
...
const VkPhysicalDeviceIDPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceIDProperties"));


const VkExternalMemoryImageCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkExternalMemoryImageCreateInfo", {
    sType: "u32("+(V.VkExternalMemoryImageCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO||0),
...
const VkExternalMemoryImageCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExternalMemoryImageCreateInfo"));


const VkExternalMemoryBufferCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkExternalMemoryBufferCreateInfo", {
    sType: "u32("+(V.VkExternalMemoryBufferCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO||0),
...
const VkExternalMemoryBufferCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExternalMemoryBufferCreateInfo"));


const VkExportMemoryAllocateInfo = new Proxy(C.CStructView, new C.CStruct("VkExportMemoryAllocateInfo", {
    sType: "u32("+(V.VkExportMemoryAllocateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO||0),
...
const VkExportMemoryAllocateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExportMemoryAllocateInfo"));


const VkImportMemoryWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkImportMemoryWin32HandleInfoKHR", {
    sType: "u32("+(V.VkImportMemoryWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHR||0),
    ...
    name: "u64("+(V.VkImportMemoryWin32HandleInfoKHR_name_offsetof||0)+")",
}, (V.VkImportMemoryWin32HandleInfoKHR_sizeof||0)));


const VkExportMemoryWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkExportMemoryWin32HandleInfoKHR", {
    sType: "u32("+(V.VkExportMemoryWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHR||0),
    ...
    name: "u64("+(V.VkExportMemoryWin32HandleInfoKHR_name_offsetof||0)+")",
}, (V.VkExportMemoryWin32HandleInfoKHR_sizeof||0)));


const VkImportMemoryZirconHandleInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkImportMemoryZirconHandleInfoFUCHSIA", {
    sType: "u32("+(V.VkImportMemoryZirconHandleInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_MEMORY_ZIRCON_HANDLE_INFO_FUCHSIA||0),
    ...
    handle: "zx_handle_t("+(V.VkImportMemoryZirconHandleInfoFUCHSIA_handle_offsetof||0)+")",
}, (V.VkImportMemoryZirconHandleInfoFUCHSIA_sizeof||0)));


const VkMemoryZirconHandlePropertiesFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkMemoryZirconHandlePropertiesFUCHSIA", {
    sType: "u32("+(V.VkMemoryZirconHandlePropertiesFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_ZIRCON_HANDLE_PROPERTIES_FUCHSIA||0),
...
const VkMemoryGetZirconHandleInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkMemoryGetZirconHandleInfoFUCHSIA", {
    sType: "u32("+(V.VkMemoryGetZirconHandleInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_GET_ZIRCON_HANDLE_INFO_FUCHSIA||0),
...
const VkMemoryWin32HandlePropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkMemoryWin32HandlePropertiesKHR", {
    sType: "u32("+(V.VkMemoryWin32HandlePropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHR||0),
...
const VkMemoryGetWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkMemoryGetWin32HandleInfoKHR", {
    sType: "u32("+(V.VkMemoryGetWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_GET_WIN32_HANDLE_INFO_KHR||0),
...
const VkImportMemoryFdInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkImportMemoryFdInfoKHR", {
    sType: "u32("+(V.VkImportMemoryFdInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHR||0),
    pNext: "u64("+(V.VkImportMemoryFdInfoKHR_pNext_offsetof||0)+")",
    handleType: "u32("+(V.VkImportMemoryFdInfoKHR_handleType_offsetof||0)+")",
    fd: "int("+(V.VkImportMemoryFdInfoKHR_fd_offsetof||0)+")",
}, (V.VkImportMemoryFdInfoKHR_sizeof||0)));


const VkMemoryFdPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkMemoryFdPropertiesKHR", {
    sType: "u32("+(V.VkMemoryFdPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHR||0),
...
const VkMemoryGetFdInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkMemoryGetFdInfoKHR", {
    sType: "u32("+(V.VkMemoryGetFdInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_GET_FD_INFO_KHR||0),
...
const VkWin32KeyedMutexAcquireReleaseInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkWin32KeyedMutexAcquireReleaseInfoKHR", {
    sType: "u32("+(V.VkWin32KeyedMutexAcquireReleaseInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHR||0),
...
const VkPhysicalDeviceExternalSemaphoreInfo = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExternalSemaphoreInfo", {
    sType: "u32("+(V.VkPhysicalDeviceExternalSemaphoreInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO||0),
...
const VkPhysicalDeviceExternalSemaphoreInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceExternalSemaphoreInfo"));


const VkExternalSemaphoreProperties = new Proxy(C.CStructView, new C.CStruct("VkExternalSemaphoreProperties", {
    sType: "u32("+(V.VkExternalSemaphoreProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES||0),
...
const VkExternalSemaphorePropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExternalSemaphoreProperties"));


const VkExportSemaphoreCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkExportSemaphoreCreateInfo", {
    sType: "u32("+(V.VkExportSemaphoreCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO||0),
...
const VkExportSemaphoreCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExportSemaphoreCreateInfo"));


const VkImportSemaphoreWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkImportSemaphoreWin32HandleInfoKHR", {
    sType: "u32("+(V.VkImportSemaphoreWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR||0),
    ...
    name: "u64("+(V.VkImportSemaphoreWin32HandleInfoKHR_name_offsetof||0)+")",
}, (V.VkImportSemaphoreWin32HandleInfoKHR_sizeof||0)));


const VkExportSemaphoreWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkExportSemaphoreWin32HandleInfoKHR", {
    sType: "u32("+(V.VkExportSemaphoreWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR||0),
    ...
    name: "u64("+(V.VkExportSemaphoreWin32HandleInfoKHR_name_offsetof||0)+")",
}, (V.VkExportSemaphoreWin32HandleInfoKHR_sizeof||0)));


const VkD3D12FenceSubmitInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkD3D12FenceSubmitInfoKHR", {
    sType: "u32("+(V.VkD3D12FenceSubmitInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHR||0),
...
const VkSemaphoreGetWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkSemaphoreGetWin32HandleInfoKHR", {
    sType: "u32("+(V.VkSemaphoreGetWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SEMAPHORE_GET_WIN32_HANDLE_INFO_KHR||0),
...
const VkImportSemaphoreFdInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkImportSemaphoreFdInfoKHR", {
    sType: "u32("+(V.VkImportSemaphoreFdInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHR||0),
    ...
    fd: "int("+(V.VkImportSemaphoreFdInfoKHR_fd_offsetof||0)+")",
}, (V.VkImportSemaphoreFdInfoKHR_sizeof||0)));


const VkSemaphoreGetFdInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkSemaphoreGetFdInfoKHR", {
    sType: "u32("+(V.VkSemaphoreGetFdInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SEMAPHORE_GET_FD_INFO_KHR||0),
...
const VkImportSemaphoreZirconHandleInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkImportSemaphoreZirconHandleInfoFUCHSIA", {
    sType: "u32("+(V.VkImportSemaphoreZirconHandleInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_ZIRCON_HANDLE_INFO_FUCHSIA||0),
    ...
    zirconHandle: "zx_handle_t("+(V.VkImportSemaphoreZirconHandleInfoFUCHSIA_zirconHandle_offsetof||0)+")",
}, (V.VkImportSemaphoreZirconHandleInfoFUCHSIA_sizeof||0)));


const VkSemaphoreGetZirconHandleInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkSemaphoreGetZirconHandleInfoFUCHSIA", {
    sType: "u32("+(V.VkSemaphoreGetZirconHandleInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SEMAPHORE_GET_ZIRCON_HANDLE_INFO_FUCHSIA||0),
...
const VkPhysicalDeviceExternalFenceInfo = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExternalFenceInfo", {
    sType: "u32("+(V.VkPhysicalDeviceExternalFenceInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FENCE_INFO||0),
...
const VkPhysicalDeviceExternalFenceInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceExternalFenceInfo"));


const VkExternalFenceProperties = new Proxy(C.CStructView, new C.CStruct("VkExternalFenceProperties", {
    sType: "u32("+(V.VkExternalFenceProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXTERNAL_FENCE_PROPERTIES||0),
...
const VkExternalFencePropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExternalFenceProperties"));


const VkExportFenceCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkExportFenceCreateInfo", {
    sType: "u32("+(V.VkExportFenceCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO||0),
...
const VkExportFenceCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkExportFenceCreateInfo"));


const VkImportFenceWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkImportFenceWin32HandleInfoKHR", {
    sType: "u32("+(V.VkImportFenceWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_FENCE_WIN32_HANDLE_INFO_KHR||0),
    ...
    name: "u64("+(V.VkImportFenceWin32HandleInfoKHR_name_offsetof||0)+")",
}, (V.VkImportFenceWin32HandleInfoKHR_sizeof||0)));


const VkExportFenceWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkExportFenceWin32HandleInfoKHR", {
    sType: "u32("+(V.VkExportFenceWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_FENCE_WIN32_HANDLE_INFO_KHR||0),
    ...
    name: "u64("+(V.VkExportFenceWin32HandleInfoKHR_name_offsetof||0)+")",
}, (V.VkExportFenceWin32HandleInfoKHR_sizeof||0)));


const VkFenceGetWin32HandleInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkFenceGetWin32HandleInfoKHR", {
    sType: "u32("+(V.VkFenceGetWin32HandleInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FENCE_GET_WIN32_HANDLE_INFO_KHR||0),
...
const VkImportFenceFdInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkImportFenceFdInfoKHR", {
    sType: "u32("+(V.VkImportFenceFdInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_FENCE_FD_INFO_KHR||0),
    ...
    fd: "int("+(V.VkImportFenceFdInfoKHR_fd_offsetof||0)+")",
}, (V.VkImportFenceFdInfoKHR_sizeof||0)));


const VkFenceGetFdInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkFenceGetFdInfoKHR", {
    sType: "u32("+(V.VkFenceGetFdInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FENCE_GET_FD_INFO_KHR||0),
...
const VkPhysicalDeviceMultiviewFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMultiviewFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceMultiviewFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_FEATURES||0),
...
const VkPhysicalDeviceMultiviewFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceMultiviewFeatures"));


const VkPhysicalDeviceMultiviewProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMultiviewProperties", {
    sType: "u32("+(V.VkPhysicalDeviceMultiviewProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES||0),
...
const VkPhysicalDeviceMultiviewPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceMultiviewProperties"));


const VkRenderPassMultiviewCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkRenderPassMultiviewCreateInfo", {
    sType: "u32("+(V.VkRenderPassMultiviewCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_MULTIVIEW_CREATE_INFO||0),
...
const VkRenderPassMultiviewCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkRenderPassMultiviewCreateInfo"));


const VkSurfaceCapabilities2EXT = new Proxy(C.CStructView, new C.CStruct("VkSurfaceCapabilities2EXT", {
    sType: "u32("+(V.VkSurfaceCapabilities2EXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_2_EXT||0),
...
const VkDisplayPowerInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDisplayPowerInfoEXT", {
    sType: "u32("+(V.VkDisplayPowerInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_POWER_INFO_EXT||0),
...
const VkDeviceEventInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceEventInfoEXT", {
    sType: "u32("+(V.VkDeviceEventInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_EVENT_INFO_EXT||0),
...
const VkDisplayEventInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDisplayEventInfoEXT", {
    sType: "u32("+(V.VkDisplayEventInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_EVENT_INFO_EXT||0),
...
const VkSwapchainCounterCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkSwapchainCounterCreateInfoEXT", {
    sType: "u32("+(V.VkSwapchainCounterCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SWAPCHAIN_COUNTER_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceGroupProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceGroupProperties", {
    sType: "u32("+(V.VkPhysicalDeviceGroupProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GROUP_PROPERTIES||0),
...
const VkPhysicalDeviceGroupPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceGroupProperties"));


const VkMemoryAllocateFlagsInfo = new Proxy(C.CStructView, new C.CStruct("VkMemoryAllocateFlagsInfo", {
    sType: "u32("+(V.VkMemoryAllocateFlagsInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO||0),
...
const VkMemoryAllocateFlagsInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkMemoryAllocateFlagsInfo"));
...
const VkBindBufferMemoryInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBindBufferMemoryInfo"));


const VkBindBufferMemoryDeviceGroupInfo = new Proxy(C.CStructView, new C.CStruct("VkBindBufferMemoryDeviceGroupInfo", {
    sType: "u32("+(V.VkBindBufferMemoryDeviceGroupInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_DEVICE_GROUP_INFO||0),
...
const VkBindBufferMemoryDeviceGroupInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBindBufferMemoryDeviceGroupInfo"));


const VkBindImageMemoryInfo = new Proxy(C.CStructView, new C.CStruct("VkBindImageMemoryInfo", {
    sType: "u32("+(V.VkBindImageMemoryInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_INFO||0),
...
const VkBindImageMemoryInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBindImageMemoryInfo"));


const VkBindImageMemoryDeviceGroupInfo = new Proxy(C.CStructView, new C.CStruct("VkBindImageMemoryDeviceGroupInfo", {
    sType: "u32("+(V.VkBindImageMemoryDeviceGroupInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_DEVICE_GROUP_INFO||0),
...
const VkBindImageMemoryDeviceGroupInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBindImageMemoryDeviceGroupInfo"));


const VkDeviceGroupRenderPassBeginInfo = new Proxy(C.CStructView, new C.CStruct("VkDeviceGroupRenderPassBeginInfo", {
    sType: "u32("+(V.VkDeviceGroupRenderPassBeginInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_GROUP_RENDER_PASS_BEGIN_INFO||0),
...
const VkDeviceGroupRenderPassBeginInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceGroupRenderPassBeginInfo"));


const VkDeviceGroupCommandBufferBeginInfo = new Proxy(C.CStructView, new C.CStruct("VkDeviceGroupCommandBufferBeginInfo", {
    sType: "u32("+(V.VkDeviceGroupCommandBufferBeginInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_GROUP_COMMAND_BUFFER_BEGIN_INFO||0),
...
const VkDeviceGroupCommandBufferBeginInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceGroupCommandBufferBeginInfo"));


const VkDeviceGroupSubmitInfo = new Proxy(C.CStructView, new C.CStruct("VkDeviceGroupSubmitInfo", {
    sType: "u32("+(V.VkDeviceGroupSubmitInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO||0),
...
const VkDeviceGroupSubmitInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceGroupSubmitInfo"));


const VkDeviceGroupBindSparseInfo = new Proxy(C.CStructView, new C.CStruct("VkDeviceGroupBindSparseInfo", {
    sType: "u32("+(V.VkDeviceGroupBindSparseInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO||0),
...
const VkDeviceGroupBindSparseInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceGroupBindSparseInfo"));


const VkDeviceGroupPresentCapabilitiesKHR = new Proxy(C.CStructView, new C.CStruct("VkDeviceGroupPresentCapabilitiesKHR", {
    sType: "u32("+(V.VkDeviceGroupPresentCapabilitiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_CAPABILITIES_KHR||0),
...
const VkImageSwapchainCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkImageSwapchainCreateInfoKHR", {
    sType: "u32("+(V.VkImageSwapchainCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_SWAPCHAIN_CREATE_INFO_KHR||0),
...
const VkBindImageMemorySwapchainInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkBindImageMemorySwapchainInfoKHR", {
    sType: "u32("+(V.VkBindImageMemorySwapchainInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_SWAPCHAIN_INFO_KHR||0),
...
const VkAcquireNextImageInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAcquireNextImageInfoKHR", {
    sType: "u32("+(V.VkAcquireNextImageInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACQUIRE_NEXT_IMAGE_INFO_KHR||0),
...
const VkDeviceGroupPresentInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkDeviceGroupPresentInfoKHR", {
    sType: "u32("+(V.VkDeviceGroupPresentInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_INFO_KHR||0),
...
const VkDeviceGroupDeviceCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDeviceGroupDeviceCreateInfo", {
    sType: "u32("+(V.VkDeviceGroupDeviceCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_GROUP_DEVICE_CREATE_INFO||0),
...
const VkDeviceGroupDeviceCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceGroupDeviceCreateInfo"));


const VkDeviceGroupSwapchainCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkDeviceGroupSwapchainCreateInfoKHR", {
    sType: "u32("+(V.VkDeviceGroupSwapchainCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_GROUP_SWAPCHAIN_CREATE_INFO_KHR||0),
...
const VkDescriptorUpdateTemplateEntry = new Proxy(C.CStructView, new C.CStruct("VkDescriptorUpdateTemplateEntry", {
...
const VkDescriptorUpdateTemplateEntryKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDescriptorUpdateTemplateEntry"));


const VkDescriptorUpdateTemplateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDescriptorUpdateTemplateCreateInfo", {
    sType: "u32("+(V.VkDescriptorUpdateTemplateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_CREATE_INFO||0),
...
const VkDescriptorUpdateTemplateCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDescriptorUpdateTemplateCreateInfo"));


const VkXYColorEXT = new Proxy(C.CStructView, new C.CStruct("VkXYColorEXT", {
    x: "f32("+(V.VkXYColorEXT_x_offsetof||0)+")",
    y: "f32("+(V.VkXYColorEXT_y_offsetof||0)+")",
}, (V.VkXYColorEXT_sizeof||0)));


const VkPhysicalDevicePresentIdFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePresentIdFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDevicePresentIdFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_FEATURES_KHR||0),
...
const VkPresentIdKHR = new Proxy(C.CStructView, new C.CStruct("VkPresentIdKHR", {
    sType: "u32("+(V.VkPresentIdKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PRESENT_ID_KHR||0),
...
const VkPhysicalDevicePresentWaitFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePresentWaitFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDevicePresentWaitFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_FEATURES_KHR||0),
...
const VkHdrMetadataEXT = new Proxy(C.CStructView, new C.CStruct("VkHdrMetadataEXT", {
    sType: "u32("+(V.VkHdrMetadataEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_HDR_METADATA_EXT||0),
    pNext: "u64("+(V.VkHdrMetadataEXT_pNext_offsetof||0)+")",
    displayPrimaryRed: "VkXYColorEXT("+(V.VkHdrMetadataEXT_displayPrimaryRed_offsetof||0)+")",
    displayPrimaryGreen: "VkXYColorEXT("+(V.VkHdrMetadataEXT_displayPrimaryGreen_offsetof||0)+")",
    displayPrimaryBlue: "VkXYColorEXT("+(V.VkHdrMetadataEXT_displayPrimaryBlue_offsetof||0)+")",
    whitePoint: "VkXYColorEXT("+(V.VkHdrMetadataEXT_whitePoint_offsetof||0)+")",
...
const VkDisplayNativeHdrSurfaceCapabilitiesAMD = new Proxy(C.CStructView, new C.CStruct("VkDisplayNativeHdrSurfaceCapabilitiesAMD", {
    sType: "u32("+(V.VkDisplayNativeHdrSurfaceCapabilitiesAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_NATIVE_HDR_SURFACE_CAPABILITIES_AMD||0),
...
const VkSwapchainDisplayNativeHdrCreateInfoAMD = new Proxy(C.CStructView, new C.CStruct("VkSwapchainDisplayNativeHdrCreateInfoAMD", {
    sType: "u32("+(V.VkSwapchainDisplayNativeHdrCreateInfoAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SWAPCHAIN_DISPLAY_NATIVE_HDR_CREATE_INFO_AMD||0),
...
const VkRefreshCycleDurationGOOGLE = new Proxy(C.CStructView, new C.CStruct("VkRefreshCycleDurationGOOGLE", {
    refreshDuration: "u64("+(V.VkRefreshCycleDurationGOOGLE_refreshDuration_offsetof||0)+")",
}, (V.VkRefreshCycleDurationGOOGLE_sizeof||0)));


const VkPastPresentationTimingGOOGLE = new Proxy(C.CStructView, new C.CStruct("VkPastPresentationTimingGOOGLE", {
...
const VkPresentTimesInfoGOOGLE = new Proxy(C.CStructView, new C.CStruct("VkPresentTimesInfoGOOGLE", {
    sType: "u32("+(V.VkPresentTimesInfoGOOGLE_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PRESENT_TIMES_INFO_GOOGLE||0),
...
const VkPresentTimeGOOGLE = new Proxy(C.CStructView, new C.CStruct("VkPresentTimeGOOGLE", {
...
const VkIOSSurfaceCreateInfoMVK = new Proxy(C.CStructView, new C.CStruct("VkIOSSurfaceCreateInfoMVK", {
    sType: "u32("+(V.VkIOSSurfaceCreateInfoMVK_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IOS_SURFACE_CREATE_INFO_MVK||0),
...
const VkMacOSSurfaceCreateInfoMVK = new Proxy(C.CStructView, new C.CStruct("VkMacOSSurfaceCreateInfoMVK", {
    sType: "u32("+(V.VkMacOSSurfaceCreateInfoMVK_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MACOS_SURFACE_CREATE_INFO_MVK||0),
...
const VkMetalSurfaceCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMetalSurfaceCreateInfoEXT", {
    sType: "u32("+(V.VkMetalSurfaceCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_METAL_SURFACE_CREATE_INFO_EXT||0),
...
const VkViewportWScalingNV = new Proxy(C.CStructView, new C.CStruct("VkViewportWScalingNV", {
...
const VkPipelineViewportWScalingStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineViewportWScalingStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineViewportWScalingStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_W_SCALING_STATE_CREATE_INFO_NV||0),
...
const VkViewportSwizzleNV = new Proxy(C.CStructView, new C.CStruct("VkViewportSwizzleNV", {
...
const VkPipelineViewportSwizzleStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineViewportSwizzleStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineViewportSwizzleStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SWIZZLE_STATE_CREATE_INFO_NV||0),
...
const VkPhysicalDeviceDiscardRectanglePropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDiscardRectanglePropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDiscardRectanglePropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT||0),
...
const VkPipelineDiscardRectangleStateCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineDiscardRectangleStateCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineDiscardRectangleStateCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_DISCARD_RECTANGLE_STATE_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX", {
    sType: "u32("+(V.VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_ATTRIBUTES_PROPERTIES_NVX||0),
...
const VkInputAttachmentAspectReference = new Proxy(C.CStructView, new C.CStruct("VkInputAttachmentAspectReference", {
...
const VkInputAttachmentAspectReferenceKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkInputAttachmentAspectReference"));


const VkRenderPassInputAttachmentAspectCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkRenderPassInputAttachmentAspectCreateInfo", {
    sType: "u32("+(V.VkRenderPassInputAttachmentAspectCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO||0),
...
const VkRenderPassInputAttachmentAspectCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkRenderPassInputAttachmentAspectCreateInfo"));


const VkPhysicalDeviceSurfaceInfo2KHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSurfaceInfo2KHR", {
    sType: "u32("+(V.VkPhysicalDeviceSurfaceInfo2KHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SURFACE_INFO_2_KHR||0),
...
const VkSurfaceCapabilities2KHR = new Proxy(C.CStructView, new C.CStruct("VkSurfaceCapabilities2KHR", {
    sType: "u32("+(V.VkSurfaceCapabilities2KHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_2_KHR||0),
    pNext: "u64("+(V.VkSurfaceCapabilities2KHR_pNext_offsetof||0)+")",
    surfaceCapabilities: "VkSurfaceCapabilitiesKHR("+(V.VkSurfaceCapabilities2KHR_surfaceCapabilities_offsetof||0)+")",
}, (V.VkSurfaceCapabilities2KHR_sizeof||0)));


const VkSurfaceFormat2KHR = new Proxy(C.CStructView, new C.CStruct("VkSurfaceFormat2KHR", {
    sType: "u32("+(V.VkSurfaceFormat2KHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SURFACE_FORMAT_2_KHR||0),
    pNext: "u64("+(V.VkSurfaceFormat2KHR_pNext_offsetof||0)+")",
    surfaceFormat: "VkSurfaceFormatKHR("+(V.VkSurfaceFormat2KHR_surfaceFormat_offsetof||0)+")",
}, (V.VkSurfaceFormat2KHR_sizeof||0)));


const VkDisplayProperties2KHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayProperties2KHR", {
    sType: "u32("+(V.VkDisplayProperties2KHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_PROPERTIES_2_KHR||0),
    pNext: "u64("+(V.VkDisplayProperties2KHR_pNext_offsetof||0)+")",
    displayProperties: "VkDisplayPropertiesKHR("+(V.VkDisplayProperties2KHR_displayProperties_offsetof||0)+")",
}, (V.VkDisplayProperties2KHR_sizeof||0)));


const VkDisplayPlaneProperties2KHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayPlaneProperties2KHR", {
    sType: "u32("+(V.VkDisplayPlaneProperties2KHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_PLANE_PROPERTIES_2_KHR||0),
    pNext: "u64("+(V.VkDisplayPlaneProperties2KHR_pNext_offsetof||0)+")",
    displayPlaneProperties: "VkDisplayPlanePropertiesKHR("+(V.VkDisplayPlaneProperties2KHR_displayPlaneProperties_offsetof||0)+")",
}, (V.VkDisplayPlaneProperties2KHR_sizeof||0)));


const VkDisplayModeProperties2KHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayModeProperties2KHR", {
    sType: "u32("+(V.VkDisplayModeProperties2KHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_MODE_PROPERTIES_2_KHR||0),
    pNext: "u64("+(V.VkDisplayModeProperties2KHR_pNext_offsetof||0)+")",
    displayModeProperties: "VkDisplayModePropertiesKHR("+(V.VkDisplayModeProperties2KHR_displayModeProperties_offsetof||0)+")",
}, (V.VkDisplayModeProperties2KHR_sizeof||0)));


const VkDisplayPlaneInfo2KHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayPlaneInfo2KHR", {
    sType: "u32("+(V.VkDisplayPlaneInfo2KHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_PLANE_INFO_2_KHR||0),
    pNext: "u64("+(V.VkDisplayPlaneInfo2KHR_pNext_offsetof||0)+")",
    mode: "VkDisplayModeKHR("+(V.VkDisplayPlaneInfo2KHR_mode_offsetof||0)+")",
    planeIndex: "u32("+(V.VkDisplayPlaneInfo2KHR_planeIndex_offsetof||0)+")",
}, (V.VkDisplayPlaneInfo2KHR_sizeof||0)));


const VkDisplayPlaneCapabilities2KHR = new Proxy(C.CStructView, new C.CStruct("VkDisplayPlaneCapabilities2KHR", {
    sType: "u32("+(V.VkDisplayPlaneCapabilities2KHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DISPLAY_PLANE_CAPABILITIES_2_KHR||0),
    pNext: "u64("+(V.VkDisplayPlaneCapabilities2KHR_pNext_offsetof||0)+")",
    capabilities: "VkDisplayPlaneCapabilitiesKHR("+(V.VkDisplayPlaneCapabilities2KHR_capabilities_offsetof||0)+")",
}, (V.VkDisplayPlaneCapabilities2KHR_sizeof||0)));


const VkSharedPresentSurfaceCapabilitiesKHR = new Proxy(C.CStructView, new C.CStruct("VkSharedPresentSurfaceCapabilitiesKHR", {
    sType: "u32("+(V.VkSharedPresentSurfaceCapabilitiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_KHR||0),
...
const VkPhysicalDevice16BitStorageFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevice16BitStorageFeatures", {
    sType: "u32("+(V.VkPhysicalDevice16BitStorageFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES||0),
...
const VkPhysicalDevice16BitStorageFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDevice16BitStorageFeatures"));


const VkPhysicalDeviceSubgroupProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSubgroupProperties", {
    sType: "u32("+(V.VkPhysicalDeviceSubgroupProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_PROPERTIES||0),
...
const VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES||0),
...
const VkPhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures"));
...
const VkDeviceBufferMemoryRequirements = new Proxy(C.CStructView, new C.CStruct("VkDeviceBufferMemoryRequirements", {
    sType: "u32("+(V.VkDeviceBufferMemoryRequirements_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_BUFFER_MEMORY_REQUIREMENTS||0),
...
const VkDeviceBufferMemoryRequirementsKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceBufferMemoryRequirements"));


const VkImageMemoryRequirementsInfo2 = new Proxy(C.CStructView, new C.CStruct("VkImageMemoryRequirementsInfo2", {
    sType: "u32("+(V.VkImageMemoryRequirementsInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_MEMORY_REQUIREMENTS_INFO_2||0),
...
const VkImageMemoryRequirementsInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageMemoryRequirementsInfo2"));


const VkImageSparseMemoryRequirementsInfo2 = new Proxy(C.CStructView, new C.CStruct("VkImageSparseMemoryRequirementsInfo2", {
    sType: "u32("+(V.VkImageSparseMemoryRequirementsInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_SPARSE_MEMORY_REQUIREMENTS_INFO_2||0),
...
const VkImageSparseMemoryRequirementsInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageSparseMemoryRequirementsInfo2"));


const VkDeviceImageMemoryRequirements = new Proxy(C.CStructView, new C.CStruct("VkDeviceImageMemoryRequirements", {
    sType: "u32("+(V.VkDeviceImageMemoryRequirements_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_IMAGE_MEMORY_REQUIREMENTS||0),
...
const VkDeviceImageMemoryRequirementsKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceImageMemoryRequirements"));
...
const VkSparseImageMemoryRequirements2 = new Proxy(C.CStructView, new C.CStruct("VkSparseImageMemoryRequirements2", {
    sType: "u32("+(V.VkSparseImageMemoryRequirements2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SPARSE_IMAGE_MEMORY_REQUIREMENTS_2||0),
    pNext: "u64("+(V.VkSparseImageMemoryRequirements2_pNext_offsetof||0)+")",
    memoryRequirements: "VkSparseImageMemoryRequirements("+(V.VkSparseImageMemoryRequirements2_memoryRequirements_offsetof||0)+")",
}, (V.VkSparseImageMemoryRequirements2_sizeof||0)));

const VkSparseImageMemoryRequirements2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSparseImageMemoryRequirements2"));


const VkPhysicalDevicePointClippingProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePointClippingProperties", {
    sType: "u32("+(V.VkPhysicalDevicePointClippingProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES||0),
...
const VkPhysicalDevicePointClippingPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDevicePointClippingProperties"));


const VkMemoryDedicatedRequirements = new Proxy(C.CStructView, new C.CStruct("VkMemoryDedicatedRequirements", {
    sType: "u32("+(V.VkMemoryDedicatedRequirements_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_DEDICATED_REQUIREMENTS||0),
...
const VkMemoryDedicatedRequirementsKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkMemoryDedicatedRequirements"));


const VkMemoryDedicatedAllocateInfo = new Proxy(C.CStructView, new C.CStruct("VkMemoryDedicatedAllocateInfo", {
...
const VkImageViewUsageCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkImageViewUsageCreateInfo", {
    sType: "u32("+(V.VkImageViewUsageCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO||0),
...
const VkImageViewUsageCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageViewUsageCreateInfo"));


const VkPipelineTessellationDomainOriginStateCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineTessellationDomainOriginStateCreateInfo", {
    sType: "u32("+(V.VkPipelineTessellationDomainOriginStateCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO||0),
...
const VkPipelineTessellationDomainOriginStateCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPipelineTessellationDomainOriginStateCreateInfo"));


const VkSamplerYcbcrConversionInfo = new Proxy(C.CStructView, new C.CStruct("VkSamplerYcbcrConversionInfo", {
    sType: "u32("+(V.VkSamplerYcbcrConversionInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_INFO||0),
    pNext: "u64("+(V.VkSamplerYcbcrConversionInfo_pNext_offsetof||0)+")",
    conversion: "VkSamplerYcbcrConversion("+(V.VkSamplerYcbcrConversionInfo_conversion_offsetof||0)+")",
}, (V.VkSamplerYcbcrConversionInfo_sizeof||0)));

const VkSamplerYcbcrConversionInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSamplerYcbcrConversionInfo"));


const VkSamplerYcbcrConversionCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkSamplerYcbcrConversionCreateInfo", {
    sType: "u32("+(V.VkSamplerYcbcrConversionCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_CREATE_INFO||0),
    ...
    components: "VkComponentMapping("+(V.VkSamplerYcbcrConversionCreateInfo_components_offsetof||0)+")",
...
const VkSamplerYcbcrConversionCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSamplerYcbcrConversionCreateInfo"));


const VkBindImagePlaneMemoryInfo = new Proxy(C.CStructView, new C.CStruct("VkBindImagePlaneMemoryInfo", {
    sType: "u32("+(V.VkBindImagePlaneMemoryInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO||0),
...
const VkBindImagePlaneMemoryInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBindImagePlaneMemoryInfo"));


const VkImagePlaneMemoryRequirementsInfo = new Proxy(C.CStructView, new C.CStruct("VkImagePlaneMemoryRequirementsInfo", {
    sType: "u32("+(V.VkImagePlaneMemoryRequirementsInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO||0),
...
const VkImagePlaneMemoryRequirementsInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImagePlaneMemoryRequirementsInfo"));


const VkPhysicalDeviceSamplerYcbcrConversionFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSamplerYcbcrConversionFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceSamplerYcbcrConversionFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES||0),
...
const VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceSamplerYcbcrConversionFeatures"));


const VkSamplerYcbcrConversionImageFormatProperties = new Proxy(C.CStructView, new C.CStruct("VkSamplerYcbcrConversionImageFormatProperties", {
    sType: "u32("+(V.VkSamplerYcbcrConversionImageFormatProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES||0),
...
const VkSamplerYcbcrConversionImageFormatPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSamplerYcbcrConversionImageFormatProperties"));


const VkTextureLODGatherFormatPropertiesAMD = new Proxy(C.CStructView, new C.CStruct("VkTextureLODGatherFormatPropertiesAMD", {
    sType: "u32("+(V.VkTextureLODGatherFormatPropertiesAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD||0),
...
const VkProtectedSubmitInfo = new Proxy(C.CStructView, new C.CStruct("VkProtectedSubmitInfo", {
    sType: "u32("+(V.VkProtectedSubmitInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PROTECTED_SUBMIT_INFO||0),
...
const VkPhysicalDeviceProtectedMemoryFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceProtectedMemoryFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceProtectedMemoryFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES||0),
...
const VkPhysicalDeviceProtectedMemoryProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceProtectedMemoryProperties", {
    sType: "u32("+(V.VkPhysicalDeviceProtectedMemoryProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_PROPERTIES||0),
...
const VkDeviceQueueInfo2 = new Proxy(C.CStructView, new C.CStruct("VkDeviceQueueInfo2", {
    sType: "u32("+(V.VkDeviceQueueInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_QUEUE_INFO_2||0),
...
const VkPipelineCoverageToColorStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineCoverageToColorStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineCoverageToColorStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_TO_COLOR_STATE_CREATE_INFO_NV||0),
...
const VkPhysicalDeviceSamplerFilterMinmaxProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSamplerFilterMinmaxProperties", {
    sType: "u32("+(V.VkPhysicalDeviceSamplerFilterMinmaxProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES||0),
...
const VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceSamplerFilterMinmaxProperties"));


const VkSampleLocationEXT = new Proxy(C.CStructView, new C.CStruct("VkSampleLocationEXT", {
    x: "f32("+(V.VkSampleLocationEXT_x_offsetof||0)+")",
    y: "f32("+(V.VkSampleLocationEXT_y_offsetof||0)+")",
}, (V.VkSampleLocationEXT_sizeof||0)));


const VkSampleLocationsInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkSampleLocationsInfoEXT", {
    sType: "u32("+(V.VkSampleLocationsInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLE_LOCATIONS_INFO_EXT||0),
...
const VkAttachmentSampleLocationsEXT = new Proxy(C.CStructView, new C.CStruct("VkAttachmentSampleLocationsEXT", {
    attachmentIndex: "u32("+(V.VkAttachmentSampleLocationsEXT_attachmentIndex_offsetof||0)+")",
    sampleLocationsInfo: "VkSampleLocationsInfoEXT("+(V.VkAttachmentSampleLocationsEXT_sampleLocationsInfo_offsetof||0)+")",
}, (V.VkAttachmentSampleLocationsEXT_sizeof||0)));


const VkSubpassSampleLocationsEXT = new Proxy(C.CStructView, new C.CStruct("VkSubpassSampleLocationsEXT", {
    subpassIndex: "u32("+(V.VkSubpassSampleLocationsEXT_subpassIndex_offsetof||0)+")",
    sampleLocationsInfo: "VkSampleLocationsInfoEXT("+(V.VkSubpassSampleLocationsEXT_sampleLocationsInfo_offsetof||0)+")",
}, (V.VkSubpassSampleLocationsEXT_sizeof||0)));


const VkRenderPassSampleLocationsBeginInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkRenderPassSampleLocationsBeginInfoEXT", {
    sType: "u32("+(V.VkRenderPassSampleLocationsBeginInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_SAMPLE_LOCATIONS_BEGIN_INFO_EXT||0),
...
const VkPipelineSampleLocationsStateCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineSampleLocationsStateCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineSampleLocationsStateCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_SAMPLE_LOCATIONS_STATE_CREATE_INFO_EXT||0),
    ...
    sampleLocationsInfo: "VkSampleLocationsInfoEXT("+(V.VkPipelineSampleLocationsStateCreateInfoEXT_sampleLocationsInfo_offsetof||0)+")",
}, (V.VkPipelineSampleLocationsStateCreateInfoEXT_sizeof||0)));


const VkPhysicalDeviceSampleLocationsPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSampleLocationsPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceSampleLocationsPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLE_LOCATIONS_PROPERTIES_EXT||0),
...
const VkMultisamplePropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkMultisamplePropertiesEXT", {
    sType: "u32("+(V.VkMultisamplePropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MULTISAMPLE_PROPERTIES_EXT||0),
...
const VkSamplerReductionModeCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkSamplerReductionModeCreateInfo", {
    sType: "u32("+(V.VkSamplerReductionModeCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO||0),
...
const VkSamplerReductionModeCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkSamplerReductionModeCreateInfo"));


const VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_FEATURES_EXT||0),
...
const VkPhysicalDeviceMultiDrawFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMultiDrawFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceMultiDrawFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_FEATURES_EXT||0),
...
const VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_PROPERTIES_EXT||0),
...
const VkPipelineColorBlendAdvancedStateCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineColorBlendAdvancedStateCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineColorBlendAdvancedStateCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_ADVANCED_STATE_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceInlineUniformBlockFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceInlineUniformBlockFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceInlineUniformBlockFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES||0),
...
const VkPhysicalDeviceInlineUniformBlockFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceInlineUniformBlockFeatures"));


const VkPhysicalDeviceInlineUniformBlockProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceInlineUniformBlockProperties", {
    sType: "u32("+(V.VkPhysicalDeviceInlineUniformBlockProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES||0),
...
const VkPhysicalDeviceInlineUniformBlockPropertiesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceInlineUniformBlockProperties"));


const VkWriteDescriptorSetInlineUniformBlock = new Proxy(C.CStructView, new C.CStruct("VkWriteDescriptorSetInlineUniformBlock", {
    sType: "u32("+(V.VkWriteDescriptorSetInlineUniformBlock_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK||0),
...
const VkWriteDescriptorSetInlineUniformBlockEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkWriteDescriptorSetInlineUniformBlock"));


const VkDescriptorPoolInlineUniformBlockCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDescriptorPoolInlineUniformBlockCreateInfo", {
    sType: "u32("+(V.VkDescriptorPoolInlineUniformBlockCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO||0),
...
const VkDescriptorPoolInlineUniformBlockCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkDescriptorPoolInlineUniformBlockCreateInfo"));


const VkPipelineCoverageModulationStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineCoverageModulationStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineCoverageModulationStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_MODULATION_STATE_CREATE_INFO_NV||0),
...
const VkImageFormatListCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkImageFormatListCreateInfo", {
    sType: "u32("+(V.VkImageFormatListCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO||0),
...
const VkImageFormatListCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageFormatListCreateInfo"));


const VkValidationCacheCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkValidationCacheCreateInfoEXT", {
    sType: "u32("+(V.VkValidationCacheCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VALIDATION_CACHE_CREATE_INFO_EXT||0),
...
const VkShaderModuleValidationCacheCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkShaderModuleValidationCacheCreateInfoEXT", {
    sType: "u32("+(V.VkShaderModuleValidationCacheCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SHADER_MODULE_VALIDATION_CACHE_CREATE_INFO_EXT||0),
    pNext: "u64("+(V.VkShaderModuleValidationCacheCreateInfoEXT_pNext_offsetof||0)+")",
    validationCache: "VkValidationCacheEXT("+(V.VkShaderModuleValidationCacheCreateInfoEXT_validationCache_offsetof||0)+")",
}, (V.VkShaderModuleValidationCacheCreateInfoEXT_sizeof||0)));


const VkPhysicalDeviceMaintenance3Properties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMaintenance3Properties", {
    sType: "u32("+(V.VkPhysicalDeviceMaintenance3Properties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_3_PROPERTIES||0),
...
const VkPhysicalDeviceMaintenance3PropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceMaintenance3Properties"));


const VkPhysicalDeviceMaintenance4Features = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMaintenance4Features", {
    sType: "u32("+(V.VkPhysicalDeviceMaintenance4Features_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES||0),
...
const VkPhysicalDeviceMaintenance4FeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceMaintenance4Features"));


const VkPhysicalDeviceMaintenance4Properties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMaintenance4Properties", {
    sType: "u32("+(V.VkPhysicalDeviceMaintenance4Properties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES||0),
...
const VkPhysicalDeviceMaintenance4PropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceMaintenance4Properties"));


const VkDescriptorSetLayoutSupport = new Proxy(C.CStructView, new C.CStruct("VkDescriptorSetLayoutSupport", {
    sType: "u32("+(V.VkDescriptorSetLayoutSupport_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_SUPPORT||0),
...
const VkDescriptorSetLayoutSupportKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDescriptorSetLayoutSupport"));


const VkPhysicalDeviceShaderDrawParametersFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderDrawParametersFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceShaderDrawParametersFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETERS_FEATURES||0),
...
const VkPhysicalDeviceShaderDrawParameterFeatures = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderDrawParametersFeatures"));


const VkPhysicalDeviceShaderFloat16Int8Features = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderFloat16Int8Features", {
    sType: "u32("+(V.VkPhysicalDeviceShaderFloat16Int8Features_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES||0),
...
const VkPhysicalDeviceShaderFloat16Int8FeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderFloat16Int8Features"));

const VkPhysicalDeviceFloat16Int8FeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderFloat16Int8Features"));


const VkPhysicalDeviceFloatControlsProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFloatControlsProperties", {
    sType: "u32("+(V.VkPhysicalDeviceFloatControlsProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES||0),
...
const VkPhysicalDeviceFloatControlsPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceFloatControlsProperties"));


const VkPhysicalDeviceHostQueryResetFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceHostQueryResetFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceHostQueryResetFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES||0),
...
const VkPhysicalDeviceHostQueryResetFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceHostQueryResetFeatures"));


const VkNativeBufferUsage2ANDROID = new Proxy(C.CStructView, new C.CStruct("VkNativeBufferUsage2ANDROID", {
...
const VkNativeBufferANDROID = new Proxy(C.CStructView, new C.CStruct("VkNativeBufferANDROID", {
    sType: "u32("+(V.VkNativeBufferANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_NATIVE_BUFFER_ANDROID||0),
    pNext: "u64("+(V.VkNativeBufferANDROID_pNext_offsetof||0)+")",
    handle: "u64("+(V.VkNativeBufferANDROID_handle_offsetof||0)+")",
    stride: "int("+(V.VkNativeBufferANDROID_stride_offsetof||0)+")",
    format: "int("+(V.VkNativeBufferANDROID_format_offsetof||0)+")",
    usage: "int("+(V.VkNativeBufferANDROID_usage_offsetof||0)+")",
    usage2: "VkNativeBufferUsage2ANDROID("+(V.VkNativeBufferANDROID_usage2_offsetof||0)+")",
}, (V.VkNativeBufferANDROID_sizeof||0)));


const VkSwapchainImageCreateInfoANDROID = new Proxy(C.CStructView, new C.CStruct("VkSwapchainImageCreateInfoANDROID", {
    sType: "u32("+(V.VkSwapchainImageCreateInfoANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SWAPCHAIN_IMAGE_CREATE_INFO_ANDROID||0),
...
const VkPhysicalDevicePresentationPropertiesANDROID = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePresentationPropertiesANDROID", {
    sType: "u32("+(V.VkPhysicalDevicePresentationPropertiesANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_ANDROID||0),
...
const VkShaderResourceUsageAMD = new Proxy(C.CStructView, new C.CStruct("VkShaderResourceUsageAMD", {
...
const VkShaderStatisticsInfoAMD = new Proxy(C.CStructView, new C.CStruct("VkShaderStatisticsInfoAMD", {
    shaderStageMask: "u32("+(V.VkShaderStatisticsInfoAMD_shaderStageMask_offsetof||0)+")",
    resourceUsage: "VkShaderResourceUsageAMD("+(V.VkShaderStatisticsInfoAMD_resourceUsage_offsetof||0)+")",
...
const VkDeviceQueueGlobalPriorityCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkDeviceQueueGlobalPriorityCreateInfoKHR", {
    sType: "u32("+(V.VkDeviceQueueGlobalPriorityCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_KHR||0),
...
const VkDeviceQueueGlobalPriorityCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceQueueGlobalPriorityCreateInfoKHR"));


const VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES_KHR||0),
...
const VkPhysicalDeviceGlobalPriorityQueryFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR"));


const VkQueueFamilyGlobalPriorityPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkQueueFamilyGlobalPriorityPropertiesKHR", {
    sType: "u32("+(V.VkQueueFamilyGlobalPriorityPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES_KHR||0),
...
const VkQueueFamilyGlobalPriorityPropertiesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkQueueFamilyGlobalPriorityPropertiesKHR"));


const VkDebugUtilsObjectNameInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugUtilsObjectNameInfoEXT", {
    sType: "u32("+(V.VkDebugUtilsObjectNameInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT||0),
...
const VkDebugUtilsObjectTagInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugUtilsObjectTagInfoEXT", {
    sType: "u32("+(V.VkDebugUtilsObjectTagInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_TAG_INFO_EXT||0),
...
const VkDebugUtilsLabelEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugUtilsLabelEXT", {
    sType: "u32("+(V.VkDebugUtilsLabelEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT||0),
...
const VkDebugUtilsMessengerCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugUtilsMessengerCreateInfoEXT", {
    sType: "u32("+(V.VkDebugUtilsMessengerCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT||0),
    ...
    pfnUserCallback: "PFN_vkDebugUtilsMessengerCallbackEXT("+(V.VkDebugUtilsMessengerCreateInfoEXT_pfnUserCallback_offsetof||0)+")",
    pUserData: "u64("+(V.VkDebugUtilsMessengerCreateInfoEXT_pUserData_offsetof||0)+")",
}, (V.VkDebugUtilsMessengerCreateInfoEXT_sizeof||0)));


const VkDebugUtilsMessengerCallbackDataEXT = new Proxy(C.CStructView, new C.CStruct("VkDebugUtilsMessengerCallbackDataEXT", {
    sType: "u32("+(V.VkDebugUtilsMessengerCallbackDataEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CALLBACK_DATA_EXT||0),
...
const VkPhysicalDeviceDeviceMemoryReportFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDeviceMemoryReportFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDeviceMemoryReportFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_MEMORY_REPORT_FEATURES_EXT||0),
...
const VkDeviceDeviceMemoryReportCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceDeviceMemoryReportCreateInfoEXT", {
    sType: "u32("+(V.VkDeviceDeviceMemoryReportCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_DEVICE_MEMORY_REPORT_CREATE_INFO_EXT||0),
    ...
    pfnUserCallback: "PFN_vkDeviceMemoryReportCallbackEXT("+(V.VkDeviceDeviceMemoryReportCreateInfoEXT_pfnUserCallback_offsetof||0)+")",
...
const VkDeviceMemoryReportCallbackDataEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceMemoryReportCallbackDataEXT", {
    sType: "u32("+(V.VkDeviceMemoryReportCallbackDataEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_MEMORY_REPORT_CALLBACK_DATA_EXT||0),
...
const VkImportMemoryHostPointerInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImportMemoryHostPointerInfoEXT", {
    sType: "u32("+(V.VkImportMemoryHostPointerInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_MEMORY_HOST_POINTER_INFO_EXT||0),
...
const VkMemoryHostPointerPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkMemoryHostPointerPropertiesEXT", {
    sType: "u32("+(V.VkMemoryHostPointerPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_HOST_POINTER_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceExternalMemoryHostPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExternalMemoryHostPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceExternalMemoryHostPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_HOST_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceConservativeRasterizationPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceConservativeRasterizationPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceConservativeRasterizationPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONSERVATIVE_RASTERIZATION_PROPERTIES_EXT||0),
...
const VkCalibratedTimestampInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkCalibratedTimestampInfoEXT", {
    sType: "u32("+(V.VkCalibratedTimestampInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_EXT||0),
...
const VkPhysicalDeviceShaderCorePropertiesAMD = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderCorePropertiesAMD", {
    sType: "u32("+(V.VkPhysicalDeviceShaderCorePropertiesAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD||0),
...
const VkPhysicalDeviceShaderCoreProperties2AMD = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderCoreProperties2AMD", {
    sType: "u32("+(V.VkPhysicalDeviceShaderCoreProperties2AMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_2_AMD||0),
...
const VkPipelineRasterizationConservativeStateCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineRasterizationConservativeStateCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineRasterizationConservativeStateCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_CONSERVATIVE_STATE_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceDescriptorIndexingFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDescriptorIndexingFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceDescriptorIndexingFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES||0),
...
const VkPhysicalDeviceDescriptorIndexingFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceDescriptorIndexingFeatures"));


const VkPhysicalDeviceDescriptorIndexingProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDescriptorIndexingProperties", {
    sType: "u32("+(V.VkPhysicalDeviceDescriptorIndexingProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES||0),
...
const VkPhysicalDeviceDescriptorIndexingPropertiesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceDescriptorIndexingProperties"));


const VkDescriptorSetLayoutBindingFlagsCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkDescriptorSetLayoutBindingFlagsCreateInfo", {
    sType: "u32("+(V.VkDescriptorSetLayoutBindingFlagsCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO||0),
...
const VkDescriptorSetLayoutBindingFlagsCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkDescriptorSetLayoutBindingFlagsCreateInfo"));


const VkDescriptorSetVariableDescriptorCountAllocateInfo = new Proxy(C.CStructView, new C.CStruct("VkDescriptorSetVariableDescriptorCountAllocateInfo", {
    sType: "u32("+(V.VkDescriptorSetVariableDescriptorCountAllocateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO||0),
...
const VkDescriptorSetVariableDescriptorCountAllocateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkDescriptorSetVariableDescriptorCountAllocateInfo"));


const VkDescriptorSetVariableDescriptorCountLayoutSupport = new Proxy(C.CStructView, new C.CStruct("VkDescriptorSetVariableDescriptorCountLayoutSupport", {
    sType: "u32("+(V.VkDescriptorSetVariableDescriptorCountLayoutSupport_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT||0),
...
const VkDescriptorSetVariableDescriptorCountLayoutSupportEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkDescriptorSetVariableDescriptorCountLayoutSupport"));


const VkAttachmentDescription2 = new Proxy(C.CStructView, new C.CStruct("VkAttachmentDescription2", {
    sType: "u32("+(V.VkAttachmentDescription2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2||0),
...
const VkAttachmentDescription2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkAttachmentDescription2"));


const VkAttachmentReference2 = new Proxy(C.CStructView, new C.CStruct("VkAttachmentReference2", {
    sType: "u32("+(V.VkAttachmentReference2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2||0),
...
const VkAttachmentReference2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkAttachmentReference2"));


const VkSubpassDescription2 = new Proxy(C.CStructView, new C.CStruct("VkSubpassDescription2", {
    sType: "u32("+(V.VkSubpassDescription2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2||0),
...
const VkSubpassDescription2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSubpassDescription2"));


const VkSubpassDependency2 = new Proxy(C.CStructView, new C.CStruct("VkSubpassDependency2", {
    sType: "u32("+(V.VkSubpassDependency2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2||0),
...
const VkSubpassDependency2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSubpassDependency2"));


const VkRenderPassCreateInfo2 = new Proxy(C.CStructView, new C.CStruct("VkRenderPassCreateInfo2", {
    sType: "u32("+(V.VkRenderPassCreateInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2||0),
...
const VkRenderPassCreateInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkRenderPassCreateInfo2"));


const VkSubpassBeginInfo = new Proxy(C.CStructView, new C.CStruct("VkSubpassBeginInfo", {
    sType: "u32("+(V.VkSubpassBeginInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO||0),
...
const VkSubpassBeginInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSubpassBeginInfo"));


const VkSubpassEndInfo = new Proxy(C.CStructView, new C.CStruct("VkSubpassEndInfo", {
    sType: "u32("+(V.VkSubpassEndInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBPASS_END_INFO||0),
    pNext: "u64("+(V.VkSubpassEndInfo_pNext_offsetof||0)+")",
}, (V.VkSubpassEndInfo_sizeof||0)));

const VkSubpassEndInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSubpassEndInfo"));


const VkPhysicalDeviceTimelineSemaphoreFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceTimelineSemaphoreFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceTimelineSemaphoreFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES||0),
...
const VkPhysicalDeviceTimelineSemaphoreFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceTimelineSemaphoreFeatures"));


const VkPhysicalDeviceTimelineSemaphoreProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceTimelineSemaphoreProperties", {
    sType: "u32("+(V.VkPhysicalDeviceTimelineSemaphoreProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES||0),
...
const VkPhysicalDeviceTimelineSemaphorePropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceTimelineSemaphoreProperties"));


const VkSemaphoreTypeCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkSemaphoreTypeCreateInfo", {
    sType: "u32("+(V.VkSemaphoreTypeCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO||0),
...
const VkSemaphoreTypeCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSemaphoreTypeCreateInfo"));


const VkTimelineSemaphoreSubmitInfo = new Proxy(C.CStructView, new C.CStruct("VkTimelineSemaphoreSubmitInfo", {
    sType: "u32("+(V.VkTimelineSemaphoreSubmitInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO||0),
...
const VkTimelineSemaphoreSubmitInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkTimelineSemaphoreSubmitInfo"));


const VkSemaphoreWaitInfo = new Proxy(C.CStructView, new C.CStruct("VkSemaphoreWaitInfo", {
    sType: "u32("+(V.VkSemaphoreWaitInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO||0),
...
const VkSemaphoreWaitInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSemaphoreWaitInfo"));


const VkSemaphoreSignalInfo = new Proxy(C.CStructView, new C.CStruct("VkSemaphoreSignalInfo", {
    sType: "u32("+(V.VkSemaphoreSignalInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO||0),
...
const VkSemaphoreSignalInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSemaphoreSignalInfo"));


const VkVertexInputBindingDivisorDescriptionEXT = new Proxy(C.CStructView, new C.CStruct("VkVertexInputBindingDivisorDescriptionEXT", {
...
const VkPipelineVertexInputDivisorStateCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineVertexInputDivisorStateCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineVertexInputDivisorStateCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_EXT||0),
...
const VkPhysicalDevicePCIBusInfoPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePCIBusInfoPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDevicePCIBusInfoPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PCI_BUS_INFO_PROPERTIES_EXT||0),
...
const VkAndroidHardwareBufferUsageANDROID = new Proxy(C.CStructView, new C.CStruct("VkAndroidHardwareBufferUsageANDROID", {
    sType: "u32("+(V.VkAndroidHardwareBufferUsageANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_USAGE_ANDROID||0),
...
const VkAndroidHardwareBufferPropertiesANDROID = new Proxy(C.CStructView, new C.CStruct("VkAndroidHardwareBufferPropertiesANDROID", {
    sType: "u32("+(V.VkAndroidHardwareBufferPropertiesANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_PROPERTIES_ANDROID||0),
...
const VkMemoryGetAndroidHardwareBufferInfoANDROID = new Proxy(C.CStructView, new C.CStruct("VkMemoryGetAndroidHardwareBufferInfoANDROID", {
    sType: "u32("+(V.VkMemoryGetAndroidHardwareBufferInfoANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_GET_ANDROID_HARDWARE_BUFFER_INFO_ANDROID||0),
...
const VkAndroidHardwareBufferFormatPropertiesANDROID = new Proxy(C.CStructView, new C.CStruct("VkAndroidHardwareBufferFormatPropertiesANDROID", {
    sType: "u32("+(V.VkAndroidHardwareBufferFormatPropertiesANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_ANDROID||0),
    ...
    samplerYcbcrConversionComponents: "VkComponentMapping("+(V.VkAndroidHardwareBufferFormatPropertiesANDROID_samplerYcbcrConversionComponents_offsetof||0)+")",
...
const VkCommandBufferInheritanceConditionalRenderingInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkCommandBufferInheritanceConditionalRenderingInfoEXT", {
    sType: "u32("+(V.VkCommandBufferInheritanceConditionalRenderingInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_CONDITIONAL_RENDERING_INFO_EXT||0),
...
const VkExternalFormatANDROID = new Proxy(C.CStructView, new C.CStruct("VkExternalFormatANDROID", {
    sType: "u32("+(V.VkExternalFormatANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_ANDROID||0),
...
const VkPhysicalDevice8BitStorageFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevice8BitStorageFeatures", {
    sType: "u32("+(V.VkPhysicalDevice8BitStorageFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES||0),
...
const VkPhysicalDevice8BitStorageFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDevice8BitStorageFeatures"));


const VkPhysicalDeviceConditionalRenderingFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceConditionalRenderingFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceConditionalRenderingFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONDITIONAL_RENDERING_FEATURES_EXT||0),
...
const VkPhysicalDeviceVulkanMemoryModelFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVulkanMemoryModelFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceVulkanMemoryModelFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES||0),
...
const VkPhysicalDeviceVulkanMemoryModelFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceVulkanMemoryModelFeatures"));


const VkPhysicalDeviceShaderAtomicInt64Features = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderAtomicInt64Features", {
    sType: "u32("+(V.VkPhysicalDeviceShaderAtomicInt64Features_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES||0),
...
const VkPhysicalDeviceShaderAtomicInt64FeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderAtomicInt64Features"));


const VkPhysicalDeviceShaderAtomicFloatFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderAtomicFloatFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceShaderAtomicFloatFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_FEATURES_EXT||0),
...
const VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_2_FEATURES_EXT||0),
...
const VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_EXT||0),
...
const VkQueueFamilyCheckpointPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkQueueFamilyCheckpointPropertiesNV", {
    sType: "u32("+(V.VkQueueFamilyCheckpointPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_NV||0),
...
const VkCheckpointDataNV = new Proxy(C.CStructView, new C.CStruct("VkCheckpointDataNV", {
    sType: "u32("+(V.VkCheckpointDataNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_CHECKPOINT_DATA_NV||0),
...
const VkPhysicalDeviceDepthStencilResolveProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDepthStencilResolveProperties", {
    sType: "u32("+(V.VkPhysicalDeviceDepthStencilResolveProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES||0),
...
const VkPhysicalDeviceDepthStencilResolvePropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceDepthStencilResolveProperties"));


const VkSubpassDescriptionDepthStencilResolve = new Proxy(C.CStructView, new C.CStruct("VkSubpassDescriptionDepthStencilResolve", {
    sType: "u32("+(V.VkSubpassDescriptionDepthStencilResolve_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE||0),
...
const VkSubpassDescriptionDepthStencilResolveKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSubpassDescriptionDepthStencilResolve"));


const VkImageViewASTCDecodeModeEXT = new Proxy(C.CStructView, new C.CStruct("VkImageViewASTCDecodeModeEXT", {
    sType: "u32("+(V.VkImageViewASTCDecodeModeEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_VIEW_ASTC_DECODE_MODE_EXT||0),
...
const VkPhysicalDeviceASTCDecodeFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceASTCDecodeFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceASTCDecodeFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ASTC_DECODE_FEATURES_EXT||0),
...
const VkPhysicalDeviceTransformFeedbackFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceTransformFeedbackFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceTransformFeedbackFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TRANSFORM_FEEDBACK_FEATURES_EXT||0),
...
const VkPhysicalDeviceTransformFeedbackPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceTransformFeedbackPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceTransformFeedbackPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TRANSFORM_FEEDBACK_PROPERTIES_EXT||0),
...
const VkPipelineRasterizationStateStreamCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineRasterizationStateStreamCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineRasterizationStateStreamCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_STREAM_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_REPRESENTATIVE_FRAGMENT_TEST_FEATURES_NV||0),
...
const VkPipelineRepresentativeFragmentTestStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineRepresentativeFragmentTestStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineRepresentativeFragmentTestStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_REPRESENTATIVE_FRAGMENT_TEST_STATE_CREATE_INFO_NV||0),
...
const VkPhysicalDeviceExclusiveScissorFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExclusiveScissorFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceExclusiveScissorFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXCLUSIVE_SCISSOR_FEATURES_NV||0),
...
const VkPipelineViewportExclusiveScissorStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineViewportExclusiveScissorStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineViewportExclusiveScissorStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_EXCLUSIVE_SCISSOR_STATE_CREATE_INFO_NV||0),
...
const VkPhysicalDeviceCornerSampledImageFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCornerSampledImageFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceCornerSampledImageFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CORNER_SAMPLED_IMAGE_FEATURES_NV||0),
...
const VkPhysicalDeviceComputeShaderDerivativesFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceComputeShaderDerivativesFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceComputeShaderDerivativesFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV||0),
...
const VkPhysicalDeviceFragmentShaderBarycentricFeaturesNV = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR"));


const VkPhysicalDeviceShaderImageFootprintFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderImageFootprintFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceShaderImageFootprintFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_FOOTPRINT_FEATURES_NV||0),
...
const VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEDICATED_ALLOCATION_IMAGE_ALIASING_FEATURES_NV||0),
...
const VkPhysicalDeviceCopyMemoryIndirectFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCopyMemoryIndirectFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceCopyMemoryIndirectFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_FEATURES_NV||0),
...
const VkPhysicalDeviceCopyMemoryIndirectPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCopyMemoryIndirectPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceCopyMemoryIndirectPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_PROPERTIES_NV||0),
...
const VkPhysicalDeviceMemoryDecompressionFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMemoryDecompressionFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceMemoryDecompressionFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_FEATURES_NV||0),
...
const VkPhysicalDeviceMemoryDecompressionPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMemoryDecompressionPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceMemoryDecompressionPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_PROPERTIES_NV||0),
...
const VkShadingRatePaletteNV = new Proxy(C.CStructView, new C.CStruct("VkShadingRatePaletteNV", {
...
const VkPipelineViewportShadingRateImageStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineViewportShadingRateImageStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineViewportShadingRateImageStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SHADING_RATE_IMAGE_STATE_CREATE_INFO_NV||0),
...
const VkPhysicalDeviceShadingRateImageFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShadingRateImageFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceShadingRateImageFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_FEATURES_NV||0),
...
const VkPhysicalDeviceShadingRateImagePropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShadingRateImagePropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceShadingRateImagePropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_PROPERTIES_NV||0),
...
const VkPhysicalDeviceInvocationMaskFeaturesHUAWEI = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceInvocationMaskFeaturesHUAWEI", {
    sType: "u32("+(V.VkPhysicalDeviceInvocationMaskFeaturesHUAWEI_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INVOCATION_MASK_FEATURES_HUAWEI||0),
...
const VkCoarseSampleLocationNV = new Proxy(C.CStructView, new C.CStruct("VkCoarseSampleLocationNV", {
...
const VkCoarseSampleOrderCustomNV = new Proxy(C.CStructView, new C.CStruct("VkCoarseSampleOrderCustomNV", {
...
const VkPipelineViewportCoarseSampleOrderStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineViewportCoarseSampleOrderStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineViewportCoarseSampleOrderStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_COARSE_SAMPLE_ORDER_STATE_CREATE_INFO_NV||0),
...
const VkPhysicalDeviceMeshShaderFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMeshShaderFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceMeshShaderFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_NV||0),
...
const VkPhysicalDeviceMeshShaderPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMeshShaderPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceMeshShaderPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_NV||0),
...
const VkDrawMeshTasksIndirectCommandNV = new Proxy(C.CStructView, new C.CStruct("VkDrawMeshTasksIndirectCommandNV", {
...
const VkPhysicalDeviceMeshShaderFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMeshShaderFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceMeshShaderFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_EXT||0),
...
const VkPhysicalDeviceMeshShaderPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMeshShaderPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceMeshShaderPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_EXT||0),
...
const VkDrawMeshTasksIndirectCommandEXT = new Proxy(C.CStructView, new C.CStruct("VkDrawMeshTasksIndirectCommandEXT", {
...
const VkRayTracingShaderGroupCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkRayTracingShaderGroupCreateInfoNV", {
    sType: "u32("+(V.VkRayTracingShaderGroupCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_NV||0),
...
const VkRayTracingShaderGroupCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkRayTracingShaderGroupCreateInfoKHR", {
    sType: "u32("+(V.VkRayTracingShaderGroupCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_KHR||0),
...
const VkRayTracingPipelineCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkRayTracingPipelineCreateInfoNV", {
    sType: "u32("+(V.VkRayTracingPipelineCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_NV||0),
...
const VkRayTracingPipelineCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkRayTracingPipelineCreateInfoKHR", {
    sType: "u32("+(V.VkRayTracingPipelineCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_KHR||0),
...
const VkGeometryTrianglesNV = new Proxy(C.CStructView, new C.CStruct("VkGeometryTrianglesNV", {
    sType: "u32("+(V.VkGeometryTrianglesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GEOMETRY_TRIANGLES_NV||0),
...
const VkGeometryAABBNV = new Proxy(C.CStructView, new C.CStruct("VkGeometryAABBNV", {
    sType: "u32("+(V.VkGeometryAABBNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GEOMETRY_AABB_NV||0),
...
const VkGeometryDataNV = new Proxy(C.CStructView, new C.CStruct("VkGeometryDataNV", {
    triangles: "VkGeometryTrianglesNV("+(V.VkGeometryDataNV_triangles_offsetof||0)+")",
    aabbs: "VkGeometryAABBNV("+(V.VkGeometryDataNV_aabbs_offsetof||0)+")",
}, (V.VkGeometryDataNV_sizeof||0)));


const VkGeometryNV = new Proxy(C.CStructView, new C.CStruct("VkGeometryNV", {
    sType: "u32("+(V.VkGeometryNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GEOMETRY_NV||0),
    pNext: "u64("+(V.VkGeometryNV_pNext_offsetof||0)+")",
    geometryType: "u32("+(V.VkGeometryNV_geometryType_offsetof||0)+")",
    geometry: "VkGeometryDataNV("+(V.VkGeometryNV_geometry_offsetof||0)+")",
    flags: "u32("+(V.VkGeometryNV_flags_offsetof||0)+")",
}, (V.VkGeometryNV_sizeof||0)));


const VkAccelerationStructureInfoNV = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureInfoNV", {
    sType: "u32("+(V.VkAccelerationStructureInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_NV||0),
    pNext: "u64("+(V.VkAccelerationStructureInfoNV_pNext_offsetof||0)+")",
    type: "VkAccelerationStructureTypeNV("+(V.VkAccelerationStructureInfoNV_type_offsetof||0)+")",
...
const VkAccelerationStructureCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureCreateInfoNV", {
    sType: "u32("+(V.VkAccelerationStructureCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_NV||0),
    ...
    info: "VkAccelerationStructureInfoNV("+(V.VkAccelerationStructureCreateInfoNV_info_offsetof||0)+")",
}, (V.VkAccelerationStructureCreateInfoNV_sizeof||0)));


const VkBindAccelerationStructureMemoryInfoNV = new Proxy(C.CStructView, new C.CStruct("VkBindAccelerationStructureMemoryInfoNV", {
    sType: "u32("+(V.VkBindAccelerationStructureMemoryInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_NV||0),
    pNext: "u64("+(V.VkBindAccelerationStructureMemoryInfoNV_pNext_offsetof||0)+")",
    accelerationStructure: "VkAccelerationStructureNV("+(V.VkBindAccelerationStructureMemoryInfoNV_accelerationStructure_offsetof||0)+")",
...
const VkWriteDescriptorSetAccelerationStructureKHR = new Proxy(C.CStructView, new C.CStruct("VkWriteDescriptorSetAccelerationStructureKHR", {
    sType: "u32("+(V.VkWriteDescriptorSetAccelerationStructureKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR||0),
...
const VkWriteDescriptorSetAccelerationStructureNV = new Proxy(C.CStructView, new C.CStruct("VkWriteDescriptorSetAccelerationStructureNV", {
    sType: "u32("+(V.VkWriteDescriptorSetAccelerationStructureNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_NV||0),
...
const VkAccelerationStructureMemoryRequirementsInfoNV = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureMemoryRequirementsInfoNV", {
    sType: "u32("+(V.VkAccelerationStructureMemoryRequirementsInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_NV||0),
    ...
    accelerationStructure: "VkAccelerationStructureNV("+(V.VkAccelerationStructureMemoryRequirementsInfoNV_accelerationStructure_offsetof||0)+")",
}, (V.VkAccelerationStructureMemoryRequirementsInfoNV_sizeof||0)));


const VkPhysicalDeviceAccelerationStructureFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceAccelerationStructureFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceAccelerationStructureFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_FEATURES_KHR||0),
...
const VkPhysicalDeviceRayTracingPipelineFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRayTracingPipelineFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceRayTracingPipelineFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR||0),
...
const VkPhysicalDeviceRayQueryFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRayQueryFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceRayQueryFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR||0),
...
const VkPhysicalDeviceAccelerationStructurePropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceAccelerationStructurePropertiesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceAccelerationStructurePropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_PROPERTIES_KHR||0),
...
const VkPhysicalDeviceRayTracingPipelinePropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRayTracingPipelinePropertiesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceRayTracingPipelinePropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_PROPERTIES_KHR||0),
...
const VkPhysicalDeviceRayTracingPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRayTracingPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceRayTracingPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_NV||0),
...
const VkStridedDeviceAddressRegionKHR = new Proxy(C.CStructView, new C.CStruct("VkStridedDeviceAddressRegionKHR", {
...
const VkTraceRaysIndirectCommandKHR = new Proxy(C.CStructView, new C.CStruct("VkTraceRaysIndirectCommandKHR", {
...
const VkTraceRaysIndirectCommand2KHR = new Proxy(C.CStructView, new C.CStruct("VkTraceRaysIndirectCommand2KHR", {
...
const VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_MAINTENANCE_1_FEATURES_KHR||0),
...
const VkDrmFormatModifierPropertiesListEXT = new Proxy(C.CStructView, new C.CStruct("VkDrmFormatModifierPropertiesListEXT", {
    sType: "u32("+(V.VkDrmFormatModifierPropertiesListEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_EXT||0),
...
const VkDrmFormatModifierPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkDrmFormatModifierPropertiesEXT", {
...
const VkPhysicalDeviceImageDrmFormatModifierInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageDrmFormatModifierInfoEXT", {
    sType: "u32("+(V.VkPhysicalDeviceImageDrmFormatModifierInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_DRM_FORMAT_MODIFIER_INFO_EXT||0),
...
const VkImageDrmFormatModifierListCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImageDrmFormatModifierListCreateInfoEXT", {
    sType: "u32("+(V.VkImageDrmFormatModifierListCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_LIST_CREATE_INFO_EXT||0),
...
const VkImageDrmFormatModifierExplicitCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImageDrmFormatModifierExplicitCreateInfoEXT", {
    sType: "u32("+(V.VkImageDrmFormatModifierExplicitCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_EXPLICIT_CREATE_INFO_EXT||0),
...
const VkImageDrmFormatModifierPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkImageDrmFormatModifierPropertiesEXT", {
    sType: "u32("+(V.VkImageDrmFormatModifierPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_PROPERTIES_EXT||0),
...
const VkImageStencilUsageCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkImageStencilUsageCreateInfo", {
    sType: "u32("+(V.VkImageStencilUsageCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO||0),
...
const VkImageStencilUsageCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkImageStencilUsageCreateInfo"));


const VkDeviceMemoryOverallocationCreateInfoAMD = new Proxy(C.CStructView, new C.CStruct("VkDeviceMemoryOverallocationCreateInfoAMD", {
    sType: "u32("+(V.VkDeviceMemoryOverallocationCreateInfoAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_MEMORY_OVERALLOCATION_CREATE_INFO_AMD||0),
...
const VkPhysicalDeviceFragmentDensityMapFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentDensityMapFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentDensityMapFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_FEATURES_EXT||0),
...
const VkPhysicalDeviceFragmentDensityMap2FeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentDensityMap2FeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentDensityMap2FeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_FEATURES_EXT||0),
...
const VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_QCOM||0),
...
const VkPhysicalDeviceFragmentDensityMapPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentDensityMapPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentDensityMapPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceFragmentDensityMap2PropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentDensityMap2PropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentDensityMap2PropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_QCOM||0),
...
const VkRenderPassFragmentDensityMapCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkRenderPassFragmentDensityMapCreateInfoEXT", {
    sType: "u32("+(V.VkRenderPassFragmentDensityMapCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_FRAGMENT_DENSITY_MAP_CREATE_INFO_EXT||0),
    pNext: "u64("+(V.VkRenderPassFragmentDensityMapCreateInfoEXT_pNext_offsetof||0)+")",
    fragmentDensityMapAttachment: "VkAttachmentReference("+(V.VkRenderPassFragmentDensityMapCreateInfoEXT_fragmentDensityMapAttachment_offsetof||0)+")",
}, (V.VkRenderPassFragmentDensityMapCreateInfoEXT_sizeof||0)));


const VkSubpassFragmentDensityMapOffsetEndInfoQCOM = new Proxy(C.CStructView, new C.CStruct("VkSubpassFragmentDensityMapOffsetEndInfoQCOM", {
    sType: "u32("+(V.VkSubpassFragmentDensityMapOffsetEndInfoQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBPASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_QCOM||0),
...
const VkPhysicalDeviceScalarBlockLayoutFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceScalarBlockLayoutFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceScalarBlockLayoutFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES||0),
...
const VkPhysicalDeviceScalarBlockLayoutFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceScalarBlockLayoutFeatures"));


const VkSurfaceProtectedCapabilitiesKHR = new Proxy(C.CStructView, new C.CStruct("VkSurfaceProtectedCapabilitiesKHR", {
    sType: "u32("+(V.VkSurfaceProtectedCapabilitiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SURFACE_PROTECTED_CAPABILITIES_KHR||0),
...
const VkPhysicalDeviceUniformBufferStandardLayoutFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceUniformBufferStandardLayoutFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceUniformBufferStandardLayoutFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES||0),
...
const VkPhysicalDeviceUniformBufferStandardLayoutFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceUniformBufferStandardLayoutFeatures"));


const VkPhysicalDeviceDepthClipEnableFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDepthClipEnableFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDepthClipEnableFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLIP_ENABLE_FEATURES_EXT||0),
...
const VkPipelineRasterizationDepthClipStateCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineRasterizationDepthClipStateCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineRasterizationDepthClipStateCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_DEPTH_CLIP_STATE_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceMemoryBudgetPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMemoryBudgetPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceMemoryBudgetPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_BUDGET_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceMemoryPriorityFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMemoryPriorityFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceMemoryPriorityFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PRIORITY_FEATURES_EXT||0),
...
const VkMemoryPriorityAllocateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMemoryPriorityAllocateInfoEXT", {
    sType: "u32("+(V.VkMemoryPriorityAllocateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_PRIORITY_ALLOCATE_INFO_EXT||0),
...
const VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PAGEABLE_DEVICE_LOCAL_MEMORY_FEATURES_EXT||0),
...
const VkPhysicalDeviceBufferDeviceAddressFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceBufferDeviceAddressFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceBufferDeviceAddressFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES||0),
...
const VkPhysicalDeviceBufferDeviceAddressFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceBufferDeviceAddressFeatures"));


const VkPhysicalDeviceBufferDeviceAddressFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceBufferDeviceAddressFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceBufferDeviceAddressFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_EXT||0),
...
const VkPhysicalDeviceBufferAddressFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceBufferDeviceAddressFeaturesEXT"));
...
const VkBufferDeviceAddressInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkBufferDeviceAddressInfo"));


const VkBufferOpaqueCaptureAddressCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkBufferOpaqueCaptureAddressCreateInfo", {
    sType: "u32("+(V.VkBufferOpaqueCaptureAddressCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO||0),
...
const VkBufferOpaqueCaptureAddressCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBufferOpaqueCaptureAddressCreateInfo"));


const VkBufferDeviceAddressCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkBufferDeviceAddressCreateInfoEXT", {
    sType: "u32("+(V.VkBufferDeviceAddressCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceImageViewImageFormatInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageViewImageFormatInfoEXT", {
    sType: "u32("+(V.VkPhysicalDeviceImageViewImageFormatInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_VIEW_IMAGE_FORMAT_INFO_EXT||0),
...
const VkFilterCubicImageViewImageFormatPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkFilterCubicImageViewImageFormatPropertiesEXT", {
    sType: "u32("+(V.VkFilterCubicImageViewImageFormatPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FILTER_CUBIC_IMAGE_VIEW_IMAGE_FORMAT_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceImagelessFramebufferFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImagelessFramebufferFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceImagelessFramebufferFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES||0),
...
const VkPhysicalDeviceImagelessFramebufferFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceImagelessFramebufferFeatures"));


const VkFramebufferAttachmentsCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkFramebufferAttachmentsCreateInfo", {
    sType: "u32("+(V.VkFramebufferAttachmentsCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO||0),
...
const VkFramebufferAttachmentsCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkFramebufferAttachmentsCreateInfo"));


const VkFramebufferAttachmentImageInfo = new Proxy(C.CStructView, new C.CStruct("VkFramebufferAttachmentImageInfo", {
    sType: "u32("+(V.VkFramebufferAttachmentImageInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO||0),
...
const VkFramebufferAttachmentImageInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkFramebufferAttachmentImageInfo"));


const VkRenderPassAttachmentBeginInfo = new Proxy(C.CStructView, new C.CStruct("VkRenderPassAttachmentBeginInfo", {
    sType: "u32("+(V.VkRenderPassAttachmentBeginInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO||0),
...
const VkRenderPassAttachmentBeginInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkRenderPassAttachmentBeginInfo"));


const VkPhysicalDeviceTextureCompressionASTCHDRFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceTextureCompressionASTCHDRFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceTextureCompressionASTCHDRFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES||0),
...
const VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceTextureCompressionASTCHDRFeatures"));


const VkPhysicalDeviceCooperativeMatrixFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCooperativeMatrixFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceCooperativeMatrixFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_NV||0),
...
const VkPhysicalDeviceCooperativeMatrixPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCooperativeMatrixPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceCooperativeMatrixPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_NV||0),
...
const VkCooperativeMatrixPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkCooperativeMatrixPropertiesNV", {
    sType: "u32("+(V.VkCooperativeMatrixPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_NV||0),
...
const VkPhysicalDeviceYcbcrImageArraysFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceYcbcrImageArraysFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceYcbcrImageArraysFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_IMAGE_ARRAYS_FEATURES_EXT||0),
...
const VkImageViewHandleInfoNVX = new Proxy(C.CStructView, new C.CStruct("VkImageViewHandleInfoNVX", {
    sType: "u32("+(V.VkImageViewHandleInfoNVX_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_VIEW_HANDLE_INFO_NVX||0),
    pNext: "u64("+(V.VkImageViewHandleInfoNVX_pNext_offsetof||0)+")",
    imageView: "u64("+(V.VkImageViewHandleInfoNVX_imageView_offsetof||0)+")",
...
const VkImageViewAddressPropertiesNVX = new Proxy(C.CStructView, new C.CStruct("VkImageViewAddressPropertiesNVX", {
    sType: "u32("+(V.VkImageViewAddressPropertiesNVX_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_VIEW_ADDRESS_PROPERTIES_NVX||0),
...
const VkPresentFrameTokenGGP = new Proxy(C.CStructView, new C.CStruct("VkPresentFrameTokenGGP", {
    sType: "u32("+(V.VkPresentFrameTokenGGP_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PRESENT_FRAME_TOKEN_GGP||0),
    pNext: "u64("+(V.VkPresentFrameTokenGGP_pNext_offsetof||0)+")",
    frameToken: "GgpFrameToken("+(V.VkPresentFrameTokenGGP_frameToken_offsetof||0)+")",
}, (V.VkPresentFrameTokenGGP_sizeof||0)));


const VkPipelineCreationFeedback = new Proxy(C.CStructView, new C.CStruct("VkPipelineCreationFeedback", {
...
const VkPipelineCreationFeedbackEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPipelineCreationFeedback"));


const VkPipelineCreationFeedbackCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineCreationFeedbackCreateInfo", {
    sType: "u32("+(V.VkPipelineCreationFeedbackCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO||0),
...
const VkPipelineCreationFeedbackCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPipelineCreationFeedbackCreateInfo"));


const VkSurfaceFullScreenExclusiveInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkSurfaceFullScreenExclusiveInfoEXT", {
    sType: "u32("+(V.VkSurfaceFullScreenExclusiveInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SURFACE_FULL_SCREEN_EXCLUSIVE_INFO_EXT||0),
...
const VkSurfaceFullScreenExclusiveWin32InfoEXT = new Proxy(C.CStructView, new C.CStruct("VkSurfaceFullScreenExclusiveWin32InfoEXT", {
    sType: "u32("+(V.VkSurfaceFullScreenExclusiveWin32InfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SURFACE_FULL_SCREEN_EXCLUSIVE_WIN32_INFO_EXT||0),
    pNext: "u64("+(V.VkSurfaceFullScreenExclusiveWin32InfoEXT_pNext_offsetof||0)+")",
    hmonitor: "HMONITOR("+(V.VkSurfaceFullScreenExclusiveWin32InfoEXT_hmonitor_offsetof||0)+")",
}, (V.VkSurfaceFullScreenExclusiveWin32InfoEXT_sizeof||0)));


const VkSurfaceCapabilitiesFullScreenExclusiveEXT = new Proxy(C.CStructView, new C.CStruct("VkSurfaceCapabilitiesFullScreenExclusiveEXT", {
    sType: "u32("+(V.VkSurfaceCapabilitiesFullScreenExclusiveEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_FULL_SCREEN_EXCLUSIVE_EXT||0),
...
const VkPhysicalDevicePresentBarrierFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePresentBarrierFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDevicePresentBarrierFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_BARRIER_FEATURES_NV||0),
...
const VkSurfaceCapabilitiesPresentBarrierNV = new Proxy(C.CStructView, new C.CStruct("VkSurfaceCapabilitiesPresentBarrierNV", {
    sType: "u32("+(V.VkSurfaceCapabilitiesPresentBarrierNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_BARRIER_NV||0),
...
const VkSwapchainPresentBarrierCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkSwapchainPresentBarrierCreateInfoNV", {
    sType: "u32("+(V.VkSwapchainPresentBarrierCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_BARRIER_CREATE_INFO_NV||0),
...
const VkPhysicalDevicePerformanceQueryFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePerformanceQueryFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDevicePerformanceQueryFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_FEATURES_KHR||0),
...
const VkPhysicalDevicePerformanceQueryPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePerformanceQueryPropertiesKHR", {
    sType: "u32("+(V.VkPhysicalDevicePerformanceQueryPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_PROPERTIES_KHR||0),
...
const VkPerformanceCounterKHR = new Proxy(C.CStructView, new C.CStruct("VkPerformanceCounterKHR", {
    sType: "u32("+(V.VkPerformanceCounterKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_KHR||0),
...
const VkPerformanceCounterDescriptionKHR = new Proxy(C.CStructView, new C.CStruct("VkPerformanceCounterDescriptionKHR", {
    sType: "u32("+(V.VkPerformanceCounterDescriptionKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_DESCRIPTION_KHR||0),
...
const VkQueryPoolPerformanceCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkQueryPoolPerformanceCreateInfoKHR", {
    sType: "u32("+(V.VkQueryPoolPerformanceCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_CREATE_INFO_KHR||0),
...
const VkAcquireProfilingLockInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAcquireProfilingLockInfoKHR", {
    sType: "u32("+(V.VkAcquireProfilingLockInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACQUIRE_PROFILING_LOCK_INFO_KHR||0),
...
const VkPerformanceQuerySubmitInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkPerformanceQuerySubmitInfoKHR", {
    sType: "u32("+(V.VkPerformanceQuerySubmitInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR||0),
...
const VkHeadlessSurfaceCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkHeadlessSurfaceCreateInfoEXT", {
    sType: "u32("+(V.VkHeadlessSurfaceCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_HEADLESS_SURFACE_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceCoverageReductionModeFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCoverageReductionModeFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceCoverageReductionModeFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COVERAGE_REDUCTION_MODE_FEATURES_NV||0),
...
const VkPipelineCoverageReductionStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineCoverageReductionStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineCoverageReductionStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_REDUCTION_STATE_CREATE_INFO_NV||0),
...
const VkFramebufferMixedSamplesCombinationNV = new Proxy(C.CStructView, new C.CStruct("VkFramebufferMixedSamplesCombinationNV", {
    sType: "u32("+(V.VkFramebufferMixedSamplesCombinationNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FRAMEBUFFER_MIXED_SAMPLES_COMBINATION_NV||0),
...
const VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL", {
    sType: "u32("+(V.VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_FUNCTIONS_2_FEATURES_INTEL||0),
...
const VkPerformanceValueINTEL = new Proxy(C.CStructView, new C.CStruct("VkPerformanceValueINTEL", {
    type: "u32("+(V.VkPerformanceValueINTEL_type_offsetof||0)+")",
    data: "VkPerformanceValueDataINTEL("+(V.VkPerformanceValueINTEL_data_offsetof||0)+")",
}, (V.VkPerformanceValueINTEL_sizeof||0)));


const VkInitializePerformanceApiInfoINTEL = new Proxy(C.CStructView, new C.CStruct("VkInitializePerformanceApiInfoINTEL", {
    sType: "u32("+(V.VkInitializePerformanceApiInfoINTEL_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_INITIALIZE_PERFORMANCE_API_INFO_INTEL||0),
...
const VkQueryPoolPerformanceQueryCreateInfoINTEL = new Proxy(C.CStructView, new C.CStruct("VkQueryPoolPerformanceQueryCreateInfoINTEL", {
    sType: "u32("+(V.VkQueryPoolPerformanceQueryCreateInfoINTEL_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_QUERY_CREATE_INFO_INTEL||0),
...
const VkQueryPoolCreateInfoINTEL = new Proxy(C.CStructView, new C.ConstructProxy("VkQueryPoolPerformanceQueryCreateInfoINTEL"));


const VkPerformanceMarkerInfoINTEL = new Proxy(C.CStructView, new C.CStruct("VkPerformanceMarkerInfoINTEL", {
    sType: "u32("+(V.VkPerformanceMarkerInfoINTEL_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PERFORMANCE_MARKER_INFO_INTEL||0),
...
const VkPerformanceStreamMarkerInfoINTEL = new Proxy(C.CStructView, new C.CStruct("VkPerformanceStreamMarkerInfoINTEL", {
    sType: "u32("+(V.VkPerformanceStreamMarkerInfoINTEL_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PERFORMANCE_STREAM_MARKER_INFO_INTEL||0),
...
const VkPerformanceOverrideInfoINTEL = new Proxy(C.CStructView, new C.CStruct("VkPerformanceOverrideInfoINTEL", {
    sType: "u32("+(V.VkPerformanceOverrideInfoINTEL_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PERFORMANCE_OVERRIDE_INFO_INTEL||0),
...
const VkPerformanceConfigurationAcquireInfoINTEL = new Proxy(C.CStructView, new C.CStruct("VkPerformanceConfigurationAcquireInfoINTEL", {
    sType: "u32("+(V.VkPerformanceConfigurationAcquireInfoINTEL_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PERFORMANCE_CONFIGURATION_ACQUIRE_INFO_INTEL||0),
...
const VkPhysicalDeviceShaderClockFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderClockFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceShaderClockFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR||0),
...
const VkPhysicalDeviceIndexTypeUint8FeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceIndexTypeUint8FeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceIndexTypeUint8FeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES_EXT||0),
...
const VkPhysicalDeviceShaderSMBuiltinsPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderSMBuiltinsPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceShaderSMBuiltinsPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SM_BUILTINS_PROPERTIES_NV||0),
...
const VkPhysicalDeviceShaderSMBuiltinsFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderSMBuiltinsFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceShaderSMBuiltinsFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SM_BUILTINS_FEATURES_NV||0),
...
const VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_INTERLOCK_FEATURES_EXT||0),
...
const VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES||0),
...
const VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures"));


const VkAttachmentReferenceStencilLayout = new Proxy(C.CStructView, new C.CStruct("VkAttachmentReferenceStencilLayout", {
    sType: "u32("+(V.VkAttachmentReferenceStencilLayout_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT||0),
...
const VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIMITIVE_TOPOLOGY_LIST_RESTART_FEATURES_EXT||0),
...
const VkAttachmentReferenceStencilLayoutKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkAttachmentReferenceStencilLayout"));


const VkAttachmentDescriptionStencilLayout = new Proxy(C.CStructView, new C.CStruct("VkAttachmentDescriptionStencilLayout", {
    sType: "u32("+(V.VkAttachmentDescriptionStencilLayout_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT||0),
...
const VkAttachmentDescriptionStencilLayoutKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkAttachmentDescriptionStencilLayout"));


const VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_EXECUTABLE_PROPERTIES_FEATURES_KHR||0),
...
const VkPipelineInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkPipelineInfoKHR", {
    sType: "u32("+(V.VkPipelineInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_INFO_KHR||0),
...
const VkPipelineInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPipelineInfoKHR"));


const VkPipelineExecutablePropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkPipelineExecutablePropertiesKHR", {
    sType: "u32("+(V.VkPipelineExecutablePropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_PROPERTIES_KHR||0),
...
const VkPipelineExecutableInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkPipelineExecutableInfoKHR", {
    sType: "u32("+(V.VkPipelineExecutableInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_INFO_KHR||0),
...
const VkPipelineExecutableStatisticKHR = new Proxy(C.CStructView, new C.CStruct("VkPipelineExecutableStatisticKHR", {
    sType: "u32("+(V.VkPipelineExecutableStatisticKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_STATISTIC_KHR||0),
    ...
    value: "VkPipelineExecutableStatisticValueKHR("+(V.VkPipelineExecutableStatisticKHR_value_offsetof||0)+")",
}, (V.VkPipelineExecutableStatisticKHR_sizeof||0)));


const VkPipelineExecutableInternalRepresentationKHR = new Proxy(C.CStructView, new C.CStruct("VkPipelineExecutableInternalRepresentationKHR", {
    sType: "u32("+(V.VkPipelineExecutableInternalRepresentationKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_INTERNAL_REPRESENTATION_KHR||0),
...
const VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES||0),
...
const VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures"));


const VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_FEATURES_EXT||0),
...
const VkPhysicalDeviceTexelBufferAlignmentProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceTexelBufferAlignmentProperties", {
    sType: "u32("+(V.VkPhysicalDeviceTexelBufferAlignmentProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_PROPERTIES||0),
...
const VkPhysicalDeviceTexelBufferAlignmentPropertiesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceTexelBufferAlignmentProperties"));


const VkPhysicalDeviceSubgroupSizeControlFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSubgroupSizeControlFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceSubgroupSizeControlFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES||0),
...
const VkPhysicalDeviceSubgroupSizeControlFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceSubgroupSizeControlFeatures"));


const VkPhysicalDeviceSubgroupSizeControlProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSubgroupSizeControlProperties", {
    sType: "u32("+(V.VkPhysicalDeviceSubgroupSizeControlProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_PROPERTIES||0),
...
const VkPhysicalDeviceSubgroupSizeControlPropertiesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceSubgroupSizeControlProperties"));


const VkPipelineShaderStageRequiredSubgroupSizeCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineShaderStageRequiredSubgroupSizeCreateInfo", {
    sType: "u32("+(V.VkPipelineShaderStageRequiredSubgroupSizeCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO||0),
...
const VkPipelineShaderStageRequiredSubgroupSizeCreateInfoEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPipelineShaderStageRequiredSubgroupSizeCreateInfo"));
...
const VkPhysicalDeviceSubpassShadingPropertiesHUAWEI = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSubpassShadingPropertiesHUAWEI", {
    sType: "u32("+(V.VkPhysicalDeviceSubpassShadingPropertiesHUAWEI_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_SHADING_PROPERTIES_HUAWEI||0),
...
const VkMemoryOpaqueCaptureAddressAllocateInfo = new Proxy(C.CStructView, new C.CStruct("VkMemoryOpaqueCaptureAddressAllocateInfo", {
    sType: "u32("+(V.VkMemoryOpaqueCaptureAddressAllocateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO||0),
...
const VkMemoryOpaqueCaptureAddressAllocateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkMemoryOpaqueCaptureAddressAllocateInfo"));


const VkDeviceMemoryOpaqueCaptureAddressInfo = new Proxy(C.CStructView, new C.CStruct("VkDeviceMemoryOpaqueCaptureAddressInfo", {
    sType: "u32("+(V.VkDeviceMemoryOpaqueCaptureAddressInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO||0),
...
const VkDeviceMemoryOpaqueCaptureAddressInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDeviceMemoryOpaqueCaptureAddressInfo"));


const VkPhysicalDeviceLineRasterizationFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceLineRasterizationFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceLineRasterizationFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_EXT||0),
...
const VkPhysicalDeviceLineRasterizationPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceLineRasterizationPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceLineRasterizationPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES_EXT||0),
...
const VkPipelineRasterizationLineStateCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineRasterizationLineStateCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineRasterizationLineStateCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO_EXT||0),
...
const VkPhysicalDevicePipelineCreationCacheControlFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePipelineCreationCacheControlFeatures", {
    sType: "u32("+(V.VkPhysicalDevicePipelineCreationCacheControlFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES||0),
...
const VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDevicePipelineCreationCacheControlFeatures"));


const VkPhysicalDeviceVulkan11Features = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVulkan11Features", {
    sType: "u32("+(V.VkPhysicalDeviceVulkan11Features_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_FEATURES||0),
...
const VkPhysicalDeviceVulkan11Properties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVulkan11Properties", {
    sType: "u32("+(V.VkPhysicalDeviceVulkan11Properties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_PROPERTIES||0),
...
const VkPhysicalDeviceVulkan12Features = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVulkan12Features", {
    sType: "u32("+(V.VkPhysicalDeviceVulkan12Features_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_FEATURES||0),
...
const VkPhysicalDeviceVulkan12Properties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVulkan12Properties", {
    sType: "u32("+(V.VkPhysicalDeviceVulkan12Properties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES||0),
    ...
    conformanceVersion: "VkConformanceVersion("+(V.VkPhysicalDeviceVulkan12Properties_conformanceVersion_offsetof||0)+")",
...
const VkPhysicalDeviceVulkan13Features = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVulkan13Features", {
    sType: "u32("+(V.VkPhysicalDeviceVulkan13Features_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_FEATURES||0),
...
const VkPhysicalDeviceVulkan13Properties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVulkan13Properties", {
    sType: "u32("+(V.VkPhysicalDeviceVulkan13Properties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_PROPERTIES||0),
...
const VkPipelineCompilerControlCreateInfoAMD = new Proxy(C.CStructView, new C.CStruct("VkPipelineCompilerControlCreateInfoAMD", {
    sType: "u32("+(V.VkPipelineCompilerControlCreateInfoAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_COMPILER_CONTROL_CREATE_INFO_AMD||0),
...
const VkPhysicalDeviceCoherentMemoryFeaturesAMD = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCoherentMemoryFeaturesAMD", {
    sType: "u32("+(V.VkPhysicalDeviceCoherentMemoryFeaturesAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COHERENT_MEMORY_FEATURES_AMD||0),
...
const VkPhysicalDeviceToolProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceToolProperties", {
    sType: "u32("+(V.VkPhysicalDeviceToolProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES||0),
...
const VkPhysicalDeviceToolPropertiesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceToolProperties"));


const VkSamplerCustomBorderColorCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkSamplerCustomBorderColorCreateInfoEXT", {
    sType: "u32("+(V.VkSamplerCustomBorderColorCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLER_CUSTOM_BORDER_COLOR_CREATE_INFO_EXT||0),
    pNext: "u64("+(V.VkSamplerCustomBorderColorCreateInfoEXT_pNext_offsetof||0)+")",
    customBorderColor: "VkClearColorValue("+(V.VkSamplerCustomBorderColorCreateInfoEXT_customBorderColor_offsetof||0)+")",
    format: "u32("+(V.VkSamplerCustomBorderColorCreateInfoEXT_format_offsetof||0)+")",
}, (V.VkSamplerCustomBorderColorCreateInfoEXT_sizeof||0)));


const VkPhysicalDeviceCustomBorderColorPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCustomBorderColorPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceCustomBorderColorPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceCustomBorderColorFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceCustomBorderColorFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceCustomBorderColorFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_FEATURES_EXT||0),
...
const VkSamplerBorderColorComponentMappingCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkSamplerBorderColorComponentMappingCreateInfoEXT", {
    sType: "u32("+(V.VkSamplerBorderColorComponentMappingCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLER_BORDER_COLOR_COMPONENT_MAPPING_CREATE_INFO_EXT||0),
    pNext: "u64("+(V.VkSamplerBorderColorComponentMappingCreateInfoEXT_pNext_offsetof||0)+")",
    components: "VkComponentMapping("+(V.VkSamplerBorderColorComponentMappingCreateInfoEXT_components_offsetof||0)+")",
...
const VkPhysicalDeviceBorderColorSwizzleFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceBorderColorSwizzleFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceBorderColorSwizzleFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BORDER_COLOR_SWIZZLE_FEATURES_EXT||0),
...
const VkAccelerationStructureGeometryTrianglesDataKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureGeometryTrianglesDataKHR", {
...
const VkAccelerationStructureGeometryInstancesDataKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureGeometryInstancesDataKHR", {
...
const VkAccelerationStructureGeometryKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureGeometryKHR", {
    sType: "u32("+(V.VkAccelerationStructureGeometryKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_KHR||0),
    ...
    geometry: "VkAccelerationStructureGeometryDataKHR("+(V.VkAccelerationStructureGeometryKHR_geometry_offsetof||0)+")",
    flags: "u32("+(V.VkAccelerationStructureGeometryKHR_flags_offsetof||0)+")",
}, (V.VkAccelerationStructureGeometryKHR_sizeof||0)));


const VkAccelerationStructureBuildGeometryInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureBuildGeometryInfoKHR", {
    sType: "u32("+(V.VkAccelerationStructureBuildGeometryInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_GEOMETRY_INFO_KHR||0),
...
const VkAccelerationStructureBuildRangeInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureBuildRangeInfoKHR", {
...
const VkAccelerationStructureCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureCreateInfoKHR", {
...
const VkAabbPositionsKHR = new Proxy(C.CStructView, new C.CStruct("VkAabbPositionsKHR", {
...
const VkAabbPositionsNV = new Proxy(C.CStructView, new C.ConstructProxy("VkAabbPositionsKHR"));
...
const VkAccelerationStructureInstanceKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureInstanceKHR", {
...
const VkAccelerationStructureInstanceNV = new Proxy(C.CStructView, new C.ConstructProxy("VkAccelerationStructureInstanceKHR"));


const VkAccelerationStructureDeviceAddressInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureDeviceAddressInfoKHR", {
    sType: "u32("+(V.VkAccelerationStructureDeviceAddressInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR||0),
...
const VkAccelerationStructureVersionInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureVersionInfoKHR", {
    sType: "u32("+(V.VkAccelerationStructureVersionInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_INFO_KHR||0),
...
const VkCopyAccelerationStructureInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkCopyAccelerationStructureInfoKHR", {
    sType: "u32("+(V.VkCopyAccelerationStructureInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_INFO_KHR||0),
...
const VkCopyAccelerationStructureToMemoryInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkCopyAccelerationStructureToMemoryInfoKHR", {
    sType: "u32("+(V.VkCopyAccelerationStructureToMemoryInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_TO_MEMORY_INFO_KHR||0),
...
const VkRayTracingPipelineInterfaceCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkRayTracingPipelineInterfaceCreateInfoKHR", {
    sType: "u32("+(V.VkRayTracingPipelineInterfaceCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_INTERFACE_CREATE_INFO_KHR||0),
...
const VkPipelineLibraryCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkPipelineLibraryCreateInfoKHR", {
    sType: "u32("+(V.VkPipelineLibraryCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_LIBRARY_CREATE_INFO_KHR||0),
...
const VkPhysicalDeviceExtendedDynamicStateFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExtendedDynamicStateFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceExtendedDynamicStateFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT||0),
...
const VkPhysicalDeviceExtendedDynamicState2FeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExtendedDynamicState2FeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceExtendedDynamicState2FeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_2_FEATURES_EXT||0),
...
const VkPhysicalDeviceExtendedDynamicState3FeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExtendedDynamicState3FeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceExtendedDynamicState3FeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_3_FEATURES_EXT||0),
...
const VkPhysicalDeviceExtendedDynamicState3PropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExtendedDynamicState3PropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceExtendedDynamicState3PropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_3_PROPERTIES_EXT||0),
...
const VkColorBlendEquationEXT = new Proxy(C.CStructView, new C.CStruct("VkColorBlendEquationEXT", {
...
const VkColorBlendAdvancedEXT = new Proxy(C.CStructView, new C.CStruct("VkColorBlendAdvancedEXT", {
...
const VkRenderPassTransformBeginInfoQCOM = new Proxy(C.CStructView, new C.CStruct("VkRenderPassTransformBeginInfoQCOM", {
    sType: "u32("+(V.VkRenderPassTransformBeginInfoQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM||0),
...
const VkCopyCommandTransformInfoQCOM = new Proxy(C.CStructView, new C.CStruct("VkCopyCommandTransformInfoQCOM", {
    sType: "u32("+(V.VkCopyCommandTransformInfoQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_COMMAND_TRANSFORM_INFO_QCOM||0),
...
const VkCommandBufferInheritanceRenderPassTransformInfoQCOM = new Proxy(C.CStructView, new C.CStruct("VkCommandBufferInheritanceRenderPassTransformInfoQCOM", {
    sType: "u32("+(V.VkCommandBufferInheritanceRenderPassTransformInfoQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDER_PASS_TRANSFORM_INFO_QCOM||0),
...
const VkPhysicalDeviceDiagnosticsConfigFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDiagnosticsConfigFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceDiagnosticsConfigFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV||0),
...
const VkDeviceDiagnosticsConfigCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkDeviceDiagnosticsConfigCreateInfoNV", {
    sType: "u32("+(V.VkDeviceDiagnosticsConfigCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV||0),
...
const VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_WORKGROUP_MEMORY_FEATURES||0),
...
const VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures"));


const VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_FEATURES_KHR||0),
...
const VkPhysicalDeviceRobustness2FeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRobustness2FeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceRobustness2FeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_EXT||0),
...
const VkPhysicalDeviceRobustness2PropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRobustness2PropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceRobustness2PropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceImageRobustnessFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageRobustnessFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceImageRobustnessFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES||0),
...
const VkPhysicalDeviceImageRobustnessFeaturesEXT = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceImageRobustnessFeatures"));


const VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_FEATURES_KHR||0),
...
const VkPhysicalDevicePortabilitySubsetFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePortabilitySubsetFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDevicePortabilitySubsetFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_FEATURES_KHR||0),
...
const VkPhysicalDevicePortabilitySubsetPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePortabilitySubsetPropertiesKHR", {
    sType: "u32("+(V.VkPhysicalDevicePortabilitySubsetPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_PROPERTIES_KHR||0),
...
const VkPhysicalDevice4444FormatsFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevice4444FormatsFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDevice4444FormatsFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT||0),
...
const VkPhysicalDeviceSubpassShadingFeaturesHUAWEI = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSubpassShadingFeaturesHUAWEI", {
    sType: "u32("+(V.VkPhysicalDeviceSubpassShadingFeaturesHUAWEI_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_SHADING_FEATURES_HUAWEI||0),
...
const VkBufferCopy2 = new Proxy(C.CStructView, new C.CStruct("VkBufferCopy2", {
    sType: "u32("+(V.VkBufferCopy2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_COPY_2||0),
...
const VkBufferCopy2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBufferCopy2"));


const VkImageCopy2 = new Proxy(C.CStructView, new C.CStruct("VkImageCopy2", {
    sType: "u32("+(V.VkImageCopy2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_COPY_2||0),
    pNext: "u64("+(V.VkImageCopy2_pNext_offsetof||0)+")",
    srcSubresource: "VkImageSubresourceLayers("+(V.VkImageCopy2_srcSubresource_offsetof||0)+")",
    srcOffset: "VkOffset3D("+(V.VkImageCopy2_srcOffset_offsetof||0)+")",
    dstSubresource: "VkImageSubresourceLayers("+(V.VkImageCopy2_dstSubresource_offsetof||0)+")",
    dstOffset: "VkOffset3D("+(V.VkImageCopy2_dstOffset_offsetof||0)+")",
    extent: "VkExtent3D("+(V.VkImageCopy2_extent_offsetof||0)+")",
}, (V.VkImageCopy2_sizeof||0)));

const VkImageCopy2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageCopy2"));


const VkImageBlit2 = new Proxy(C.CStructView, new C.CStruct("VkImageBlit2", {
    sType: "u32("+(V.VkImageBlit2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_BLIT_2||0),
    pNext: "u64("+(V.VkImageBlit2_pNext_offsetof||0)+")",
    srcSubresource: "VkImageSubresourceLayers("+(V.VkImageBlit2_srcSubresource_offsetof||0)+")",
    srcOffsets: "VkOffset3D[2]("+(V.VkImageBlit2_srcOffsets_offsetof||0)+")",
    dstSubresource: "VkImageSubresourceLayers("+(V.VkImageBlit2_dstSubresource_offsetof||0)+")",
    dstOffsets: "VkOffset3D[2]("+(V.VkImageBlit2_dstOffsets_offsetof||0)+")",
}, (V.VkImageBlit2_sizeof||0)));

const VkImageBlit2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageBlit2"));


const VkBufferImageCopy2 = new Proxy(C.CStructView, new C.CStruct("VkBufferImageCopy2", {
    sType: "u32("+(V.VkBufferImageCopy2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_IMAGE_COPY_2||0),
    ...
    imageSubresource: "VkImageSubresourceLayers("+(V.VkBufferImageCopy2_imageSubresource_offsetof||0)+")",
    imageOffset: "VkOffset3D("+(V.VkBufferImageCopy2_imageOffset_offsetof||0)+")",
    imageExtent: "VkExtent3D("+(V.VkBufferImageCopy2_imageExtent_offsetof||0)+")",
}, (V.VkBufferImageCopy2_sizeof||0)));

const VkBufferImageCopy2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBufferImageCopy2"));


const VkImageResolve2 = new Proxy(C.CStructView, new C.CStruct("VkImageResolve2", {
    sType: "u32("+(V.VkImageResolve2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_RESOLVE_2||0),
    pNext: "u64("+(V.VkImageResolve2_pNext_offsetof||0)+")",
    srcSubresource: "VkImageSubresourceLayers("+(V.VkImageResolve2_srcSubresource_offsetof||0)+")",
    srcOffset: "VkOffset3D("+(V.VkImageResolve2_srcOffset_offsetof||0)+")",
    dstSubresource: "VkImageSubresourceLayers("+(V.VkImageResolve2_dstSubresource_offsetof||0)+")",
    dstOffset: "VkOffset3D("+(V.VkImageResolve2_dstOffset_offsetof||0)+")",
    extent: "VkExtent3D("+(V.VkImageResolve2_extent_offsetof||0)+")",
}, (V.VkImageResolve2_sizeof||0)));

const VkImageResolve2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageResolve2"));


const VkCopyBufferInfo2 = new Proxy(C.CStructView, new C.CStruct("VkCopyBufferInfo2", {
    sType: "u32("+(V.VkCopyBufferInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_BUFFER_INFO_2||0),
...
const VkCopyBufferInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkCopyBufferInfo2"));


const VkCopyImageInfo2 = new Proxy(C.CStructView, new C.CStruct("VkCopyImageInfo2", {
    sType: "u32("+(V.VkCopyImageInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_IMAGE_INFO_2||0),
...
const VkCopyImageInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkCopyImageInfo2"));


const VkBlitImageInfo2 = new Proxy(C.CStructView, new C.CStruct("VkBlitImageInfo2", {
    sType: "u32("+(V.VkBlitImageInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BLIT_IMAGE_INFO_2||0),
...
const VkBlitImageInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBlitImageInfo2"));


const VkCopyBufferToImageInfo2 = new Proxy(C.CStructView, new C.CStruct("VkCopyBufferToImageInfo2", {
    sType: "u32("+(V.VkCopyBufferToImageInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_BUFFER_TO_IMAGE_INFO_2||0),
...
const VkCopyBufferToImageInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkCopyBufferToImageInfo2"));


const VkCopyImageToBufferInfo2 = new Proxy(C.CStructView, new C.CStruct("VkCopyImageToBufferInfo2", {
    sType: "u32("+(V.VkCopyImageToBufferInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_IMAGE_TO_BUFFER_INFO_2||0),
...
const VkCopyImageToBufferInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkCopyImageToBufferInfo2"));


const VkResolveImageInfo2 = new Proxy(C.CStructView, new C.CStruct("VkResolveImageInfo2", {
    sType: "u32("+(V.VkResolveImageInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RESOLVE_IMAGE_INFO_2||0),
...
const VkResolveImageInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkResolveImageInfo2"));


const VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_ATOMIC_INT64_FEATURES_EXT||0),
...
const VkFragmentShadingRateAttachmentInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkFragmentShadingRateAttachmentInfoKHR", {
    sType: "u32("+(V.VkFragmentShadingRateAttachmentInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR||0),
...
const VkPipelineFragmentShadingRateStateCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkPipelineFragmentShadingRateStateCreateInfoKHR", {
    sType: "u32("+(V.VkPipelineFragmentShadingRateStateCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_STATE_CREATE_INFO_KHR||0),
...
const VkPhysicalDeviceFragmentShadingRateFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentShadingRateFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentShadingRateFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_FEATURES_KHR||0),
...
const VkPhysicalDeviceFragmentShadingRatePropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentShadingRatePropertiesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentShadingRatePropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_PROPERTIES_KHR||0),
...
const VkPhysicalDeviceFragmentShadingRateKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentShadingRateKHR", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentShadingRateKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_KHR||0),
...
const VkPhysicalDeviceShaderTerminateInvocationFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderTerminateInvocationFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceShaderTerminateInvocationFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES||0),
...
const VkPhysicalDeviceShaderTerminateInvocationFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderTerminateInvocationFeatures"));


const VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_FEATURES_NV||0),
...
const VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV||0),
...
const VkPipelineFragmentShadingRateEnumStateCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkPipelineFragmentShadingRateEnumStateCreateInfoNV", {
    sType: "u32("+(V.VkPipelineFragmentShadingRateEnumStateCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_ENUM_STATE_CREATE_INFO_NV||0),
...
const VkAccelerationStructureBuildSizesInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureBuildSizesInfoKHR", {
    sType: "u32("+(V.VkAccelerationStructureBuildSizesInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_SIZES_INFO_KHR||0),
...
const VkPhysicalDeviceImage2DViewOf3DFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImage2DViewOf3DFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceImage2DViewOf3DFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_2D_VIEW_OF_3D_FEATURES_EXT||0),
...
const VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_EXT||0),
...
const VkPhysicalDeviceMutableDescriptorTypeFeaturesVALVE = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT"));


const VkMutableDescriptorTypeListEXT = new Proxy(C.CStructView, new C.CStruct("VkMutableDescriptorTypeListEXT", {
...
const VkMutableDescriptorTypeListVALVE = new Proxy(C.CStructView, new C.ConstructProxy("VkMutableDescriptorTypeListEXT"));


const VkMutableDescriptorTypeCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMutableDescriptorTypeCreateInfoEXT", {
    sType: "u32("+(V.VkMutableDescriptorTypeCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_EXT||0),
...
const VkMutableDescriptorTypeCreateInfoVALVE = new Proxy(C.CStructView, new C.ConstructProxy("VkMutableDescriptorTypeCreateInfoEXT"));


const VkPhysicalDeviceDepthClipControlFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDepthClipControlFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDepthClipControlFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLIP_CONTROL_FEATURES_EXT||0),
...
const VkPipelineViewportDepthClipControlCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineViewportDepthClipControlCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineViewportDepthClipControlCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_DEPTH_CLIP_CONTROL_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_INPUT_DYNAMIC_STATE_FEATURES_EXT||0),
...
const VkPhysicalDeviceExternalMemoryRDMAFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceExternalMemoryRDMAFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceExternalMemoryRDMAFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_RDMA_FEATURES_NV||0),
...
const VkVertexInputBindingDescription2EXT = new Proxy(C.CStructView, new C.CStruct("VkVertexInputBindingDescription2EXT", {
    sType: "u32("+(V.VkVertexInputBindingDescription2EXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VERTEX_INPUT_BINDING_DESCRIPTION_2_EXT||0),
...
const VkVertexInputAttributeDescription2EXT = new Proxy(C.CStructView, new C.CStruct("VkVertexInputAttributeDescription2EXT", {
    sType: "u32("+(V.VkVertexInputAttributeDescription2EXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VERTEX_INPUT_ATTRIBUTE_DESCRIPTION_2_EXT||0),
...
const VkPhysicalDeviceColorWriteEnableFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceColorWriteEnableFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceColorWriteEnableFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COLOR_WRITE_ENABLE_FEATURES_EXT||0),
...
const VkPipelineColorWriteCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineColorWriteCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineColorWriteCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_COLOR_WRITE_CREATE_INFO_EXT||0),
...
const VkMemoryBarrier2 = new Proxy(C.CStructView, new C.CStruct("VkMemoryBarrier2", {
    sType: "u32("+(V.VkMemoryBarrier2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_BARRIER_2||0),
...
const VkMemoryBarrier2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkMemoryBarrier2"));


const VkImageMemoryBarrier2 = new Proxy(C.CStructView, new C.CStruct("VkImageMemoryBarrier2", {
    sType: "u32("+(V.VkImageMemoryBarrier2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2||0),
    ...
    subresourceRange: "VkImageSubresourceRange("+(V.VkImageMemoryBarrier2_subresourceRange_offsetof||0)+")",
}, (V.VkImageMemoryBarrier2_sizeof||0)));

const VkImageMemoryBarrier2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkImageMemoryBarrier2"));


const VkBufferMemoryBarrier2 = new Proxy(C.CStructView, new C.CStruct("VkBufferMemoryBarrier2", {
    sType: "u32("+(V.VkBufferMemoryBarrier2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER_2||0),
...
const VkBufferMemoryBarrier2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkBufferMemoryBarrier2"));


const VkDependencyInfo = new Proxy(C.CStructView, new C.CStruct("VkDependencyInfo", {
    sType: "u32("+(V.VkDependencyInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEPENDENCY_INFO||0),
...
const VkDependencyInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkDependencyInfo"));


const VkSemaphoreSubmitInfo = new Proxy(C.CStructView, new C.CStruct("VkSemaphoreSubmitInfo", {
    sType: "u32("+(V.VkSemaphoreSubmitInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SEMAPHORE_SUBMIT_INFO||0),
...
const VkSemaphoreSubmitInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSemaphoreSubmitInfo"));


const VkCommandBufferSubmitInfo = new Proxy(C.CStructView, new C.CStruct("VkCommandBufferSubmitInfo", {
    sType: "u32("+(V.VkCommandBufferSubmitInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COMMAND_BUFFER_SUBMIT_INFO||0),
...
const VkCommandBufferSubmitInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkCommandBufferSubmitInfo"));


const VkSubmitInfo2 = new Proxy(C.CStructView, new C.CStruct("VkSubmitInfo2", {
    sType: "u32("+(V.VkSubmitInfo2_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBMIT_INFO_2||0),
...
const VkSubmitInfo2KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkSubmitInfo2"));


const VkQueueFamilyCheckpointProperties2NV = new Proxy(C.CStructView, new C.CStruct("VkQueueFamilyCheckpointProperties2NV", {
    sType: "u32("+(V.VkQueueFamilyCheckpointProperties2NV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV||0),
...
const VkCheckpointData2NV = new Proxy(C.CStructView, new C.CStruct("VkCheckpointData2NV", {
    sType: "u32("+(V.VkCheckpointData2NV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_CHECKPOINT_DATA_2_NV||0),
...
const VkPhysicalDeviceSynchronization2Features = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSynchronization2Features", {
    sType: "u32("+(V.VkPhysicalDeviceSynchronization2Features_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES||0),
...
const VkPhysicalDeviceSynchronization2FeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceSynchronization2Features"));


const VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIMITIVES_GENERATED_QUERY_FEATURES_EXT||0),
...
const VkPhysicalDeviceLegacyDitheringFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceLegacyDitheringFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceLegacyDitheringFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_DITHERING_FEATURES_EXT||0),
...
const VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_FEATURES_EXT||0),
...
const VkSubpassResolvePerformanceQueryEXT = new Proxy(C.CStructView, new C.CStruct("VkSubpassResolvePerformanceQueryEXT", {
    sType: "u32("+(V.VkSubpassResolvePerformanceQueryEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBPASS_RESOLVE_PERFORMANCE_QUERY_EXT||0),
...
const VkMultisampledRenderToSingleSampledInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMultisampledRenderToSingleSampledInfoEXT", {
    sType: "u32("+(V.VkMultisampledRenderToSingleSampledInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_INFO_EXT||0),
...
const VkPhysicalDevicePipelineProtectedAccessFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePipelineProtectedAccessFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDevicePipelineProtectedAccessFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES_EXT||0),
...
const VkQueueFamilyVideoPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkQueueFamilyVideoPropertiesKHR", {
    sType: "u32("+(V.VkQueueFamilyVideoPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUEUE_FAMILY_VIDEO_PROPERTIES_KHR||0),
...
const VkQueueFamilyQueryResultStatusPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkQueueFamilyQueryResultStatusPropertiesKHR", {
    sType: "u32("+(V.VkQueueFamilyQueryResultStatusPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_QUEUE_FAMILY_QUERY_RESULT_STATUS_PROPERTIES_KHR||0),
...
const VkVideoProfileListInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoProfileListInfoKHR", {
    sType: "u32("+(V.VkVideoProfileListInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_PROFILE_LIST_INFO_KHR||0),
...
const VkPhysicalDeviceVideoFormatInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceVideoFormatInfoKHR", {
    sType: "u32("+(V.VkPhysicalDeviceVideoFormatInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_FORMAT_INFO_KHR||0),
...
const VkVideoFormatPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoFormatPropertiesKHR", {
    sType: "u32("+(V.VkVideoFormatPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_FORMAT_PROPERTIES_KHR||0),
    pNext: "u64("+(V.VkVideoFormatPropertiesKHR_pNext_offsetof||0)+")",
    format: "u32("+(V.VkVideoFormatPropertiesKHR_format_offsetof||0)+")",
    componentMapping: "VkComponentMapping("+(V.VkVideoFormatPropertiesKHR_componentMapping_offsetof||0)+")",
...
const VkVideoProfileInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoProfileInfoKHR", {
    sType: "u32("+(V.VkVideoProfileInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_PROFILE_INFO_KHR||0),
...
const VkVideoCapabilitiesKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoCapabilitiesKHR", {
    sType: "u32("+(V.VkVideoCapabilitiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_CAPABILITIES_KHR||0),
    ...
    stdHeaderVersion: "VkExtensionProperties("+(V.VkVideoCapabilitiesKHR_stdHeaderVersion_offsetof||0)+")",
}, (V.VkVideoCapabilitiesKHR_sizeof||0)));


const VkVideoSessionMemoryRequirementsKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoSessionMemoryRequirementsKHR", {
...
const VkBindVideoSessionMemoryInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkBindVideoSessionMemoryInfoKHR", {
    sType: "u32("+(V.VkBindVideoSessionMemoryInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BIND_VIDEO_SESSION_MEMORY_INFO_KHR||0),
...
const VkVideoPictureResourceInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoPictureResourceInfoKHR", {
    sType: "u32("+(V.VkVideoPictureResourceInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_PICTURE_RESOURCE_INFO_KHR||0),
    ...
    imageViewBinding: "u64("+(V.VkVideoPictureResourceInfoKHR_imageViewBinding_offsetof||0)+")",
}, (V.VkVideoPictureResourceInfoKHR_sizeof||0)));


const VkVideoReferenceSlotInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoReferenceSlotInfoKHR", {
    sType: "u32("+(V.VkVideoReferenceSlotInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_REFERENCE_SLOT_INFO_KHR||0),
...
const VkVideoDecodeCapabilitiesKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoDecodeCapabilitiesKHR", {
    sType: "u32("+(V.VkVideoDecodeCapabilitiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_DECODE_CAPABILITIES_KHR||0),
...
const VkVideoDecodeUsageInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoDecodeUsageInfoKHR", {
    sType: "u32("+(V.VkVideoDecodeUsageInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_DECODE_USAGE_INFO_KHR||0),
...
const VkVideoDecodeInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoDecodeInfoKHR", {
    sType: "u32("+(V.VkVideoDecodeInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_DECODE_INFO_KHR||0),
    ...
    dstPictureResource: "VkVideoPictureResourceInfoKHR("+(V.VkVideoDecodeInfoKHR_dstPictureResource_offsetof||0)+")",
...
const VkVideoSessionCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoSessionCreateInfoKHR", {
    sType: "u32("+(V.VkVideoSessionCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_SESSION_CREATE_INFO_KHR||0),
...
const VkVideoSessionParametersCreateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoSessionParametersCreateInfoKHR", {
    sType: "u32("+(V.VkVideoSessionParametersCreateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_SESSION_PARAMETERS_CREATE_INFO_KHR||0),
    ...
    videoSessionParametersTemplate: "VkVideoSessionParametersKHR("+(V.VkVideoSessionParametersCreateInfoKHR_videoSessionParametersTemplate_offsetof||0)+")",
    videoSession: "VkVideoSessionKHR("+(V.VkVideoSessionParametersCreateInfoKHR_videoSession_offsetof||0)+")",
}, (V.VkVideoSessionParametersCreateInfoKHR_sizeof||0)));


const VkVideoSessionParametersUpdateInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoSessionParametersUpdateInfoKHR", {
    sType: "u32("+(V.VkVideoSessionParametersUpdateInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_SESSION_PARAMETERS_UPDATE_INFO_KHR||0),
...
const VkVideoBeginCodingInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoBeginCodingInfoKHR", {
    sType: "u32("+(V.VkVideoBeginCodingInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_BEGIN_CODING_INFO_KHR||0),
    pNext: "u64("+(V.VkVideoBeginCodingInfoKHR_pNext_offsetof||0)+")",
    flags: "u32("+(V.VkVideoBeginCodingInfoKHR_flags_offsetof||0)+")",
    videoSession: "VkVideoSessionKHR("+(V.VkVideoBeginCodingInfoKHR_videoSession_offsetof||0)+")",
    videoSessionParameters: "VkVideoSessionParametersKHR("+(V.VkVideoBeginCodingInfoKHR_videoSessionParameters_offsetof||0)+")",
...
const VkVideoEndCodingInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoEndCodingInfoKHR", {
    sType: "u32("+(V.VkVideoEndCodingInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_END_CODING_INFO_KHR||0),
...
const VkVideoCodingControlInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoCodingControlInfoKHR", {
    sType: "u32("+(V.VkVideoCodingControlInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_CODING_CONTROL_INFO_KHR||0),
...
const VkVideoEncodeUsageInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeUsageInfoKHR", {
    sType: "u32("+(V.VkVideoEncodeUsageInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_USAGE_INFO_KHR||0),
...
const VkVideoEncodeInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeInfoKHR", {
    sType: "u32("+(V.VkVideoEncodeInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_INFO_KHR||0),
    ...
    srcPictureResource: "VkVideoPictureResourceInfoKHR("+(V.VkVideoEncodeInfoKHR_srcPictureResource_offsetof||0)+")",
...
const VkVideoEncodeRateControlInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeRateControlInfoKHR", {
    sType: "u32("+(V.VkVideoEncodeRateControlInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_RATE_CONTROL_INFO_KHR||0),
...
const VkVideoEncodeRateControlLayerInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeRateControlLayerInfoKHR", {
    sType: "u32("+(V.VkVideoEncodeRateControlLayerInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_RATE_CONTROL_LAYER_INFO_KHR||0),
...
const VkVideoEncodeCapabilitiesKHR = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeCapabilitiesKHR", {
    sType: "u32("+(V.VkVideoEncodeCapabilitiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_CAPABILITIES_KHR||0),
...
const VkVideoEncodeH264CapabilitiesEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264CapabilitiesEXT", {
    sType: "u32("+(V.VkVideoEncodeH264CapabilitiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_CAPABILITIES_EXT||0),
...
const VkVideoEncodeH264SessionParametersAddInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264SessionParametersAddInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264SessionParametersAddInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_ADD_INFO_EXT||0),
...
const VkVideoEncodeH264SessionParametersCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264SessionParametersCreateInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264SessionParametersCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_CREATE_INFO_EXT||0),
...
const VkVideoEncodeH264DpbSlotInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264DpbSlotInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264DpbSlotInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_DPB_SLOT_INFO_EXT||0),
...
const VkVideoEncodeH264VclFrameInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264VclFrameInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264VclFrameInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_VCL_FRAME_INFO_EXT||0),
...
const VkVideoEncodeH264ReferenceListsInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264ReferenceListsInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264ReferenceListsInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_REFERENCE_LISTS_INFO_EXT||0),
...
const VkVideoEncodeH264EmitPictureParametersInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264EmitPictureParametersInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264EmitPictureParametersInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_EMIT_PICTURE_PARAMETERS_INFO_EXT||0),
...
const VkVideoEncodeH264ProfileInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264ProfileInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264ProfileInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_PROFILE_INFO_EXT||0),
    pNext: "u64("+(V.VkVideoEncodeH264ProfileInfoEXT_pNext_offsetof||0)+")",
    stdProfileIdc: "StdVideoH264ProfileIdc("+(V.VkVideoEncodeH264ProfileInfoEXT_stdProfileIdc_offsetof||0)+")",
}, (V.VkVideoEncodeH264ProfileInfoEXT_sizeof||0)));


const VkVideoEncodeH264NaluSliceInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264NaluSliceInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264NaluSliceInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_NALU_SLICE_INFO_EXT||0),
...
const VkVideoEncodeH264RateControlInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264RateControlInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264RateControlInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_RATE_CONTROL_INFO_EXT||0),
...
const VkVideoEncodeH264QpEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264QpEXT", {
...
const VkVideoEncodeH264FrameSizeEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264FrameSizeEXT", {
...
const VkVideoEncodeH264RateControlLayerInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH264RateControlLayerInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH264RateControlLayerInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_RATE_CONTROL_LAYER_INFO_EXT||0),
    ...
    initialRcQp: "VkVideoEncodeH264QpEXT("+(V.VkVideoEncodeH264RateControlLayerInfoEXT_initialRcQp_offsetof||0)+")",
    useMinQp: "u32("+(V.VkVideoEncodeH264RateControlLayerInfoEXT_useMinQp_offsetof||0)+")",
    minQp: "VkVideoEncodeH264QpEXT("+(V.VkVideoEncodeH264RateControlLayerInfoEXT_minQp_offsetof||0)+")",
    useMaxQp: "u32("+(V.VkVideoEncodeH264RateControlLayerInfoEXT_useMaxQp_offsetof||0)+")",
    maxQp: "VkVideoEncodeH264QpEXT("+(V.VkVideoEncodeH264RateControlLayerInfoEXT_maxQp_offsetof||0)+")",
    useMaxFrameSize: "u32("+(V.VkVideoEncodeH264RateControlLayerInfoEXT_useMaxFrameSize_offsetof||0)+")",
    maxFrameSize: "VkVideoEncodeH264FrameSizeEXT("+(V.VkVideoEncodeH264RateControlLayerInfoEXT_maxFrameSize_offsetof||0)+")",
}, (V.VkVideoEncodeH264RateControlLayerInfoEXT_sizeof||0)));


const VkVideoEncodeH265CapabilitiesEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265CapabilitiesEXT", {
    sType: "u32("+(V.VkVideoEncodeH265CapabilitiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_CAPABILITIES_EXT||0),
...
const VkVideoEncodeH265SessionParametersAddInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265SessionParametersAddInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265SessionParametersAddInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_ADD_INFO_EXT||0),
...
const VkVideoEncodeH265SessionParametersCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265SessionParametersCreateInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265SessionParametersCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_EXT||0),
...
const VkVideoEncodeH265VclFrameInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265VclFrameInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265VclFrameInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_VCL_FRAME_INFO_EXT||0),
...
const VkVideoEncodeH265EmitPictureParametersInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265EmitPictureParametersInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265EmitPictureParametersInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_EMIT_PICTURE_PARAMETERS_INFO_EXT||0),
...
const VkVideoEncodeH265NaluSliceSegmentInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265NaluSliceSegmentInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265NaluSliceSegmentInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_NALU_SLICE_SEGMENT_INFO_EXT||0),
...
const VkVideoEncodeH265RateControlInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265RateControlInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265RateControlInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_RATE_CONTROL_INFO_EXT||0),
...
const VkVideoEncodeH265QpEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265QpEXT", {
...
const VkVideoEncodeH265FrameSizeEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265FrameSizeEXT", {
...
const VkVideoEncodeH265RateControlLayerInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265RateControlLayerInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265RateControlLayerInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_RATE_CONTROL_LAYER_INFO_EXT||0),
    ...
    initialRcQp: "VkVideoEncodeH265QpEXT("+(V.VkVideoEncodeH265RateControlLayerInfoEXT_initialRcQp_offsetof||0)+")",
    useMinQp: "u32("+(V.VkVideoEncodeH265RateControlLayerInfoEXT_useMinQp_offsetof||0)+")",
    minQp: "VkVideoEncodeH265QpEXT("+(V.VkVideoEncodeH265RateControlLayerInfoEXT_minQp_offsetof||0)+")",
    useMaxQp: "u32("+(V.VkVideoEncodeH265RateControlLayerInfoEXT_useMaxQp_offsetof||0)+")",
    maxQp: "VkVideoEncodeH265QpEXT("+(V.VkVideoEncodeH265RateControlLayerInfoEXT_maxQp_offsetof||0)+")",
    useMaxFrameSize: "u32("+(V.VkVideoEncodeH265RateControlLayerInfoEXT_useMaxFrameSize_offsetof||0)+")",
    maxFrameSize: "VkVideoEncodeH265FrameSizeEXT("+(V.VkVideoEncodeH265RateControlLayerInfoEXT_maxFrameSize_offsetof||0)+")",
}, (V.VkVideoEncodeH265RateControlLayerInfoEXT_sizeof||0)));


const VkVideoEncodeH265ProfileInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265ProfileInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265ProfileInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_PROFILE_INFO_EXT||0),
    pNext: "u64("+(V.VkVideoEncodeH265ProfileInfoEXT_pNext_offsetof||0)+")",
    stdProfileIdc: "StdVideoH265ProfileIdc("+(V.VkVideoEncodeH265ProfileInfoEXT_stdProfileIdc_offsetof||0)+")",
}, (V.VkVideoEncodeH265ProfileInfoEXT_sizeof||0)));


const VkVideoEncodeH265DpbSlotInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265DpbSlotInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265DpbSlotInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_DPB_SLOT_INFO_EXT||0),
...
const VkVideoEncodeH265ReferenceListsInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkVideoEncodeH265ReferenceListsInfoEXT", {
    sType: "u32("+(V.VkVideoEncodeH265ReferenceListsInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_REFERENCE_LISTS_INFO_EXT||0),
...
const VkPhysicalDeviceInheritedViewportScissorFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceInheritedViewportScissorFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceInheritedViewportScissorFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INHERITED_VIEWPORT_SCISSOR_FEATURES_NV||0),
...
const VkCommandBufferInheritanceViewportScissorInfoNV = new Proxy(C.CStructView, new C.CStruct("VkCommandBufferInheritanceViewportScissorInfoNV", {
    sType: "u32("+(V.VkCommandBufferInheritanceViewportScissorInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_VIEWPORT_SCISSOR_INFO_NV||0),
...
const VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_2_PLANE_444_FORMATS_FEATURES_EXT||0),
...
const VkPhysicalDeviceProvokingVertexFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceProvokingVertexFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceProvokingVertexFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_FEATURES_EXT||0),
...
const VkPhysicalDeviceProvokingVertexPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceProvokingVertexPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceProvokingVertexPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_PROPERTIES_EXT||0),
...
const VkPipelineRasterizationProvokingVertexStateCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineRasterizationProvokingVertexStateCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineRasterizationProvokingVertexStateCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_PROVOKING_VERTEX_STATE_CREATE_INFO_EXT||0),
...
const VkCuModuleCreateInfoNVX = new Proxy(C.CStructView, new C.CStruct("VkCuModuleCreateInfoNVX", {
    sType: "u32("+(V.VkCuModuleCreateInfoNVX_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_CU_MODULE_CREATE_INFO_NVX||0),
...
const VkCuFunctionCreateInfoNVX = new Proxy(C.CStructView, new C.CStruct("VkCuFunctionCreateInfoNVX", {
    sType: "u32("+(V.VkCuFunctionCreateInfoNVX_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_CU_FUNCTION_CREATE_INFO_NVX||0),
    pNext: "u64("+(V.VkCuFunctionCreateInfoNVX_pNext_offsetof||0)+")",
    module: "VkCuModuleNVX("+(V.VkCuFunctionCreateInfoNVX_module_offsetof||0)+")",
    pName: "u64("+(V.VkCuFunctionCreateInfoNVX_pName_offsetof||0)+")",
}, (V.VkCuFunctionCreateInfoNVX_sizeof||0)));


const VkCuLaunchInfoNVX = new Proxy(C.CStructView, new C.CStruct("VkCuLaunchInfoNVX", {
    sType: "u32("+(V.VkCuLaunchInfoNVX_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_CU_LAUNCH_INFO_NVX||0),
    pNext: "u64("+(V.VkCuLaunchInfoNVX_pNext_offsetof||0)+")",
    function: "VkCuFunctionNVX("+(V.VkCuLaunchInfoNVX_function_offsetof||0)+")",
...
const VkPhysicalDeviceDescriptorBufferFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDescriptorBufferFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDescriptorBufferFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_FEATURES_EXT||0),
...
const VkPhysicalDeviceDescriptorBufferPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDescriptorBufferPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDescriptorBufferPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_DENSITY_MAP_PROPERTIES_EXT||0),
...
const VkImageCaptureDescriptorDataInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImageCaptureDescriptorDataInfoEXT", {
    sType: "u32("+(V.VkImageCaptureDescriptorDataInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_CAPTURE_DESCRIPTOR_DATA_INFO_EXT||0),
...
const VkImageViewCaptureDescriptorDataInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImageViewCaptureDescriptorDataInfoEXT", {
    sType: "u32("+(V.VkImageViewCaptureDescriptorDataInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_EXT||0),
    pNext: "u64("+(V.VkImageViewCaptureDescriptorDataInfoEXT_pNext_offsetof||0)+")",
    imageView: "u64("+(V.VkImageViewCaptureDescriptorDataInfoEXT_imageView_offsetof||0)+")",
...
const VkSamplerCaptureDescriptorDataInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkSamplerCaptureDescriptorDataInfoEXT", {
    sType: "u32("+(V.VkSamplerCaptureDescriptorDataInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SAMPLER_CAPTURE_DESCRIPTOR_DATA_INFO_EXT||0),
...
const VkAccelerationStructureCaptureDescriptorDataInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureCaptureDescriptorDataInfoEXT", {
    sType: "u32("+(V.VkAccelerationStructureCaptureDescriptorDataInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CAPTURE_DESCRIPTOR_DATA_INFO_EXT||0),
    ...
    accelerationStructureNV: "VkAccelerationStructureNV("+(V.VkAccelerationStructureCaptureDescriptorDataInfoEXT_accelerationStructureNV_offsetof||0)+")",
...
const VkOpaqueCaptureDescriptorDataCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkOpaqueCaptureDescriptorDataCreateInfoEXT", {
    sType: "u32("+(V.VkOpaqueCaptureDescriptorDataCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_OPAQUE_CAPTURE_DESCRIPTOR_DATA_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceShaderIntegerDotProductFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderIntegerDotProductFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceShaderIntegerDotProductFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_FEATURES||0),
...
const VkPhysicalDeviceShaderIntegerDotProductFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderIntegerDotProductFeatures"));


const VkPhysicalDeviceShaderIntegerDotProductProperties = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderIntegerDotProductProperties", {
    sType: "u32("+(V.VkPhysicalDeviceShaderIntegerDotProductProperties_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_PROPERTIES||0),
...
const VkPhysicalDeviceShaderIntegerDotProductPropertiesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceShaderIntegerDotProductProperties"));


const VkPhysicalDeviceDrmPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDrmPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDrmPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRM_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_KHR||0),
...
const VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR", {
    sType: "u32("+(V.VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_PROPERTIES_KHR||0),
...
const VkPhysicalDeviceRayTracingMotionBlurFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRayTracingMotionBlurFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceRayTracingMotionBlurFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_MOTION_BLUR_FEATURES_NV||0),
...
const VkAccelerationStructureMotionInfoNV = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureMotionInfoNV", {
    sType: "u32("+(V.VkAccelerationStructureMotionInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MOTION_INFO_NV||0),
...
const VkSRTDataNV = new Proxy(C.CStructView, new C.CStruct("VkSRTDataNV", {
...
const VkAccelerationStructureSRTMotionInstanceNV = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureSRTMotionInstanceNV", {
    transformT0: "VkSRTDataNV("+(V.VkAccelerationStructureSRTMotionInstanceNV_transformT0_offsetof||0)+")",
    transformT1: "VkSRTDataNV("+(V.VkAccelerationStructureSRTMotionInstanceNV_transformT1_offsetof||0)+")",
...
const VkAccelerationStructureMatrixMotionInstanceNV = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureMatrixMotionInstanceNV", {
...
const VkAccelerationStructureMotionInstanceNV = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureMotionInstanceNV", {
    ...
    data: "VkAccelerationStructureMotionInstanceDataNV("+(V.VkAccelerationStructureMotionInstanceNV_data_offsetof||0)+")",
}, (V.VkAccelerationStructureMotionInstanceNV_sizeof||0)));


const VkMemoryGetRemoteAddressInfoNV = new Proxy(C.CStructView, new C.CStruct("VkMemoryGetRemoteAddressInfoNV", {
    sType: "u32("+(V.VkMemoryGetRemoteAddressInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MEMORY_GET_REMOTE_ADDRESS_INFO_NV||0),
...
const VkImportMemoryBufferCollectionFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkImportMemoryBufferCollectionFUCHSIA", {
    sType: "u32("+(V.VkImportMemoryBufferCollectionFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_MEMORY_BUFFER_COLLECTION_FUCHSIA||0),
    pNext: "u64("+(V.VkImportMemoryBufferCollectionFUCHSIA_pNext_offsetof||0)+")",
    collection: "VkBufferCollectionFUCHSIA("+(V.VkImportMemoryBufferCollectionFUCHSIA_collection_offsetof||0)+")",
    index: "u32("+(V.VkImportMemoryBufferCollectionFUCHSIA_index_offsetof||0)+")",
}, (V.VkImportMemoryBufferCollectionFUCHSIA_sizeof||0)));


const VkBufferCollectionImageCreateInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkBufferCollectionImageCreateInfoFUCHSIA", {
    sType: "u32("+(V.VkBufferCollectionImageCreateInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_IMAGE_CREATE_INFO_FUCHSIA||0),
    pNext: "u64("+(V.VkBufferCollectionImageCreateInfoFUCHSIA_pNext_offsetof||0)+")",
    collection: "VkBufferCollectionFUCHSIA("+(V.VkBufferCollectionImageCreateInfoFUCHSIA_collection_offsetof||0)+")",
    index: "u32("+(V.VkBufferCollectionImageCreateInfoFUCHSIA_index_offsetof||0)+")",
}, (V.VkBufferCollectionImageCreateInfoFUCHSIA_sizeof||0)));


const VkBufferCollectionBufferCreateInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkBufferCollectionBufferCreateInfoFUCHSIA", {
    sType: "u32("+(V.VkBufferCollectionBufferCreateInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_BUFFER_CREATE_INFO_FUCHSIA||0),
    pNext: "u64("+(V.VkBufferCollectionBufferCreateInfoFUCHSIA_pNext_offsetof||0)+")",
    collection: "VkBufferCollectionFUCHSIA("+(V.VkBufferCollectionBufferCreateInfoFUCHSIA_collection_offsetof||0)+")",
...
const VkBufferCollectionCreateInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkBufferCollectionCreateInfoFUCHSIA", {
    sType: "u32("+(V.VkBufferCollectionCreateInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_CREATE_INFO_FUCHSIA||0),
    pNext: "u64("+(V.VkBufferCollectionCreateInfoFUCHSIA_pNext_offsetof||0)+")",
    collectionToken: "zx_handle_t("+(V.VkBufferCollectionCreateInfoFUCHSIA_collectionToken_offsetof||0)+")",
}, (V.VkBufferCollectionCreateInfoFUCHSIA_sizeof||0)));


const VkBufferCollectionPropertiesFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkBufferCollectionPropertiesFUCHSIA", {
    sType: "u32("+(V.VkBufferCollectionPropertiesFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_PROPERTIES_FUCHSIA||0),
    ...
    sysmemColorSpaceIndex: "VkSysmemColorSpaceFUCHSIA("+(V.VkBufferCollectionPropertiesFUCHSIA_sysmemColorSpaceIndex_offsetof||0)+")",
    samplerYcbcrConversionComponents: "VkComponentMapping("+(V.VkBufferCollectionPropertiesFUCHSIA_samplerYcbcrConversionComponents_offsetof||0)+")",
...
const VkBufferConstraintsInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkBufferConstraintsInfoFUCHSIA", {
    sType: "u32("+(V.VkBufferConstraintsInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_CONSTRAINTS_INFO_FUCHSIA||0),
    pNext: "u64("+(V.VkBufferConstraintsInfoFUCHSIA_pNext_offsetof||0)+")",
    createInfo: "VkBufferCreateInfo("+(V.VkBufferConstraintsInfoFUCHSIA_createInfo_offsetof||0)+")",
    requiredFormatFeatures: "u32("+(V.VkBufferConstraintsInfoFUCHSIA_requiredFormatFeatures_offsetof||0)+")",
    bufferCollectionConstraints: "VkBufferCollectionConstraintsInfoFUCHSIA("+(V.VkBufferConstraintsInfoFUCHSIA_bufferCollectionConstraints_offsetof||0)+")",
}, (V.VkBufferConstraintsInfoFUCHSIA_sizeof||0)));


const VkSysmemColorSpaceFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkSysmemColorSpaceFUCHSIA", {
    sType: "u32("+(V.VkSysmemColorSpaceFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SYSMEM_COLOR_SPACE_FUCHSIA||0),
...
const VkImageFormatConstraintsInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkImageFormatConstraintsInfoFUCHSIA", {
    sType: "u32("+(V.VkImageFormatConstraintsInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_FORMAT_CONSTRAINTS_INFO_FUCHSIA||0),
    pNext: "u64("+(V.VkImageFormatConstraintsInfoFUCHSIA_pNext_offsetof||0)+")",
    imageCreateInfo: "VkImageCreateInfo("+(V.VkImageFormatConstraintsInfoFUCHSIA_imageCreateInfo_offsetof||0)+")",
...
const VkImageConstraintsInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkImageConstraintsInfoFUCHSIA", {
    sType: "u32("+(V.VkImageConstraintsInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_CONSTRAINTS_INFO_FUCHSIA||0),
    ...
    bufferCollectionConstraints: "VkBufferCollectionConstraintsInfoFUCHSIA("+(V.VkImageConstraintsInfoFUCHSIA_bufferCollectionConstraints_offsetof||0)+")",
    flags: "u32("+(V.VkImageConstraintsInfoFUCHSIA_flags_offsetof||0)+")",
}, (V.VkImageConstraintsInfoFUCHSIA_sizeof||0)));


const VkBufferCollectionConstraintsInfoFUCHSIA = new Proxy(C.CStructView, new C.CStruct("VkBufferCollectionConstraintsInfoFUCHSIA", {
    sType: "u32("+(V.VkBufferCollectionConstraintsInfoFUCHSIA_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_CONSTRAINTS_INFO_FUCHSIA||0),
...
const VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RGBA10X6_FORMATS_FEATURES_EXT||0),
...
const VkFormatProperties3 = new Proxy(C.CStructView, new C.CStruct("VkFormatProperties3", {
    sType: "u32("+(V.VkFormatProperties3_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_3||0),
...
const VkFormatProperties3KHR = new Proxy(C.CStructView, new C.ConstructProxy("VkFormatProperties3"));


const VkDrmFormatModifierPropertiesList2EXT = new Proxy(C.CStructView, new C.CStruct("VkDrmFormatModifierPropertiesList2EXT", {
    sType: "u32("+(V.VkDrmFormatModifierPropertiesList2EXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_2_EXT||0),
...
const VkDrmFormatModifierProperties2EXT = new Proxy(C.CStructView, new C.CStruct("VkDrmFormatModifierProperties2EXT", {
...
const VkAndroidHardwareBufferFormatProperties2ANDROID = new Proxy(C.CStructView, new C.CStruct("VkAndroidHardwareBufferFormatProperties2ANDROID", {
    sType: "u32("+(V.VkAndroidHardwareBufferFormatProperties2ANDROID_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_2_ANDROID||0),
    ...
    samplerYcbcrConversionComponents: "VkComponentMapping("+(V.VkAndroidHardwareBufferFormatProperties2ANDROID_samplerYcbcrConversionComponents_offsetof||0)+")",
...
const VkPipelineRenderingCreateInfo = new Proxy(C.CStructView, new C.CStruct("VkPipelineRenderingCreateInfo", {
    sType: "u32("+(V.VkPipelineRenderingCreateInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_RENDERING_CREATE_INFO||0),
...
const VkPipelineRenderingCreateInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPipelineRenderingCreateInfo"));


const VkRenderingInfo = new Proxy(C.CStructView, new C.CStruct("VkRenderingInfo", {
    sType: "u32("+(V.VkRenderingInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDERING_INFO||0),
...
const VkRenderingInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkRenderingInfo"));


const VkRenderingAttachmentInfo = new Proxy(C.CStructView, new C.CStruct("VkRenderingAttachmentInfo", {
    sType: "u32("+(V.VkRenderingAttachmentInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO||0),
    pNext: "u64("+(V.VkRenderingAttachmentInfo_pNext_offsetof||0)+")",
    imageView: "u64("+(V.VkRenderingAttachmentInfo_imageView_offsetof||0)+")",
    ...
    resolveImageView: "u64("+(V.VkRenderingAttachmentInfo_resolveImageView_offsetof||0)+")",
    ...
    clearValue: "VkClearValue("+(V.VkRenderingAttachmentInfo_clearValue_offsetof||0)+")",
}, (V.VkRenderingAttachmentInfo_sizeof||0)));

const VkRenderingAttachmentInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkRenderingAttachmentInfo"));


const VkRenderingFragmentShadingRateAttachmentInfoKHR = new Proxy(C.CStructView, new C.CStruct("VkRenderingFragmentShadingRateAttachmentInfoKHR", {
    sType: "u32("+(V.VkRenderingFragmentShadingRateAttachmentInfoKHR_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR||0),
    pNext: "u64("+(V.VkRenderingFragmentShadingRateAttachmentInfoKHR_pNext_offsetof||0)+")",
    imageView: "u64("+(V.VkRenderingFragmentShadingRateAttachmentInfoKHR_imageView_offsetof||0)+")",
...
const VkRenderingFragmentDensityMapAttachmentInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkRenderingFragmentDensityMapAttachmentInfoEXT", {
    sType: "u32("+(V.VkRenderingFragmentDensityMapAttachmentInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_INFO_EXT||0),
    pNext: "u64("+(V.VkRenderingFragmentDensityMapAttachmentInfoEXT_pNext_offsetof||0)+")",
    imageView: "u64("+(V.VkRenderingFragmentDensityMapAttachmentInfoEXT_imageView_offsetof||0)+")",
...
const VkPhysicalDeviceDynamicRenderingFeatures = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDynamicRenderingFeatures", {
    sType: "u32("+(V.VkPhysicalDeviceDynamicRenderingFeatures_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES||0),
...
const VkPhysicalDeviceDynamicRenderingFeaturesKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceDynamicRenderingFeatures"));


const VkCommandBufferInheritanceRenderingInfo = new Proxy(C.CStructView, new C.CStruct("VkCommandBufferInheritanceRenderingInfo", {
    sType: "u32("+(V.VkCommandBufferInheritanceRenderingInfo_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDERING_INFO||0),
...
const VkCommandBufferInheritanceRenderingInfoKHR = new Proxy(C.CStructView, new C.ConstructProxy("VkCommandBufferInheritanceRenderingInfo"));


const VkAttachmentSampleCountInfoAMD = new Proxy(C.CStructView, new C.CStruct("VkAttachmentSampleCountInfoAMD", {
    sType: "u32("+(V.VkAttachmentSampleCountInfoAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_ATTACHMENT_SAMPLE_COUNT_INFO_AMD||0),
...
const VkAttachmentSampleCountInfoNV = new Proxy(C.CStructView, new C.ConstructProxy("VkAttachmentSampleCountInfoAMD"));


const VkMultiviewPerViewAttributesInfoNVX = new Proxy(C.CStructView, new C.CStruct("VkMultiviewPerViewAttributesInfoNVX", {
    sType: "u32("+(V.VkMultiviewPerViewAttributesInfoNVX_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MULTIVIEW_PER_VIEW_ATTRIBUTES_INFO_NVX||0),
...
const VkPhysicalDeviceImageViewMinLodFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageViewMinLodFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceImageViewMinLodFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_VIEW_MIN_LOD_FEATURES_EXT||0),
...
const VkImageViewMinLodCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImageViewMinLodCreateInfoEXT", {
    sType: "u32("+(V.VkImageViewMinLodCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_VIEW_MIN_LOD_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_EXT||0),
...
const VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM = new Proxy(C.CStructView, new C.ConstructProxy("VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT"));


const VkPhysicalDeviceLinearColorAttachmentFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceLinearColorAttachmentFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceLinearColorAttachmentFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINEAR_COLOR_ATTACHMENT_FEATURES_NV||0),
...
const VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GRAPHICS_PIPELINE_LIBRARY_FEATURES_EXT||0),
...
const VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GRAPHICS_PIPELINE_LIBRARY_PROPERTIES_EXT||0),
...
const VkGraphicsPipelineLibraryCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkGraphicsPipelineLibraryCreateInfoEXT", {
    sType: "u32("+(V.VkGraphicsPipelineLibraryCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_LIBRARY_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE", {
    sType: "u32("+(V.VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_SET_HOST_MAPPING_FEATURES_VALVE||0),
...
const VkDescriptorSetLayoutHostMappingInfoVALVE = new Proxy(C.CStructView, new C.CStruct("VkDescriptorSetLayoutHostMappingInfoVALVE", {
    sType: "u32("+(V.VkDescriptorSetLayoutHostMappingInfoVALVE_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_HOST_MAPPING_INFO_VALVE||0),
...
const VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MODULE_IDENTIFIER_FEATURES_EXT||0),
...
const VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MODULE_IDENTIFIER_PROPERTIES_EXT||0),
...
const VkPipelineShaderStageModuleIdentifierCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineShaderStageModuleIdentifierCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineShaderStageModuleIdentifierCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_MODULE_IDENTIFIER_CREATE_INFO_EXT||0),
...
const VkShaderModuleIdentifierEXT = new Proxy(C.CStructView, new C.CStruct("VkShaderModuleIdentifierEXT", {
    sType: "u32("+(V.VkShaderModuleIdentifierEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SHADER_MODULE_IDENTIFIER_EXT||0),
...
const VkImageCompressionControlEXT = new Proxy(C.CStructView, new C.CStruct("VkImageCompressionControlEXT", {
    sType: "u32("+(V.VkImageCompressionControlEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_COMPRESSION_CONTROL_EXT||0),
...
const VkPhysicalDeviceImageCompressionControlFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageCompressionControlFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceImageCompressionControlFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_COMPRESSION_CONTROL_FEATURES_EXT||0),
...
const VkImageCompressionPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkImageCompressionPropertiesEXT", {
    sType: "u32("+(V.VkImageCompressionPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_COMPRESSION_PROPERTIES_EXT||0),
...
const VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_FEATURES_EXT||0),
...
const VkImageSubresource2EXT = new Proxy(C.CStructView, new C.CStruct("VkImageSubresource2EXT", {
    sType: "u32("+(V.VkImageSubresource2EXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_SUBRESOURCE_2_EXT||0),
    pNext: "u64("+(V.VkImageSubresource2EXT_pNext_offsetof||0)+")",
    imageSubresource: "VkImageSubresource("+(V.VkImageSubresource2EXT_imageSubresource_offsetof||0)+")",
}, (V.VkImageSubresource2EXT_sizeof||0)));


const VkSubresourceLayout2EXT = new Proxy(C.CStructView, new C.CStruct("VkSubresourceLayout2EXT", {
    sType: "u32("+(V.VkSubresourceLayout2EXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_SUBRESOURCE_LAYOUT_2_EXT||0),
    pNext: "u64("+(V.VkSubresourceLayout2EXT_pNext_offsetof||0)+")",
    subresourceLayout: "VkSubresourceLayout("+(V.VkSubresourceLayout2EXT_subresourceLayout_offsetof||0)+")",
}, (V.VkSubresourceLayout2EXT_sizeof||0)));


const VkRenderPassCreationControlEXT = new Proxy(C.CStructView, new C.CStruct("VkRenderPassCreationControlEXT", {
    sType: "u32("+(V.VkRenderPassCreationControlEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_CREATION_CONTROL_EXT||0),
...
const VkRenderPassCreationFeedbackInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkRenderPassCreationFeedbackInfoEXT", {
...
const VkRenderPassCreationFeedbackCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkRenderPassCreationFeedbackCreateInfoEXT", {
    sType: "u32("+(V.VkRenderPassCreationFeedbackCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_CREATION_FEEDBACK_CREATE_INFO_EXT||0),
...
const VkRenderPassSubpassFeedbackInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkRenderPassSubpassFeedbackInfoEXT", {
...
const VkRenderPassSubpassFeedbackCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkRenderPassSubpassFeedbackCreateInfoEXT", {
    sType: "u32("+(V.VkRenderPassSubpassFeedbackCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_RENDER_PASS_SUBPASS_FEEDBACK_CREATE_INFO_EXT||0),
...
const VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_MERGE_FEEDBACK_FEATURES_EXT||0),
...
const VkMicromapBuildInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMicromapBuildInfoEXT", {
    sType: "u32("+(V.VkMicromapBuildInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MICROMAP_BUILD_INFO_EXT||0),
    ...
    dstMicromap: "VkMicromapEXT("+(V.VkMicromapBuildInfoEXT_dstMicromap_offsetof||0)+")",
...
const VkMicromapCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMicromapCreateInfoEXT", {
...
const VkMicromapVersionInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMicromapVersionInfoEXT", {
    sType: "u32("+(V.VkMicromapVersionInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MICROMAP_VERSION_INFO_EXT||0),
...
const VkCopyMicromapInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkCopyMicromapInfoEXT", {
    sType: "u32("+(V.VkCopyMicromapInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_MICROMAP_INFO_EXT||0),
    pNext: "u64("+(V.VkCopyMicromapInfoEXT_pNext_offsetof||0)+")",
    src: "VkMicromapEXT("+(V.VkCopyMicromapInfoEXT_src_offsetof||0)+")",
    dst: "VkMicromapEXT("+(V.VkCopyMicromapInfoEXT_dst_offsetof||0)+")",
    mode: "u32("+(V.VkCopyMicromapInfoEXT_mode_offsetof||0)+")",
}, (V.VkCopyMicromapInfoEXT_sizeof||0)));


const VkCopyMicromapToMemoryInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkCopyMicromapToMemoryInfoEXT", {
    sType: "u32("+(V.VkCopyMicromapToMemoryInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_COPY_MICROMAP_TO_MEMORY_INFO_EXT||0),
    pNext: "u64("+(V.VkCopyMicromapToMemoryInfoEXT_pNext_offsetof||0)+")",
    src: "VkMicromapEXT("+(V.VkCopyMicromapToMemoryInfoEXT_src_offsetof||0)+")",
...
const VkCopyMemoryToMicromapInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkCopyMemoryToMicromapInfoEXT", {
    ...
    dst: "VkMicromapEXT("+(V.VkCopyMemoryToMicromapInfoEXT_dst_offsetof||0)+")",
    mode: "u32("+(V.VkCopyMemoryToMicromapInfoEXT_mode_offsetof||0)+")",
}, (V.VkCopyMemoryToMicromapInfoEXT_sizeof||0)));


const VkMicromapBuildSizesInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkMicromapBuildSizesInfoEXT", {
    sType: "u32("+(V.VkMicromapBuildSizesInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_MICROMAP_BUILD_SIZES_INFO_EXT||0),
...
const VkMicromapUsageEXT = new Proxy(C.CStructView, new C.CStruct("VkMicromapUsageEXT", {
...
const VkMicromapTriangleEXT = new Proxy(C.CStructView, new C.CStruct("VkMicromapTriangleEXT", {
...
const VkPhysicalDeviceOpacityMicromapFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceOpacityMicromapFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceOpacityMicromapFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPACITY_MICROMAP_FEATURES_EXT||0),
...
const VkPhysicalDeviceOpacityMicromapPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceOpacityMicromapPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceOpacityMicromapPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPACITY_MICROMAP_PROPERTIES_EXT||0),
...
const VkAccelerationStructureTrianglesOpacityMicromapEXT = new Proxy(C.CStructView, new C.CStruct("VkAccelerationStructureTrianglesOpacityMicromapEXT", {
    ...
    micromap: "VkMicromapEXT("+(V.VkAccelerationStructureTrianglesOpacityMicromapEXT_micromap_offsetof||0)+")",
}, (V.VkAccelerationStructureTrianglesOpacityMicromapEXT_sizeof||0)));


const VkPipelinePropertiesIdentifierEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelinePropertiesIdentifierEXT", {
    sType: "u32("+(V.VkPipelinePropertiesIdentifierEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_PROPERTIES_IDENTIFIER_EXT||0),
...
const VkPhysicalDevicePipelinePropertiesFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePipelinePropertiesFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDevicePipelinePropertiesFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROPERTIES_FEATURES_EXT||0),
...
const VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD", {
    sType: "u32("+(V.VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_FEATURES_AMD||0),
...
const VkExportMetalObjectCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkExportMetalObjectCreateInfoEXT", {
    sType: "u32("+(V.VkExportMetalObjectCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_METAL_OBJECT_CREATE_INFO_EXT||0),
...
const VkExportMetalObjectsInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkExportMetalObjectsInfoEXT", {
    sType: "u32("+(V.VkExportMetalObjectsInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_METAL_OBJECTS_INFO_EXT||0),
    pNext: "u64("+(V.VkExportMetalObjectsInfoEXT_pNext_offsetof||0)+")",
}, (V.VkExportMetalObjectsInfoEXT_sizeof||0)));


const VkExportMetalDeviceInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkExportMetalDeviceInfoEXT", {
    sType: "u32("+(V.VkExportMetalDeviceInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_METAL_DEVICE_INFO_EXT||0),
    pNext: "u64("+(V.VkExportMetalDeviceInfoEXT_pNext_offsetof||0)+")",
    mtlDevice: "MTLDevice_id("+(V.VkExportMetalDeviceInfoEXT_mtlDevice_offsetof||0)+")",
}, (V.VkExportMetalDeviceInfoEXT_sizeof||0)));


const VkExportMetalCommandQueueInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkExportMetalCommandQueueInfoEXT", {
    sType: "u32("+(V.VkExportMetalCommandQueueInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_METAL_COMMAND_QUEUE_INFO_EXT||0),
    ...
    mtlCommandQueue: "MTLCommandQueue_id("+(V.VkExportMetalCommandQueueInfoEXT_mtlCommandQueue_offsetof||0)+")",
}, (V.VkExportMetalCommandQueueInfoEXT_sizeof||0)));


const VkExportMetalBufferInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkExportMetalBufferInfoEXT", {
    sType: "u32("+(V.VkExportMetalBufferInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_METAL_BUFFER_INFO_EXT||0),
    pNext: "u64("+(V.VkExportMetalBufferInfoEXT_pNext_offsetof||0)+")",
    memory: "u64("+(V.VkExportMetalBufferInfoEXT_memory_offsetof||0)+")",
    mtlBuffer: "MTLBuffer_id("+(V.VkExportMetalBufferInfoEXT_mtlBuffer_offsetof||0)+")",
}, (V.VkExportMetalBufferInfoEXT_sizeof||0)));


const VkImportMetalBufferInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImportMetalBufferInfoEXT", {
    sType: "u32("+(V.VkImportMetalBufferInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_METAL_BUFFER_INFO_EXT||0),
    pNext: "u64("+(V.VkImportMetalBufferInfoEXT_pNext_offsetof||0)+")",
    mtlBuffer: "MTLBuffer_id("+(V.VkImportMetalBufferInfoEXT_mtlBuffer_offsetof||0)+")",
}, (V.VkImportMetalBufferInfoEXT_sizeof||0)));


const VkExportMetalTextureInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkExportMetalTextureInfoEXT", {
    sType: "u32("+(V.VkExportMetalTextureInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_METAL_TEXTURE_INFO_EXT||0),
    pNext: "u64("+(V.VkExportMetalTextureInfoEXT_pNext_offsetof||0)+")",
    image: "u64("+(V.VkExportMetalTextureInfoEXT_image_offsetof||0)+")",
    imageView: "u64("+(V.VkExportMetalTextureInfoEXT_imageView_offsetof||0)+")",
    bufferView: "VkBufferView("+(V.VkExportMetalTextureInfoEXT_bufferView_offsetof||0)+")",
    plane: "u32("+(V.VkExportMetalTextureInfoEXT_plane_offsetof||0)+")",
    mtlTexture: "MTLTexture_id("+(V.VkExportMetalTextureInfoEXT_mtlTexture_offsetof||0)+")",
}, (V.VkExportMetalTextureInfoEXT_sizeof||0)));


const VkImportMetalTextureInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImportMetalTextureInfoEXT", {
    sType: "u32("+(V.VkImportMetalTextureInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_METAL_TEXTURE_INFO_EXT||0),
    pNext: "u64("+(V.VkImportMetalTextureInfoEXT_pNext_offsetof||0)+")",
    plane: "u32("+(V.VkImportMetalTextureInfoEXT_plane_offsetof||0)+")",
    mtlTexture: "MTLTexture_id("+(V.VkImportMetalTextureInfoEXT_mtlTexture_offsetof||0)+")",
}, (V.VkImportMetalTextureInfoEXT_sizeof||0)));


const VkExportMetalIOSurfaceInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkExportMetalIOSurfaceInfoEXT", {
    sType: "u32("+(V.VkExportMetalIOSurfaceInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_METAL_IO_SURFACE_INFO_EXT||0),
    pNext: "u64("+(V.VkExportMetalIOSurfaceInfoEXT_pNext_offsetof||0)+")",
    image: "u64("+(V.VkExportMetalIOSurfaceInfoEXT_image_offsetof||0)+")",
    ioSurface: "IOSurfaceRef("+(V.VkExportMetalIOSurfaceInfoEXT_ioSurface_offsetof||0)+")",
}, (V.VkExportMetalIOSurfaceInfoEXT_sizeof||0)));


const VkImportMetalIOSurfaceInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImportMetalIOSurfaceInfoEXT", {
    sType: "u32("+(V.VkImportMetalIOSurfaceInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_METAL_IO_SURFACE_INFO_EXT||0),
    pNext: "u64("+(V.VkImportMetalIOSurfaceInfoEXT_pNext_offsetof||0)+")",
    ioSurface: "IOSurfaceRef("+(V.VkImportMetalIOSurfaceInfoEXT_ioSurface_offsetof||0)+")",
}, (V.VkImportMetalIOSurfaceInfoEXT_sizeof||0)));


const VkExportMetalSharedEventInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkExportMetalSharedEventInfoEXT", {
    sType: "u32("+(V.VkExportMetalSharedEventInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_EXPORT_METAL_SHARED_EVENT_INFO_EXT||0),
    ...
    event: "VkEvent("+(V.VkExportMetalSharedEventInfoEXT_event_offsetof||0)+")",
    mtlSharedEvent: "MTLSharedEvent_id("+(V.VkExportMetalSharedEventInfoEXT_mtlSharedEvent_offsetof||0)+")",
}, (V.VkExportMetalSharedEventInfoEXT_sizeof||0)));


const VkImportMetalSharedEventInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkImportMetalSharedEventInfoEXT", {
    sType: "u32("+(V.VkImportMetalSharedEventInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMPORT_METAL_SHARED_EVENT_INFO_EXT||0),
    pNext: "u64("+(V.VkImportMetalSharedEventInfoEXT_pNext_offsetof||0)+")",
    mtlSharedEvent: "MTLSharedEvent_id("+(V.VkImportMetalSharedEventInfoEXT_mtlSharedEvent_offsetof||0)+")",
}, (V.VkImportMetalSharedEventInfoEXT_sizeof||0)));


const VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NON_SEAMLESS_CUBE_MAP_FEATURES_EXT||0),
...
const VkPhysicalDevicePipelineRobustnessFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePipelineRobustnessFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDevicePipelineRobustnessFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES_EXT||0),
...
const VkPipelineRobustnessCreateInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkPipelineRobustnessCreateInfoEXT", {
    sType: "u32("+(V.VkPipelineRobustnessCreateInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PIPELINE_ROBUSTNESS_CREATE_INFO_EXT||0),
...
const VkPhysicalDevicePipelineRobustnessPropertiesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDevicePipelineRobustnessPropertiesEXT", {
    sType: "u32("+(V.VkPhysicalDevicePipelineRobustnessPropertiesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES_EXT||0),
...
const VkImageViewSampleWeightCreateInfoQCOM = new Proxy(C.CStructView, new C.CStruct("VkImageViewSampleWeightCreateInfoQCOM", {
    sType: "u32("+(V.VkImageViewSampleWeightCreateInfoQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_IMAGE_VIEW_SAMPLE_WEIGHT_CREATE_INFO_QCOM||0),
...
const VkPhysicalDeviceImageProcessingFeaturesQCOM = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageProcessingFeaturesQCOM", {
    sType: "u32("+(V.VkPhysicalDeviceImageProcessingFeaturesQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_PROCESSING_FEATURES_QCOM||0),
...
const VkPhysicalDeviceImageProcessingPropertiesQCOM = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceImageProcessingPropertiesQCOM", {
    sType: "u32("+(V.VkPhysicalDeviceImageProcessingPropertiesQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_PROCESSING_PROPERTIES_QCOM||0),
...
const VkPhysicalDeviceTilePropertiesFeaturesQCOM = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceTilePropertiesFeaturesQCOM", {
    sType: "u32("+(V.VkPhysicalDeviceTilePropertiesFeaturesQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_PROPERTIES_FEATURES_QCOM||0),
...
const VkTilePropertiesQCOM = new Proxy(C.CStructView, new C.CStruct("VkTilePropertiesQCOM", {
    sType: "u32("+(V.VkTilePropertiesQCOM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_TILE_PROPERTIES_QCOM||0),
    pNext: "u64("+(V.VkTilePropertiesQCOM_pNext_offsetof||0)+")",
    tileSize: "VkExtent3D("+(V.VkTilePropertiesQCOM_tileSize_offsetof||0)+")",
...
const VkPhysicalDeviceAmigoProfilingFeaturesSEC = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceAmigoProfilingFeaturesSEC", {
    sType: "u32("+(V.VkPhysicalDeviceAmigoProfilingFeaturesSEC_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_AMIGO_PROFILING_FEATURES_SEC||0),
...
const VkAmigoProfilingSubmitInfoSEC = new Proxy(C.CStructView, new C.CStruct("VkAmigoProfilingSubmitInfoSEC", {
    sType: "u32("+(V.VkAmigoProfilingSubmitInfoSEC_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_AMIGO_PROFILING_SUBMIT_INFO_SEC||0),
...
const VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_FEATURES_EXT||0),
...
const VkPhysicalDeviceDepthClampZeroOneFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceDepthClampZeroOneFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceDepthClampZeroOneFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_EXT||0),
...
const VkPhysicalDeviceAddressBindingReportFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceAddressBindingReportFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceAddressBindingReportFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ADDRESS_BINDING_REPORT_FEATURES_EXT||0),
...
const VkDeviceAddressBindingCallbackDataEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceAddressBindingCallbackDataEXT", {
    sType: "u32("+(V.VkDeviceAddressBindingCallbackDataEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_ADDRESS_BINDING_CALLBACK_DATA_EXT||0),
...
const VkPhysicalDeviceOpticalFlowFeaturesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceOpticalFlowFeaturesNV", {
    sType: "u32("+(V.VkPhysicalDeviceOpticalFlowFeaturesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPTICAL_FLOW_FEATURES_NV||0),
...
const VkPhysicalDeviceOpticalFlowPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceOpticalFlowPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceOpticalFlowPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPTICAL_FLOW_PROPERTIES_NV||0),
...
const VkOpticalFlowImageFormatInfoNV = new Proxy(C.CStructView, new C.CStruct("VkOpticalFlowImageFormatInfoNV", {
    sType: "u32("+(V.VkOpticalFlowImageFormatInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_OPTICAL_FLOW_IMAGE_FORMAT_INFO_NV||0),
...
const VkOpticalFlowImageFormatPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkOpticalFlowImageFormatPropertiesNV", {
    sType: "u32("+(V.VkOpticalFlowImageFormatPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_OPTICAL_FLOW_IMAGE_FORMAT_PROPERTIES_NV||0),
...
const VkOpticalFlowSessionCreateInfoNV = new Proxy(C.CStructView, new C.CStruct("VkOpticalFlowSessionCreateInfoNV", {
    sType: "u32("+(V.VkOpticalFlowSessionCreateInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_OPTICAL_FLOW_SESSION_CREATE_INFO_NV||0),
...
const VkOpticalFlowSessionCreatePrivateDataInfoNV = new Proxy(C.CStructView, new C.CStruct("VkOpticalFlowSessionCreatePrivateDataInfoNV", {
    sType: "u32("+(V.VkOpticalFlowSessionCreatePrivateDataInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_OPTICAL_FLOW_SESSION_CREATE_PRIVATE_DATA_INFO_NV||0),
...
const VkOpticalFlowExecuteInfoNV = new Proxy(C.CStructView, new C.CStruct("VkOpticalFlowExecuteInfoNV", {
    sType: "u32("+(V.VkOpticalFlowExecuteInfoNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_OPTICAL_FLOW_EXECUTE_INFO_NV||0),
...
const VkPhysicalDeviceFaultFeaturesEXT = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceFaultFeaturesEXT", {
    sType: "u32("+(V.VkPhysicalDeviceFaultFeaturesEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FAULT_FEATURES_EXT||0),
...
const VkDeviceFaultAddressInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceFaultAddressInfoEXT", {
...
const VkDeviceFaultVendorInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceFaultVendorInfoEXT", {
...
const VkDeviceFaultCountsEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceFaultCountsEXT", {
    sType: "u32("+(V.VkDeviceFaultCountsEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_FAULT_COUNTS_EXT||0),
...
const VkDeviceFaultInfoEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceFaultInfoEXT", {
    sType: "u32("+(V.VkDeviceFaultInfoEXT_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_DEVICE_FAULT_INFO_EXT||0),
...
const VkDeviceFaultVendorBinaryHeaderVersionOneEXT = new Proxy(C.CStructView, new C.CStruct("VkDeviceFaultVendorBinaryHeaderVersionOneEXT", {
...
const VkDecompressMemoryRegionNV = new Proxy(C.CStructView, new C.CStruct("VkDecompressMemoryRegionNV", {
...
const VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM", {
    sType: "u32("+(V.VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_BUILTINS_PROPERTIES_ARM||0),
...
const VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM", {
    sType: "u32("+(V.VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_BUILTINS_FEATURES_ARM||0),
...
const VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV = new Proxy(C.CStructView, new C.CStruct("VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV", {
    sType: "u32("+(V.VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV_sType_offsetof||0)+")"+";"+(E.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_INVOCATION_REORDER_PROPERTIES_NV||0),
