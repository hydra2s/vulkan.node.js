...
const VkPhysicalDeviceLimits = new T.StructBuffer("VkPhysicalDeviceLimits", {
    ...
    minTexelOffset: C.uint32_t,
    maxTexelOffset: C.uint32_t,
    minTexelGatherOffset: C.uint32_t,
